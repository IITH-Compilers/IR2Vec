...
; <label>:24:                                     ; preds = %17
  ...
  %49 = tail call double @llvm.fmuladd.f64(double -4.232000e-01, double 7.500000e-01, double %48)
  ...
  %99 = tail call double @llvm.fmuladd.f64(double -4.232000e-01, double 7.500000e-01, double %98)
  ...
  %148 = tail call double @llvm.fmuladd.f64(double -4.232000e-01, double 7.500000e-01, double %147)
  ...
  %197 = tail call double @llvm.fmuladd.f64(double -4.232000e-01, double 7.500000e-01, double %196)
  ...
  %246 = tail call double @llvm.fmuladd.f64(double -4.232000e-01, double 7.500000e-01, double %245)
  ...
  %362 = tail call double @llvm.fmuladd.f64(double -4.232000e-01, double 7.500000e-01, double %361)
  ...
  %411 = tail call double @llvm.fmuladd.f64(double -4.232000e-01, double 7.500000e-01, double %410)
  ...
  %460 = tail call double @llvm.fmuladd.f64(double -4.232000e-01, double 7.500000e-01, double %459)
  ...
  %509 = tail call double @llvm.fmuladd.f64(double -4.232000e-01, double 7.500000e-01, double %508)
  ...
  %558 = tail call double @llvm.fmuladd.f64(double -4.232000e-01, double 7.500000e-01, double %557)
