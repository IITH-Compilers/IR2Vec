...
; <label>:23:                                     ; preds = %15
  ...
  %31 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %24, i64 %26, i64 %28, i64 %30, i64 0
  %32 = load double, double* %31, align 8, !tbaa !8
  %33 = fmul double %32, %1
  store double %33, double* %31, align 8, !tbaa !8
  %34 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %24, i64 %26, i64 %28, i64 %30, i64 1
  %35 = load double, double* %34, align 8, !tbaa !8
  %36 = fmul double %35, %1
  store double %36, double* %34, align 8, !tbaa !8
  %37 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %24, i64 %26, i64 %28, i64 %30, i64 2
  %38 = load double, double* %37, align 8, !tbaa !8
  %39 = fmul double %38, %1
  store double %39, double* %37, align 8, !tbaa !8
  %40 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %24, i64 %26, i64 %28, i64 %30, i64 3
  %41 = load double, double* %40, align 8, !tbaa !8
  %42 = fmul double %41, %1
  store double %42, double* %40, align 8, !tbaa !8
  %43 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %24, i64 %26, i64 %28, i64 %30, i64 4
