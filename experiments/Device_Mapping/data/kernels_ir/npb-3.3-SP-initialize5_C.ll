; ModuleID = 'npb-SP-initialize5.cl'
source_filename = "npb-SP-initialize5.cl"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.13.0"

; Function Attrs: nounwind ssp uwtable
define spir_kernel void @initialize5(double* nocapture, double*, i32, i32, i32) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
...
; <label>:15:                                     ; preds = %5
  ...
  %17 = fmul double %16, 0x3F7970E4F80CB872
  %18 = sitofp i32 %11 to double
  %19 = fmul double %18, 0x3F7970E4F80CB872
  %20 = getelementptr inbounds [5 x double], [5 x double]* %6, i64 0, i64 0
  call void @exact_solution(double %19, double %17, double 0.000000e+00, double* nonnull %20, double* %1) #4
  %21 = shl i64 %8, 32
  %22 = ashr exact i64 %21, 32
  %23 = shl i64 %10, 32
  %24 = ashr exact i64 %23, 32
  %25 = mul nsw i64 %22, 815
  %26 = mul nsw i64 %24, 5
  %27 = add i64 %25, %26
  ...
  %30 = add nsw i32 %4, -1
  call void @exact_solution(double %19, double %17, double 1.000000e+00, double* nonnull %20, double* %1) #4
  %31 = sext i32 %30 to i64
  %32 = mul nsw i64 %31, 132845
  %33 = add i64 %32, %25
  %34 = add i64 %33, %26
  %35 = getelementptr double, double* %0, i64 %34
  %36 = bitcast double* %35 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %36, i8* nonnull %7, i64 40, i32 8, i1 false)
  br label %37
