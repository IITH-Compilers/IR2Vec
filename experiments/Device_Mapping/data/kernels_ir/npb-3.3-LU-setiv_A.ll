...
; <label>:35:                                     ; preds = %5
  %36 = bitcast double* %0 to [65 x [65 x [5 x double]]]*
  ...
  call void @exact(i32 63, i32 %23, i32 %20, double* nonnull %45, double* %1) #5
  ...
  call void @exact(i32 %26, i32 63, i32 %20, double* nonnull %47, double* %1) #5
  ...
  %81 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %36, i64 %54, i64 %56, i64 %58, i64 0
