...
; <label>:19:                                     ; preds = %4
  %20 = bitcast double* %0 to [163 x [163 x [5 x double]]]*
  %21 = shl i64 %6, 32
  ...
  %27 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %20, i64 %22, i64 %24, i64 %26, i64 0
  %28 = load double, double* %27, align 8, !tbaa !8
  %29 = fmul double %28, 6.700000e-04
  store double %29, double* %27, align 8, !tbaa !8
  %30 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %20, i64 %22, i64 %24, i64 %26, i64 1
  %31 = load double, double* %30, align 8, !tbaa !8
  %32 = fmul double %31, 6.700000e-04
  ...
  %35 = fmul double %34, 6.700000e-04
  store double %35, double* %33, align 8, !tbaa !8
  %36 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %20, i64 %22, i64 %24, i64 %26, i64 3
  %37 = load double, double* %36, align 8, !tbaa !8
  %38 = fmul double %37, 6.700000e-04
  store double %38, double* %36, align 8, !tbaa !8
  %39 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %20, i64 %22, i64 %24, i64 %26, i64 4
  %40 = load double, double* %39, align 8, !tbaa !8
  %41 = fmul double %40, 6.700000e-04
