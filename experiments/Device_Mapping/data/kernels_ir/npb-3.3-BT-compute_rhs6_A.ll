; ModuleID = 'npb-BT-compute_rhs6_A.cl'
source_filename = "npb-BT-compute_rhs6_A.cl"
...
; <label>:22:                                     ; preds = %14
  ...
  %30 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %23, i64 %25, i64 %27, i64 %29, i64 0
  %31 = load double, double* %30, align 8, !tbaa !8
  %32 = fmul double %31, 8.000000e-04
  store double %32, double* %30, align 8, !tbaa !8
  %33 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %23, i64 %25, i64 %27, i64 %29, i64 1
  %34 = load double, double* %33, align 8, !tbaa !8
  %35 = fmul double %34, 8.000000e-04
  store double %35, double* %33, align 8, !tbaa !8
  %36 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %23, i64 %25, i64 %27, i64 %29, i64 2
  %37 = load double, double* %36, align 8, !tbaa !8
  %38 = fmul double %37, 8.000000e-04
  store double %38, double* %36, align 8, !tbaa !8
  %39 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %23, i64 %25, i64 %27, i64 %29, i64 3
  %40 = load double, double* %39, align 8, !tbaa !8
  %41 = fmul double %40, 8.000000e-04
  store double %41, double* %39, align 8, !tbaa !8
  %42 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %23, i64 %25, i64 %27, i64 %29, i64 4
