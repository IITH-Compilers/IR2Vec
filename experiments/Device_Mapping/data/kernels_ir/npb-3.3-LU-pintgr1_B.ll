...
; <label>:21:                                     ; preds = %9
  ...
  %30 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %22, i64 %25, i64 %27, i64 %29, i64 4
  %31 = load double, double* %30, align 8, !tbaa !8
  %32 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %22, i64 %25, i64 %27, i64 %29, i64 1
  %33 = load double, double* %32, align 8, !tbaa !8
  %34 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %22, i64 %25, i64 %27, i64 %29, i64 2
  %35 = load double, double* %34, align 8, !tbaa !8
  %36 = fmul double %35, %35
  %37 = tail call double @llvm.fmuladd.f64(double %33, double %33, double %36)
  %38 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %22, i64 %25, i64 %27, i64 %29, i64 3
  %39 = load double, double* %38, align 8, !tbaa !8
  %40 = tail call double @llvm.fmuladd.f64(double %39, double %39, double %37)
  %41 = fmul double %40, 5.000000e-01
  %42 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %22, i64 %25, i64 %27, i64 %29, i64 0
  %43 = load double, double* %42, align 8, !tbaa !8
  %44 = fdiv double %41, %43
  %45 = fsub double %31, %44
  %46 = fmul double %45, 4.000000e-01
  %47 = getelementptr inbounds [104 x double], [104 x double]* %23, i64 %27, i64 %29
  store double %46, double* %47, align 8, !tbaa !8
  %48 = add nsw i32 %8, -1
  %49 = sext i32 %48 to i64
  %50 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %22, i64 %49, i64 %27, i64 %29, i64 4
  %51 = load double, double* %50, align 8, !tbaa !8
  %52 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %22, i64 %49, i64 %27, i64 %29, i64 1
  %53 = load double, double* %52, align 8, !tbaa !8
  %54 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %22, i64 %49, i64 %27, i64 %29, i64 2
  %55 = load double, double* %54, align 8, !tbaa !8
  %56 = fmul double %55, %55
  %57 = tail call double @llvm.fmuladd.f64(double %53, double %53, double %56)
  %58 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %22, i64 %49, i64 %27, i64 %29, i64 3
  %59 = load double, double* %58, align 8, !tbaa !8
  %60 = tail call double @llvm.fmuladd.f64(double %59, double %59, double %57)
  %61 = fmul double %60, 5.000000e-01
  %62 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %22, i64 %49, i64 %27, i64 %29, i64 0
  %63 = load double, double* %62, align 8, !tbaa !8
  %64 = fdiv double %61, %63
  %65 = fsub double %51, %64
  %66 = fmul double %65, 4.000000e-01
  %67 = getelementptr inbounds [104 x double], [104 x double]* %24, i64 %27, i64 %29
