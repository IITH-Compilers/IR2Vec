...
@cffts1.ty1 = internal global [512 x %struct.dcomplex] undef, align 16
@cffts1.ty2 = internal global [512 x %struct.dcomplex] undef, align 16
...
; <label>:30:                                     ; preds = %20
  ...
  %35 = getelementptr inbounds [512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 %22
  ...
  %40 = getelementptr inbounds [512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 %22, i32 1
...
; <label>:47:                                     ; preds = %43, %79, %8
  ...
  tail call void @cfftz(i32 %3, i32 %7, i32 %4, %struct.dcomplex* %2, %struct.dcomplex* getelementptr inbounds ([512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 0), %struct.dcomplex* getelementptr inbounds ([512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty2, i64 0, i64 0)) #6
  tail call void @_Z7barrierj(i32 1) #5
...
; <label>:62:                                     ; preds = %49
  ...
  %64 = getelementptr inbounds [512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 %51
  ...
  %69 = getelementptr inbounds [512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 %51, i32 1
...
; <label>:79:                                     ; preds = %79, %46
  ...
  %85 = getelementptr inbounds [512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 %80
  ...
  %90 = getelementptr inbounds [512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 %80, i32 1
  ...
  %97 = getelementptr inbounds [512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 %92
  ...
  %102 = getelementptr inbounds [512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 %92, i32 1
...
; <label>:107:                                    ; preds = %107, %78
  ...
  %110 = getelementptr inbounds [512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 %108
  ...
  %115 = getelementptr inbounds [512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 %108, i32 1
  ...
  %122 = getelementptr inbounds [512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 %120
  ...
  %127 = getelementptr inbounds [512 x %struct.dcomplex], [512 x %struct.dcomplex]* @cffts1.ty1, i64 0, i64 %120, i32 1
