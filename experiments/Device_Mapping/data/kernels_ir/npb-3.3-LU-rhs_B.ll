...
; <label>:20:                                     ; preds = %8
  %21 = bitcast double* %1 to [103 x [103 x [5 x double]]]*
  %22 = bitcast double* %2 to [103 x [103 x [5 x double]]]*
  %23 = bitcast double* %3 to [103 x [103 x double]]*
  %24 = shl i64 %9, 32
  ...
  %50 = bitcast double* %0 to [103 x [103 x [5 x double]]]*
  %51 = bitcast double* %4 to [103 x [103 x double]]*
  ...
  %55 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %51, i64 %25, i64 %27, i64 %29
  ...
  %67 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %23, i64 %25, i64 %27, i64 %29
