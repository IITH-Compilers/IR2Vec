; ModuleID = 'shoc-1.1.5-FFT-ifft1D_512.cl'
source_filename = "shoc-1.1.5-FFT-ifft1D_512.cl"
...
define spir_kernel void @ifft1D_512(<2 x float>*) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !7 !kernel_arg_type_qual !8 {
  ...
  %50 = call double @cmplx_mul(double %49, double 0x3F8000003F800000) #6
  ...
  %55 = call double @cmplx_mul(double %54, double 0x3F800000BF800000) #6
  ...
  %158 = call double @cmplx_mul(double %157, double 0x3F8000003F800000) #6
  ...
  %163 = call double @cmplx_mul(double %162, double 0x3F800000BF800000) #6
  ...
  %261 = call double @cmplx_mul(double %260, double 0x3F8000003F800000) #6
  ...
  %266 = call double @cmplx_mul(double %265, double 0x3F800000BF800000) #6
  ...
  %310 = load <2 x float>, <2 x float>* %13, align 16
  %311 = extractelement <2 x float> %310, i64 0
  %312 = fmul float %311, 0x3F60000000000000
  %313 = insertelement <2 x float> undef, float %312, i64 0
  %314 = extractelement <2 x float> %310, i64 1
  %315 = fmul float %314, 0x3F60000000000000
  %316 = insertelement <2 x float> %313, float %315, i64 1
  store <2 x float> %316, <2 x float>* %13, align 16
  %317 = load <2 x float>, <2 x float>* %22, align 8
  %318 = extractelement <2 x float> %317, i64 0
  %319 = fmul float %318, 0x3F60000000000000
  %320 = insertelement <2 x float> undef, float %319, i64 0
  %321 = extractelement <2 x float> %317, i64 1
  %322 = fmul float %321, 0x3F60000000000000
  %323 = insertelement <2 x float> %320, float %322, i64 1
  store <2 x float> %323, <2 x float>* %22, align 8
  %324 = load <2 x float>, <2 x float>* %31, align 16
  %325 = extractelement <2 x float> %324, i64 0
  %326 = fmul float %325, 0x3F60000000000000
  %327 = insertelement <2 x float> undef, float %326, i64 0
  %328 = extractelement <2 x float> %324, i64 1
  %329 = fmul float %328, 0x3F60000000000000
  %330 = insertelement <2 x float> %327, float %329, i64 1
  store <2 x float> %330, <2 x float>* %31, align 16
  %331 = load <2 x float>, <2 x float>* %40, align 8
  %332 = extractelement <2 x float> %331, i64 0
  %333 = fmul float %332, 0x3F60000000000000
  %334 = insertelement <2 x float> undef, float %333, i64 0
  %335 = extractelement <2 x float> %331, i64 1
  %336 = fmul float %335, 0x3F60000000000000
  %337 = insertelement <2 x float> %334, float %336, i64 1
  store <2 x float> %337, <2 x float>* %40, align 8
  %338 = load <2 x float>, <2 x float>* %16, align 16
  %339 = extractelement <2 x float> %338, i64 0
  %340 = fmul float %339, 0x3F60000000000000
  %341 = insertelement <2 x float> undef, float %340, i64 0
  %342 = extractelement <2 x float> %338, i64 1
  %343 = fmul float %342, 0x3F60000000000000
  %344 = insertelement <2 x float> %341, float %343, i64 1
  store <2 x float> %344, <2 x float>* %16, align 16
  %345 = load <2 x float>, <2 x float>* %25, align 8
  %346 = extractelement <2 x float> %345, i64 0
  %347 = fmul float %346, 0x3F60000000000000
  %348 = insertelement <2 x float> undef, float %347, i64 0
  %349 = extractelement <2 x float> %345, i64 1
  %350 = fmul float %349, 0x3F60000000000000
  %351 = insertelement <2 x float> %348, float %350, i64 1
  store <2 x float> %351, <2 x float>* %25, align 8
  %352 = load <2 x float>, <2 x float>* %34, align 16
