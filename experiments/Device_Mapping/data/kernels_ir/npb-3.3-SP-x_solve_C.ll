; ModuleID = 'npb-SP-x_solve.cl'
source_filename = "npb-SP-x_solve.cl"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.13.0"

; Function Attrs: nounwind ssp uwtable
define spir_kernel void @x_solve(double* nocapture readonly, double* nocapture readonly, double* nocapture readonly, double*, double* nocapture, double* nocapture, double*, double*, double*, i32, i32, i32, i32) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
...
; <label>:23:                                     ; preds = %13
  %24 = bitcast double* %0 to [163 x [163 x double]]*
  %25 = bitcast double* %2 to [163 x [163 x double]]*
  %26 = add nsw i32 %16, -1
  %27 = mul nsw i32 %26, %10
  %28 = add nsw i32 %19, -1
  %29 = add nsw i32 %28, %27
  %30 = mul nsw i32 %29, 162
  ...
  %70 = bitcast double* %1 to [163 x [163 x double]]*
  %71 = bitcast double* %3 to [163 x [163 x [5 x double]]]*
  ...
  %77 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %70, i64 %74, i64 %76, i64 0
  %78 = load double, double* %77, align 8, !tbaa !8
  %79 = fmul double %78, 1.000000e-01
  %80 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %24, i64 %74, i64 %76, i64 0
  ...
  %91 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %25, i64 %74, i64 %76, i64 0
  %92 = load double, double* %91, align 8, !tbaa !8
  %93 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %70, i64 %74, i64 %76, i64 1
  %94 = load double, double* %93, align 8, !tbaa !8
  %95 = fmul double %94, 1.000000e-01
  %96 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %24, i64 %74, i64 %76, i64 1
  ...
  %109 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %25, i64 %74, i64 %76, i64 1
  %110 = load double, double* %109, align 8, !tbaa !8
  %111 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %70, i64 %74, i64 %76, i64 2
  %112 = load double, double* %111, align 8, !tbaa !8
  %113 = fmul double %112, 1.000000e-01
  %114 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %24, i64 %74, i64 %76, i64 2
  ...
  %127 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %25, i64 %74, i64 %76, i64 2
  ...
  %130 = fmul double %90, 0x40315DF84CAD57BD
  %131 = fsub double -0.000000e+00, %130
  %132 = tail call double @llvm.fmuladd.f64(double %81, double 0xBFAB9D5E4A383277, double %131)
  %133 = getelementptr inbounds double, double* %129, i64 1
  store double %132, double* %133, align 8, !tbaa !8
  %134 = tail call double @llvm.fmuladd.f64(double %107, double 0x40415DF84CAD57BD, double 1.000000e+00)
  %135 = fadd double %134, 8.375000e-04
  %136 = getelementptr inbounds double, double* %129, i64 2
  store double %135, double* %136, align 8, !tbaa !8
  %137 = fmul double %125, 0x40315DF84CAD57BD
  %138 = fsub double -0.000000e+00, %137
  %139 = tail call double @llvm.fmuladd.f64(double %115, double 0x3FAB9D5E4A383277, double %138)
  %140 = fadd double %139, -6.700000e-04
  ...
  store double 1.675000e-04, double* %142, align 8, !tbaa !8
  %143 = getelementptr inbounds double, double* %37, i64 5
  store double 0.000000e+00, double* %143, align 8, !tbaa !8
  %144 = tail call double @llvm.fmuladd.f64(double %92, double 0xBFAB9D5E4A383277, double %132)
  ...
  %147 = tail call double @llvm.fmuladd.f64(double %128, double 0x3FAB9D5E4A383277, double %140)
  ...
  store double 1.675000e-04, double* %149, align 8, !tbaa !8
  %150 = getelementptr inbounds double, double* %39, i64 5
  store double 0.000000e+00, double* %150, align 8, !tbaa !8
  %151 = tail call double @llvm.fmuladd.f64(double %92, double 0x3FAB9D5E4A383277, double %132)
  ...
  %154 = tail call double @llvm.fmuladd.f64(double %128, double 0xBFAB9D5E4A383277, double %140)
  ...
  store double 1.675000e-04, double* %156, align 8, !tbaa !8
  %157 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %70, i64 %74, i64 %76, i64 3
  %158 = load double, double* %157, align 8, !tbaa !8
  %159 = fmul double %158, 1.000000e-01
  %160 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %24, i64 %74, i64 %76, i64 3
  ...
  %173 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %25, i64 %74, i64 %76, i64 3
  ...
  %176 = fmul double %107, 0x40315DF84CAD57BD
  %177 = fsub double -0.000000e+00, %176
  %178 = tail call double @llvm.fmuladd.f64(double %97, double 0xBFAB9D5E4A383277, double %177)
  %179 = fadd double %178, -6.700000e-04
  %180 = getelementptr inbounds double, double* %175, i64 1
  store double %179, double* %180, align 8, !tbaa !8
  %181 = tail call double @llvm.fmuladd.f64(double %125, double 0x40415DF84CAD57BD, double 1.000000e+00)
  %182 = fadd double %181, 1.005000e-03
  %183 = getelementptr inbounds double, double* %175, i64 2
  store double %182, double* %183, align 8, !tbaa !8
  %184 = fmul double %171, 0x40315DF84CAD57BD
  %185 = fsub double -0.000000e+00, %184
  %186 = tail call double @llvm.fmuladd.f64(double %161, double 0x3FAB9D5E4A383277, double %185)
  %187 = fadd double %186, -6.700000e-04
  ...
  store double 1.675000e-04, double* %189, align 8, !tbaa !8
  %190 = getelementptr inbounds double, double* %37, i64 10
  store double 0.000000e+00, double* %190, align 8, !tbaa !8
  %191 = tail call double @llvm.fmuladd.f64(double %110, double 0xBFAB9D5E4A383277, double %179)
  ...
  %194 = tail call double @llvm.fmuladd.f64(double %174, double 0x3FAB9D5E4A383277, double %187)
  ...
  store double 1.675000e-04, double* %196, align 8, !tbaa !8
  %197 = getelementptr inbounds double, double* %39, i64 10
  store double 0.000000e+00, double* %197, align 8, !tbaa !8
  %198 = tail call double @llvm.fmuladd.f64(double %110, double 0x3FAB9D5E4A383277, double %179)
  ...
  %201 = tail call double @llvm.fmuladd.f64(double %174, double 0xBFAB9D5E4A383277, double %187)
  ...
  store double 1.675000e-04, double* %203, align 8, !tbaa !8
...
; <label>:208:                                    ; preds = %208, %206
  ...
  %217 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %70, i64 %74, i64 %76, i64 %216
  %218 = load double, double* %217, align 8, !tbaa !8
  %219 = fmul double %218, 1.000000e-01
  %220 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %24, i64 %74, i64 %76, i64 %216
  ...
  %233 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %25, i64 %74, i64 %76, i64 %216
  %234 = load double, double* %233, align 8, !tbaa !8
  %235 = getelementptr inbounds [5 x double], [5 x double]* %36, i64 %209, i64 0
  store double 1.675000e-04, double* %235, align 8, !tbaa !8
  %236 = fmul double %213, 0x40315DF84CAD57BD
  %237 = fsub double -0.000000e+00, %236
  %238 = tail call double @llvm.fmuladd.f64(double %215, double 0xBFAB9D5E4A383277, double %237)
  %239 = fadd double %238, -6.700000e-04
  %240 = getelementptr inbounds [5 x double], [5 x double]* %36, i64 %209, i64 1
  store double %239, double* %240, align 8, !tbaa !8
  %241 = tail call double @llvm.fmuladd.f64(double %212, double 0x40415DF84CAD57BD, double 1.000000e+00)
  %242 = fadd double %241, 1.005000e-03
  %243 = getelementptr inbounds [5 x double], [5 x double]* %36, i64 %209, i64 2
  store double %242, double* %243, align 8, !tbaa !8
  %244 = fmul double %231, 0x40315DF84CAD57BD
  %245 = fsub double -0.000000e+00, %244
  %246 = tail call double @llvm.fmuladd.f64(double %221, double 0x3FAB9D5E4A383277, double %245)
  %247 = fadd double %246, -6.700000e-04
  ...
  store double 1.675000e-04, double* %249, align 8, !tbaa !8
  %250 = getelementptr inbounds [5 x double], [5 x double]* %38, i64 %209, i64 0
  store double 1.675000e-04, double* %250, align 8, !tbaa !8
  %251 = tail call double @llvm.fmuladd.f64(double %211, double 0xBFAB9D5E4A383277, double %239)
  ...
  %254 = tail call double @llvm.fmuladd.f64(double %234, double 0x3FAB9D5E4A383277, double %247)
  ...
  store double 1.675000e-04, double* %256, align 8, !tbaa !8
  %257 = getelementptr inbounds [5 x double], [5 x double]* %40, i64 %209, i64 0
  store double 1.675000e-04, double* %257, align 8, !tbaa !8
  %258 = tail call double @llvm.fmuladd.f64(double %211, double 0x3FAB9D5E4A383277, double %239)
  ...
  %261 = tail call double @llvm.fmuladd.f64(double %234, double 0xBFAB9D5E4A383277, double %247)
  ...
  store double 1.675000e-04, double* %263, align 8, !tbaa !8
...
; <label>:265:                                    ; preds = %208, %23
  ...
  %274 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %70, i64 %74, i64 %76, i64 %273
  %275 = load double, double* %274, align 8, !tbaa !8
  %276 = fmul double %275, 1.000000e-01
  %277 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %24, i64 %74, i64 %76, i64 %273
  ...
  %290 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %25, i64 %74, i64 %76, i64 %273
  ...
  store double 1.675000e-04, double* %293, align 8, !tbaa !8
  %294 = fmul double %268, 0x40315DF84CAD57BD
  %295 = fsub double -0.000000e+00, %294
  %296 = tail call double @llvm.fmuladd.f64(double %266, double 0xBFAB9D5E4A383277, double %295)
  %297 = fadd double %296, -6.700000e-04
  %298 = getelementptr inbounds [5 x double], [5 x double]* %36, i64 %292, i64 1
  store double %297, double* %298, align 8, !tbaa !8
  %299 = tail call double @llvm.fmuladd.f64(double %269, double 0x40415DF84CAD57BD, double 1.000000e+00)
  %300 = fadd double %299, 1.005000e-03
  %301 = getelementptr inbounds [5 x double], [5 x double]* %36, i64 %292, i64 2
  store double %300, double* %301, align 8, !tbaa !8
  %302 = fmul double %288, 0x40315DF84CAD57BD
  %303 = fsub double -0.000000e+00, %302
  %304 = tail call double @llvm.fmuladd.f64(double %278, double 0x3FAB9D5E4A383277, double %303)
  %305 = fadd double %304, -6.700000e-04
  ...
  store double 1.675000e-04, double* %308, align 8, !tbaa !8
  %309 = tail call double @llvm.fmuladd.f64(double %270, double 0xBFAB9D5E4A383277, double %297)
  ...
  %312 = tail call double @llvm.fmuladd.f64(double %291, double 0x3FAB9D5E4A383277, double %305)
  ...
  store double 1.675000e-04, double* %315, align 8, !tbaa !8
  %316 = tail call double @llvm.fmuladd.f64(double %270, double 0x3FAB9D5E4A383277, double %297)
  ...
  %319 = tail call double @llvm.fmuladd.f64(double %291, double 0xBFAB9D5E4A383277, double %305)
  ...
  %324 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %70, i64 %74, i64 %76, i64 %323
  %325 = load double, double* %324, align 8, !tbaa !8
  %326 = fmul double %325, 1.000000e-01
  %327 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %24, i64 %74, i64 %76, i64 %323
  ...
  %340 = getelementptr inbounds [163 x [163 x double]], [163 x [163 x double]]* %25, i64 %74, i64 %76, i64 %323
  %341 = load double, double* %340, align 8, !tbaa !8
  %342 = getelementptr inbounds [5 x double], [5 x double]* %36, i64 %273, i64 0
  store double 1.675000e-04, double* %342, align 8, !tbaa !8
  %343 = fmul double %269, 0x40315DF84CAD57BD
  %344 = fsub double -0.000000e+00, %343
  %345 = tail call double @llvm.fmuladd.f64(double %267, double 0xBFAB9D5E4A383277, double %344)
  %346 = fadd double %345, -6.700000e-04
  %347 = getelementptr inbounds [5 x double], [5 x double]* %36, i64 %273, i64 1
  store double %346, double* %347, align 8, !tbaa !8
  %348 = tail call double @llvm.fmuladd.f64(double %288, double 0x40415DF84CAD57BD, double 1.000000e+00)
  %349 = fadd double %348, 8.375000e-04
  %350 = getelementptr inbounds [5 x double], [5 x double]* %36, i64 %273, i64 2
  store double %349, double* %350, align 8, !tbaa !8
  %351 = fmul double %338, 0x40315DF84CAD57BD
  %352 = fsub double -0.000000e+00, %351
  %353 = tail call double @llvm.fmuladd.f64(double %328, double 0x3FAB9D5E4A383277, double %352)
  ...
  store double 1.675000e-04, double* %356, align 8, !tbaa !8
  %357 = tail call double @llvm.fmuladd.f64(double %271, double 0xBFAB9D5E4A383277, double %346)
  ...
  %360 = tail call double @llvm.fmuladd.f64(double %341, double 0x3FAB9D5E4A383277, double %353)
  ...
  store double 1.675000e-04, double* %363, align 8, !tbaa !8
  %364 = tail call double @llvm.fmuladd.f64(double %271, double 0x3FAB9D5E4A383277, double %346)
  ...
  %367 = tail call double @llvm.fmuladd.f64(double %341, double 0xBFAB9D5E4A383277, double %353)
  ...
  %374 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76
  %375 = bitcast [163 x [5 x double]]* %374 to i64*
  %376 = load i64, i64* %375, align 8, !tbaa !8
  %377 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 0, i64 1
  %378 = bitcast double* %377 to i64*
  %379 = load i64, i64* %378, align 8, !tbaa !8
  %380 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 0, i64 2
  %381 = bitcast double* %380 to i64*
  %382 = load i64, i64* %381, align 8, !tbaa !8
  %383 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 1
  %384 = bitcast [5 x double]* %383 to i64*
  %385 = load i64, i64* %384, align 8, !tbaa !8
  %386 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 1, i64 1
  %387 = bitcast double* %386 to i64*
  %388 = load i64, i64* %387, align 8, !tbaa !8
  %389 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 1, i64 2
...
; <label>:395:                                    ; preds = %395, %393
  ...
  %416 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %402, i64 0
  store double %415, double* %416, align 8, !tbaa !8
  %417 = bitcast i64 %400 to double
  %418 = fmul double %410, %417
  %419 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %402, i64 1
  store double %418, double* %419, align 8, !tbaa !8
  %420 = bitcast i64 %399 to double
  %421 = fmul double %410, %420
  %422 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %402, i64 2
  ...
  %441 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %434, i64 0
  %442 = load double, double* %441, align 8, !tbaa !8
  %443 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %434, i64 1
  %444 = load double, double* %443, align 8, !tbaa !8
  %445 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %434, i64 2
...
; <label>:461:                                    ; preds = %395, %265
  ...
  %478 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %273, i64 0
  store double %477, double* %478, align 8, !tbaa !8
  %479 = bitcast i64 %466 to double
  %480 = fmul double %473, %479
  %481 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %273, i64 1
  store double %480, double* %481, align 8, !tbaa !8
  %482 = bitcast i64 %465 to double
  %483 = fmul double %473, %482
  %484 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %273, i64 2
  ...
  %499 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %323, i64 0
  store double %498, double* %499, align 8, !tbaa !8
  %500 = fmul double %497, %494
  %501 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %323, i64 1
  store double %500, double* %501, align 8, !tbaa !8
  %502 = fmul double %497, %496
  %503 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %323, i64 2
  ...
  %512 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 0, i64 3
  %513 = bitcast double* %512 to i64*
  %514 = load i64, i64* %513, align 8, !tbaa !8
  %515 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 0, i64 4
  %516 = bitcast double* %515 to i64*
  %517 = load i64, i64* %516, align 8, !tbaa !8
  %518 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 1, i64 3
  %519 = bitcast double* %518 to i64*
  %520 = load i64, i64* %519, align 8, !tbaa !8
  %521 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 1, i64 4
...
; <label>:526:                                    ; preds = %526, %524
  ...
  %550 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %531, i64 3
  ...
  %565 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %541, i64 3
  ...
  %579 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %531, i64 4
  ...
  %594 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %541, i64 4
...
; <label>:605:                                    ; preds = %526, %461
  ...
  %624 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %273, i64 3
  ...
  %639 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %273, i64 4
  ...
  %649 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %323, i64 3
  store double %648, double* %649, align 8, !tbaa !8
  %650 = fdiv double %647, %643
  %651 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %323, i64 4
  store double %650, double* %651, align 8, !tbaa !8
  %652 = load double, double* %354, align 8, !tbaa !8
  %653 = fsub double -0.000000e+00, %652
  %654 = load double, double* %499, align 8, !tbaa !8
  %655 = load double, double* %478, align 8, !tbaa !8
  %656 = tail call double @llvm.fmuladd.f64(double %653, double %654, double %655)
  store double %656, double* %478, align 8, !tbaa !8
  %657 = load double, double* %501, align 8, !tbaa !8
  %658 = load double, double* %481, align 8, !tbaa !8
  %659 = tail call double @llvm.fmuladd.f64(double %653, double %657, double %658)
  store double %659, double* %481, align 8, !tbaa !8
  %660 = load double, double* %503, align 8, !tbaa !8
  %661 = load double, double* %484, align 8, !tbaa !8
  %662 = tail call double @llvm.fmuladd.f64(double %653, double %660, double %661)
  store double %662, double* %484, align 8, !tbaa !8
  %663 = load double, double* %624, align 8, !tbaa !8
  %664 = load double, double* %361, align 8, !tbaa !8
  %665 = fsub double -0.000000e+00, %664
  %666 = tail call double @llvm.fmuladd.f64(double %665, double %648, double %663)
  store double %666, double* %624, align 8, !tbaa !8
  %667 = load double, double* %639, align 8, !tbaa !8
  %668 = load double, double* %368, align 8, !tbaa !8
  %669 = fsub double -0.000000e+00, %668
  %670 = tail call double @llvm.fmuladd.f64(double %669, double %650, double %667)
  store double %670, double* %639, align 8, !tbaa !8
...
; <label>:673:                                    ; preds = %672, %673
  %674 = phi double [ %722, %673 ], [ %670, %672 ]
  %675 = phi double [ %674, %673 ], [ %650, %672 ]
  %676 = phi double [ %712, %673 ], [ %666, %672 ]
  %677 = phi double [ %676, %673 ], [ %648, %672 ]
  %678 = phi double [ %702, %673 ], [ %662, %672 ]
  %679 = phi double [ %678, %673 ], [ %660, %672 ]
  %680 = phi double [ %698, %673 ], [ %659, %672 ]
  %681 = phi double [ %680, %673 ], [ %657, %672 ]
  %682 = phi double [ %694, %673 ], [ %656, %672 ]
  %683 = phi double [ %682, %673 ], [ %654, %672 ]
  %684 = phi i64 [ %723, %673 ], [ %292, %672 ]
  %685 = getelementptr inbounds [5 x double], [5 x double]* %36, i64 %684, i64 3
  %686 = load double, double* %685, align 8, !tbaa !8
  %687 = getelementptr inbounds [5 x double], [5 x double]* %36, i64 %684, i64 4
  %688 = load double, double* %687, align 8, !tbaa !8
  %689 = fsub double -0.000000e+00, %686
  %690 = fsub double -0.000000e+00, %688
  %691 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %684, i64 0
  %692 = load double, double* %691, align 8, !tbaa !8
  %693 = tail call double @llvm.fmuladd.f64(double %689, double %682, double %692)
  %694 = tail call double @llvm.fmuladd.f64(double %690, double %683, double %693)
  store double %694, double* %691, align 8, !tbaa !8
  %695 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %684, i64 1
  %696 = load double, double* %695, align 8, !tbaa !8
  %697 = tail call double @llvm.fmuladd.f64(double %689, double %680, double %696)
  %698 = tail call double @llvm.fmuladd.f64(double %690, double %681, double %697)
  store double %698, double* %695, align 8, !tbaa !8
  %699 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %684, i64 2
  %700 = load double, double* %699, align 8, !tbaa !8
  %701 = tail call double @llvm.fmuladd.f64(double %689, double %678, double %700)
  %702 = tail call double @llvm.fmuladd.f64(double %690, double %679, double %701)
  store double %702, double* %699, align 8, !tbaa !8
  %703 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %684, i64 3
  %704 = load double, double* %703, align 8, !tbaa !8
  %705 = getelementptr inbounds [5 x double], [5 x double]* %38, i64 %684, i64 3
  %706 = load double, double* %705, align 8, !tbaa !8
  %707 = fsub double -0.000000e+00, %706
  %708 = tail call double @llvm.fmuladd.f64(double %707, double %676, double %704)
  %709 = getelementptr inbounds [5 x double], [5 x double]* %38, i64 %684, i64 4
  %710 = load double, double* %709, align 8, !tbaa !8
  %711 = fsub double -0.000000e+00, %710
  %712 = tail call double @llvm.fmuladd.f64(double %711, double %677, double %708)
  store double %712, double* %703, align 8, !tbaa !8
  %713 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %71, i64 %74, i64 %76, i64 %684, i64 4
  %714 = load double, double* %713, align 8, !tbaa !8
  %715 = getelementptr inbounds [5 x double], [5 x double]* %40, i64 %684, i64 3
  %716 = load double, double* %715, align 8, !tbaa !8
  %717 = fsub double -0.000000e+00, %716
  %718 = tail call double @llvm.fmuladd.f64(double %717, double %674, double %714)
  %719 = getelementptr inbounds [5 x double], [5 x double]* %40, i64 %684, i64 4
  %720 = load double, double* %719, align 8, !tbaa !8
  %721 = fsub double -0.000000e+00, %720
  %722 = tail call double @llvm.fmuladd.f64(double %721, double %675, double %718)
  store double %722, double* %713, align 8, !tbaa !8
  %723 = add nsw i64 %684, -1
  %724 = icmp sgt i64 %684, 0
  br i1 %724, label %673, label %725

; <label>:725:                                    ; preds = %673, %605, %13
  ret void
}
