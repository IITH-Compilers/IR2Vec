; ModuleID = 'npb-BT-compute_rhs5_B.cl'
source_filename = "npb-BT-compute_rhs5_B.cl"
...
; <label>:33:                                     ; preds = %29
  ...
  %45 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 0, i64 %42, i64 %44
  ...
  %50 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 0, i64 %42, i64 %44, i64 1
  ...
  %55 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 0, i64 %42, i64 %44, i64 2
  ...
  %60 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 0, i64 %42, i64 %44, i64 3
  ...
  %65 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 0, i64 %42, i64 %44, i64 4
  ...
  %123 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %34, i64 0, i64 %42, i64 %44
  ...
  %129 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %35, i64 0, i64 %42, i64 %44
  ...
  %135 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %36, i64 0, i64 %42, i64 %44
  ...
  %141 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %37, i64 0, i64 %42, i64 %44
  ...
  %147 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %38, i64 0, i64 %42, i64 %44
  ...
  %153 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %39, i64 0, i64 %42, i64 %44
  ...
  %360 = bitcast double* %7 to [103 x [103 x [5 x double]]]*
  ...
  %361 = getelementptr inbounds double, double* %0, i64 212180
  %362 = bitcast double* %361 to [103 x [103 x [5 x double]]]*
  %363 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %362, i64 0, i64 %42, i64 %44
  %364 = bitcast [5 x double]* %363 to i64*
  %365 = load i64, i64* %364, align 8, !tbaa !8
  store i64 %365, i64* %102, align 16, !tbaa !8
  %366 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %362, i64 0, i64 %42, i64 %44, i64 1
  %367 = bitcast double* %366 to i64*
  %368 = load i64, i64* %367, align 8, !tbaa !8
  store i64 %368, i64* %107, align 8, !tbaa !8
  %369 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %362, i64 0, i64 %42, i64 %44, i64 2
  %370 = bitcast double* %369 to i64*
  %371 = load i64, i64* %370, align 8, !tbaa !8
  store i64 %371, i64* %112, align 16, !tbaa !8
  %372 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %362, i64 0, i64 %42, i64 %44, i64 3
  %373 = bitcast double* %372 to i64*
  %374 = load i64, i64* %373, align 8, !tbaa !8
  store i64 %374, i64* %117, align 8, !tbaa !8
  %375 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %362, i64 0, i64 %42, i64 %44, i64 4
  %376 = bitcast double* %375 to i64*
  %377 = load i64, i64* %376, align 8, !tbaa !8
  store i64 %377, i64* %122, align 16, !tbaa !8
  %378 = getelementptr inbounds double, double* %1, i64 31827
  ...
  %382 = getelementptr inbounds double, double* %2, i64 31827
  ...
  %386 = getelementptr inbounds double, double* %3, i64 31827
  ...
  %390 = getelementptr inbounds double, double* %4, i64 31827
  ...
  %394 = getelementptr inbounds double, double* %5, i64 31827
  ...
  %398 = getelementptr inbounds double, double* %6, i64 31827
  %399 = bitcast double* %398 to [103 x [103 x double]]*
  %400 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %399, i64 0, i64 %42, i64 %44
  %401 = load double, double* %400, align 8, !tbaa !8
  %402 = getelementptr inbounds double, double* %7, i64 106090
  %403 = bitcast double* %402 to [103 x [103 x [5 x double]]]*
  %404 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %403, i64 0, i64 %42, i64 %44, i64 0
  ...
  %409 = tail call double @llvm.fmuladd.f64(double %408, double 1.020100e+04, double %405)
  %410 = bitcast i64 %196 to double
  %411 = bitcast i64 %89 to double
  %412 = fsub double %410, %411
  %413 = tail call double @llvm.fmuladd.f64(double %412, double -5.050000e+01, double %409)
  %414 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %403, i64 0, i64 %42, i64 %44, i64 1
  ...
  %419 = tail call double @llvm.fmuladd.f64(double %418, double 1.020100e+04, double %415)
  %420 = tail call double @llvm.fmuladd.f64(double %203, double -2.000000e+00, double %381)
  %421 = fadd double %128, %420
  %422 = tail call double @llvm.fmuladd.f64(double %421, double 0x408FE0CCCCCCCCCE, double %419)
  ...
  %426 = tail call double @llvm.fmuladd.f64(double %425, double -5.050000e+01, double %422)
  %427 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %403, i64 0, i64 %42, i64 %44, i64 2
  ...
  %432 = tail call double @llvm.fmuladd.f64(double %431, double 1.020100e+04, double %428)
  %433 = tail call double @llvm.fmuladd.f64(double %207, double -2.000000e+00, double %385)
  %434 = fadd double %134, %433
  %435 = tail call double @llvm.fmuladd.f64(double %434, double 0x408FE0CCCCCCCCCE, double %432)
  ...
  %439 = tail call double @llvm.fmuladd.f64(double %438, double -5.050000e+01, double %435)
  %440 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %403, i64 0, i64 %42, i64 %44, i64 3
  ...
  %445 = tail call double @llvm.fmuladd.f64(double %444, double 1.020100e+04, double %441)
  %446 = tail call double @llvm.fmuladd.f64(double %211, double -2.000000e+00, double %389)
  %447 = fadd double %140, %446
  %448 = tail call double @llvm.fmuladd.f64(double %447, double 0x4095408888888889, double %445)
  ...
  %458 = tail call double @llvm.fmuladd.f64(double %457, double -5.050000e+01, double %448)
  %459 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %403, i64 0, i64 %42, i64 %44, i64 4
  ...
  %464 = tail call double @llvm.fmuladd.f64(double %463, double 1.020100e+04, double %460)
  %465 = tail call double @llvm.fmuladd.f64(double %215, double -2.000000e+00, double %393)
  %466 = fadd double %146, %465
  %467 = tail call double @llvm.fmuladd.f64(double %466, double 0xC08E9A5E353F7CEC, double %464)
  ...
  %473 = tail call double @llvm.fmuladd.f64(double %472, double 0x4065408888888889, double %467)
  ...
  %479 = tail call double @llvm.fmuladd.f64(double %478, double 0x409F3D95810624DD, double %473)
  ...
  %489 = tail call double @llvm.fmuladd.f64(double %488, double -5.050000e+01, double %479)
...
; <label>:554:                                    ; preds = %554, %545
  ...
  %589 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 %588, i64 %42, i64 %44
  %590 = bitcast [5 x double]* %589 to i64*
  %591 = load i64, i64* %590, align 8, !tbaa !8
  store i64 %591, i64* %102, align 16, !tbaa !8
  %592 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 %588, i64 %42, i64 %44, i64 1
  %593 = bitcast double* %592 to i64*
  %594 = load i64, i64* %593, align 8, !tbaa !8
  store i64 %594, i64* %107, align 8, !tbaa !8
  %595 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 %588, i64 %42, i64 %44, i64 2
  %596 = bitcast double* %595 to i64*
  %597 = load i64, i64* %596, align 8, !tbaa !8
  store i64 %597, i64* %112, align 16, !tbaa !8
  %598 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 %588, i64 %42, i64 %44, i64 3
  %599 = bitcast double* %598 to i64*
  %600 = load i64, i64* %599, align 8, !tbaa !8
  store i64 %600, i64* %117, align 8, !tbaa !8
  %601 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 %588, i64 %42, i64 %44, i64 4
  ...
  %605 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %34, i64 %604, i64 %42, i64 %44
  %606 = load double, double* %605, align 8, !tbaa !8
  %607 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %35, i64 %604, i64 %42, i64 %44
  %608 = load double, double* %607, align 8, !tbaa !8
  %609 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %36, i64 %604, i64 %42, i64 %44
  %610 = load double, double* %609, align 8, !tbaa !8
  %611 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %37, i64 %604, i64 %42, i64 %44
  %612 = load double, double* %611, align 8, !tbaa !8
  %613 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %38, i64 %604, i64 %42, i64 %44
  %614 = load double, double* %613, align 8, !tbaa !8
  %615 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %39, i64 %604, i64 %42, i64 %44
  %616 = load double, double* %615, align 8, !tbaa !8
  %617 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %575, i64 %42, i64 %44, i64 0
  ...
  %621 = tail call double @llvm.fmuladd.f64(double %620, double 1.020100e+04, double %618)
  %622 = fsub double %556, %566
  %623 = tail call double @llvm.fmuladd.f64(double %622, double -5.050000e+01, double %621)
  %624 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %575, i64 %42, i64 %44, i64 1
  ...
  %628 = tail call double @llvm.fmuladd.f64(double %627, double 1.020100e+04, double %625)
  %629 = tail call double @llvm.fmuladd.f64(double %577, double -2.000000e+00, double %606)
  %630 = fadd double %576, %629
  %631 = tail call double @llvm.fmuladd.f64(double %630, double 0x408FE0CCCCCCCCCE, double %628)
  ...
  %635 = tail call double @llvm.fmuladd.f64(double %634, double -5.050000e+01, double %631)
  %636 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %575, i64 %42, i64 %44, i64 2
  ...
  %640 = tail call double @llvm.fmuladd.f64(double %639, double 1.020100e+04, double %637)
  %641 = tail call double @llvm.fmuladd.f64(double %579, double -2.000000e+00, double %608)
  %642 = fadd double %578, %641
  %643 = tail call double @llvm.fmuladd.f64(double %642, double 0x408FE0CCCCCCCCCE, double %640)
  ...
  %647 = tail call double @llvm.fmuladd.f64(double %646, double -5.050000e+01, double %643)
  %648 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %575, i64 %42, i64 %44, i64 3
  ...
  %652 = tail call double @llvm.fmuladd.f64(double %651, double 1.020100e+04, double %649)
  %653 = tail call double @llvm.fmuladd.f64(double %586, double -2.000000e+00, double %610)
  %654 = fadd double %587, %653
  %655 = tail call double @llvm.fmuladd.f64(double %654, double 0x4095408888888889, double %652)
  ...
  %664 = tail call double @llvm.fmuladd.f64(double %663, double -5.050000e+01, double %655)
  %665 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %575, i64 %42, i64 %44, i64 4
  ...
  %670 = tail call double @llvm.fmuladd.f64(double %669, double 1.020100e+04, double %666)
  %671 = tail call double @llvm.fmuladd.f64(double %584, double -2.000000e+00, double %612)
  %672 = fadd double %585, %671
  %673 = tail call double @llvm.fmuladd.f64(double %672, double 0xC08E9A5E353F7CEC, double %670)
  ...
  %679 = tail call double @llvm.fmuladd.f64(double %678, double 0x4065408888888889, double %673)
  ...
  %685 = tail call double @llvm.fmuladd.f64(double %684, double 0x409F3D95810624DD, double %679)
  ...
  %695 = tail call double @llvm.fmuladd.f64(double %694, double -5.050000e+01, double %685)
...
; <label>:741:                                    ; preds = %538, %739
  ...
  %783 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 %782, i64 %42, i64 %44
  %784 = bitcast [5 x double]* %783 to i64*
  %785 = load i64, i64* %784, align 8, !tbaa !8
  store i64 %785, i64* %102, align 16, !tbaa !8
  %786 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 %782, i64 %42, i64 %44, i64 1
  %787 = bitcast double* %786 to i64*
  %788 = load i64, i64* %787, align 8, !tbaa !8
  store i64 %788, i64* %107, align 8, !tbaa !8
  %789 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 %782, i64 %42, i64 %44, i64 2
  %790 = bitcast double* %789 to i64*
  %791 = load i64, i64* %790, align 8, !tbaa !8
  store i64 %791, i64* %112, align 16, !tbaa !8
  %792 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 %782, i64 %42, i64 %44, i64 3
  %793 = bitcast double* %792 to i64*
  %794 = load i64, i64* %793, align 8, !tbaa !8
  store i64 %794, i64* %117, align 8, !tbaa !8
  %795 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %40, i64 %782, i64 %42, i64 %44, i64 4
  ...
  %800 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %34, i64 %799, i64 %42, i64 %44
  %801 = load double, double* %800, align 8, !tbaa !8
  %802 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %35, i64 %799, i64 %42, i64 %44
  %803 = load double, double* %802, align 8, !tbaa !8
  %804 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %36, i64 %799, i64 %42, i64 %44
  %805 = load double, double* %804, align 8, !tbaa !8
  %806 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %37, i64 %799, i64 %42, i64 %44
  %807 = load double, double* %806, align 8, !tbaa !8
  %808 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %38, i64 %799, i64 %42, i64 %44
  %809 = load double, double* %808, align 8, !tbaa !8
  %810 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %39, i64 %799, i64 %42, i64 %44
  %811 = load double, double* %810, align 8, !tbaa !8
  %812 = sext i32 %743 to i64
  %813 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %812, i64 %42, i64 %44, i64 0
  ...
  %817 = tail call double @llvm.fmuladd.f64(double %816, double 1.020100e+04, double %814)
  %818 = fsub double %745, %756
  %819 = tail call double @llvm.fmuladd.f64(double %818, double -5.050000e+01, double %817)
  %820 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %812, i64 %42, i64 %44, i64 1
  ...
  %824 = tail call double @llvm.fmuladd.f64(double %823, double 1.020100e+04, double %821)
  %825 = tail call double @llvm.fmuladd.f64(double %776, double -2.000000e+00, double %801)
  %826 = fadd double %777, %825
  %827 = tail call double @llvm.fmuladd.f64(double %826, double 0x408FE0CCCCCCCCCE, double %824)
  ...
  %831 = tail call double @llvm.fmuladd.f64(double %830, double -5.050000e+01, double %827)
  %832 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %812, i64 %42, i64 %44, i64 2
  ...
  %836 = tail call double @llvm.fmuladd.f64(double %835, double 1.020100e+04, double %833)
  %837 = tail call double @llvm.fmuladd.f64(double %774, double -2.000000e+00, double %803)
  %838 = fadd double %775, %837
  %839 = tail call double @llvm.fmuladd.f64(double %838, double 0x408FE0CCCCCCCCCE, double %836)
  ...
  %843 = tail call double @llvm.fmuladd.f64(double %842, double -5.050000e+01, double %839)
  %844 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %812, i64 %42, i64 %44, i64 3
  ...
  %848 = tail call double @llvm.fmuladd.f64(double %847, double 1.020100e+04, double %845)
  %849 = tail call double @llvm.fmuladd.f64(double %767, double -2.000000e+00, double %805)
  %850 = fadd double %766, %849
  %851 = tail call double @llvm.fmuladd.f64(double %850, double 0x4095408888888889, double %848)
  ...
  %860 = tail call double @llvm.fmuladd.f64(double %859, double -5.050000e+01, double %851)
  %861 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %812, i64 %42, i64 %44, i64 4
  ...
  %866 = tail call double @llvm.fmuladd.f64(double %865, double 1.020100e+04, double %862)
  %867 = tail call double @llvm.fmuladd.f64(double %769, double -2.000000e+00, double %807)
  %868 = fadd double %768, %867
  %869 = tail call double @llvm.fmuladd.f64(double %868, double 0xC08E9A5E353F7CEC, double %866)
  ...
  %875 = tail call double @llvm.fmuladd.f64(double %874, double 0x4065408888888889, double %869)
  ...
  %881 = tail call double @llvm.fmuladd.f64(double %880, double 0x409F3D95810624DD, double %875)
  ...
  %891 = tail call double @llvm.fmuladd.f64(double %890, double -5.050000e+01, double %881)
  ...
  %933 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %34, i64 %782, i64 %42, i64 %44
  %934 = load double, double* %933, align 8, !tbaa !8
  %935 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %35, i64 %782, i64 %42, i64 %44
  %936 = load double, double* %935, align 8, !tbaa !8
  %937 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %36, i64 %782, i64 %42, i64 %44
  %938 = load double, double* %937, align 8, !tbaa !8
  %939 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %37, i64 %782, i64 %42, i64 %44
  %940 = load double, double* %939, align 8, !tbaa !8
  %941 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %38, i64 %782, i64 %42, i64 %44
  %942 = load double, double* %941, align 8, !tbaa !8
  %943 = getelementptr inbounds [103 x [103 x double]], [103 x [103 x double]]* %39, i64 %782, i64 %42, i64 %44
  %944 = load double, double* %943, align 8, !tbaa !8
  %945 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %799, i64 %42, i64 %44, i64 0
  ...
  %950 = tail call double @llvm.fmuladd.f64(double %949, double 1.020100e+04, double %946)
  %951 = bitcast i64 %794 to double
  %952 = fsub double %951, %751
  %953 = tail call double @llvm.fmuladd.f64(double %952, double -5.050000e+01, double %950)
  %954 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %799, i64 %42, i64 %44, i64 1
  ...
  %959 = tail call double @llvm.fmuladd.f64(double %958, double 1.020100e+04, double %955)
  %960 = tail call double @llvm.fmuladd.f64(double %801, double -2.000000e+00, double %934)
  %961 = fadd double %776, %960
  %962 = tail call double @llvm.fmuladd.f64(double %961, double 0x408FE0CCCCCCCCCE, double %959)
  ...
  %966 = tail call double @llvm.fmuladd.f64(double %965, double -5.050000e+01, double %962)
  %967 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %799, i64 %42, i64 %44, i64 2
  ...
  %972 = tail call double @llvm.fmuladd.f64(double %971, double 1.020100e+04, double %968)
  %973 = tail call double @llvm.fmuladd.f64(double %803, double -2.000000e+00, double %936)
  %974 = fadd double %774, %973
  %975 = tail call double @llvm.fmuladd.f64(double %974, double 0x408FE0CCCCCCCCCE, double %972)
  ...
  %979 = tail call double @llvm.fmuladd.f64(double %978, double -5.050000e+01, double %975)
  %980 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %799, i64 %42, i64 %44, i64 3
  ...
  %984 = tail call double @llvm.fmuladd.f64(double %983, double 1.020100e+04, double %981)
  %985 = tail call double @llvm.fmuladd.f64(double %805, double -2.000000e+00, double %938)
  %986 = fadd double %767, %985
  %987 = tail call double @llvm.fmuladd.f64(double %986, double 0x4095408888888889, double %984)
  ...
  %996 = tail call double @llvm.fmuladd.f64(double %995, double -5.050000e+01, double %987)
  %997 = getelementptr inbounds [103 x [103 x [5 x double]]], [103 x [103 x [5 x double]]]* %360, i64 %799, i64 %42, i64 %44, i64 4
  ...
  %1001 = tail call double @llvm.fmuladd.f64(double %1000, double 1.020100e+04, double %998)
  %1002 = tail call double @llvm.fmuladd.f64(double %807, double -2.000000e+00, double %940)
  %1003 = fadd double %769, %1002
  %1004 = tail call double @llvm.fmuladd.f64(double %1003, double 0xC08E9A5E353F7CEC, double %1001)
  ...
  %1010 = tail call double @llvm.fmuladd.f64(double %1009, double 0x4065408888888889, double %1004)
  ...
  %1016 = tail call double @llvm.fmuladd.f64(double %1015, double 0x409F3D95810624DD, double %1010)
  ...
  %1026 = tail call double @llvm.fmuladd.f64(double %1025, double -5.050000e+01, double %1016)
