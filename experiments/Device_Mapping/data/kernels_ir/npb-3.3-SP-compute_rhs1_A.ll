...
; <label>:23:                                     ; preds = %11
  %24 = bitcast double* %0 to [65 x [65 x [5 x double]]]*
  %25 = bitcast double* %1 to [65 x [65 x double]]*
  %26 = bitcast double* %2 to [65 x [65 x double]]*
  %27 = bitcast double* %3 to [65 x [65 x double]]*
  %28 = bitcast double* %4 to [65 x [65 x double]]*
  %29 = bitcast double* %5 to [65 x [65 x double]]*
  %30 = bitcast double* %6 to [65 x [65 x double]]*
  %31 = bitcast double* %7 to [65 x [65 x double]]*
  %32 = shl i64 %12, 32
  ...
  %38 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %24, i64 %33, i64 %35, i64 %37, i64 0
  %39 = load double, double* %38, align 8, !tbaa !8
  %40 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %24, i64 %33, i64 %35, i64 %37, i64 1
  %41 = load double, double* %40, align 8, !tbaa !8
  %42 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %24, i64 %33, i64 %35, i64 %37, i64 2
  %43 = load double, double* %42, align 8, !tbaa !8
  %44 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %24, i64 %33, i64 %35, i64 %37, i64 3
  %45 = load double, double* %44, align 8, !tbaa !8
  %46 = getelementptr inbounds [65 x [65 x [5 x double]]], [65 x [65 x [5 x double]]]* %24, i64 %33, i64 %35, i64 %37, i64 4
  %47 = load double, double* %46, align 8, !tbaa !8
  %48 = fdiv double 1.000000e+00, %39
  %49 = getelementptr inbounds [65 x [65 x double]], [65 x [65 x double]]* %29, i64 %33, i64 %35, i64 %37
  store double %48, double* %49, align 8, !tbaa !8
  %50 = fmul double %41, %48
  %51 = getelementptr inbounds [65 x [65 x double]], [65 x [65 x double]]* %25, i64 %33, i64 %35, i64 %37
  store double %50, double* %51, align 8, !tbaa !8
  %52 = fmul double %48, %43
  %53 = getelementptr inbounds [65 x [65 x double]], [65 x [65 x double]]* %26, i64 %33, i64 %35, i64 %37
  store double %52, double* %53, align 8, !tbaa !8
  %54 = fmul double %48, %45
  %55 = getelementptr inbounds [65 x [65 x double]], [65 x [65 x double]]* %27, i64 %33, i64 %35, i64 %37
  ...
  %61 = getelementptr inbounds [65 x [65 x double]], [65 x [65 x double]]* %31, i64 %33, i64 %35, i64 %37
  store double %60, double* %61, align 8, !tbaa !8
  %62 = fmul double %48, %60
  %63 = getelementptr inbounds [65 x [65 x double]], [65 x [65 x double]]* %28, i64 %33, i64 %35, i64 %37
  ...
  %68 = getelementptr inbounds [65 x [65 x double]], [65 x [65 x double]]* %30, i64 %33, i64 %35, i64 %37
