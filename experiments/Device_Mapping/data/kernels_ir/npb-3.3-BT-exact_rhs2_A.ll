...
; <label>:113:                                    ; preds = %113, %106
  ...
  %157 = call double @llvm.fmuladd.f64(double %156, double -3.150000e+01, double %135)
  ...
  %162 = call double @llvm.fmuladd.f64(double %161, double 5.292000e+02, double %157)
  ...
  %167 = call double @llvm.fmuladd.f64(double %166, double 0x40A7418000000001, double %162)
  ...
  %179 = call double @llvm.fmuladd.f64(double %178, double -3.150000e+01, double %169)
  ...
  %188 = call double @llvm.fmuladd.f64(double %187, double 0x4078CE6666666667, double %179)
