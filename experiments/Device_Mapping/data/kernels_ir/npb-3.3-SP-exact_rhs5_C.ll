...
; <label>:22:                                     ; preds = %14
  %23 = bitcast double* %0 to [163 x [163 x [5 x double]]]*
  %24 = shl i64 %6, 32
  ...
  %30 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %23, i64 %25, i64 %27, i64 %29, i64 0
  %31 = load double, double* %30, align 8, !tbaa !8
  %32 = fsub double -0.000000e+00, %31
  store double %32, double* %30, align 8, !tbaa !8
  %33 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %23, i64 %25, i64 %27, i64 %29, i64 1
  %34 = load double, double* %33, align 8, !tbaa !8
  %35 = fsub double -0.000000e+00, %34
  store double %35, double* %33, align 8, !tbaa !8
  %36 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %23, i64 %25, i64 %27, i64 %29, i64 2
  %37 = load double, double* %36, align 8, !tbaa !8
  %38 = fsub double -0.000000e+00, %37
  store double %38, double* %36, align 8, !tbaa !8
  %39 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %23, i64 %25, i64 %27, i64 %29, i64 3
  %40 = load double, double* %39, align 8, !tbaa !8
  %41 = fsub double -0.000000e+00, %40
  store double %41, double* %39, align 8, !tbaa !8
  %42 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %23, i64 %25, i64 %27, i64 %29, i64 4
