; ModuleID = 'npb-BT-x_solve3.cl'
source_filename = "npb-BT-x_solve3.cl"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.13.0"

; Function Attrs: nounwind ssp uwtable
define spir_kernel void @x_solve3(double* readonly, double* readonly, double*, i32, i32, i32) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
...
; <label>:24:                                     ; preds = %17
  ...
  %46 = fmul double %45, 3.060300e+00
  %47 = fsub double -0.000000e+00, %46
  %48 = tail call double @llvm.fmuladd.f64(double %43, double 0xBF8F06F694467381, double %47)
  %49 = tail call double @llvm.fmuladd.f64(double -3.060300e+00, double 7.500000e-01, double %48)
  ...
  %56 = fmul double %55, 3.060300e+00
  %57 = fsub double -0.000000e+00, %56
  %58 = tail call double @llvm.fmuladd.f64(double %53, double 0xBF8F06F694467381, double %57)
  ...
  %64 = fmul double %63, 3.060300e+00
  %65 = fsub double -0.000000e+00, %64
  %66 = tail call double @llvm.fmuladd.f64(double %61, double 0xBF8F06F694467381, double %65)
  ...
  %72 = fmul double %71, 3.060300e+00
  %73 = fsub double -0.000000e+00, %72
  %74 = tail call double @llvm.fmuladd.f64(double %69, double 0xBF8F06F694467381, double %73)
  ...
  %80 = fmul double %79, 3.060300e+00
  %81 = fsub double -0.000000e+00, %80
  %82 = tail call double @llvm.fmuladd.f64(double %77, double 0xBF8F06F694467381, double %81)
  ...
  %88 = fmul double %87, 3.060300e+00
  %89 = fsub double -0.000000e+00, %88
  %90 = tail call double @llvm.fmuladd.f64(double %85, double 0xBF8F06F694467381, double %89)
  ...
  %96 = fmul double %95, 3.060300e+00
  %97 = fsub double -0.000000e+00, %96
  %98 = tail call double @llvm.fmuladd.f64(double %93, double 0xBF8F06F694467381, double %97)
  %99 = tail call double @llvm.fmuladd.f64(double -3.060300e+00, double 7.500000e-01, double %98)
  ...
  %105 = fmul double %104, 3.060300e+00
  %106 = fsub double -0.000000e+00, %105
  %107 = tail call double @llvm.fmuladd.f64(double %102, double 0xBF8F06F694467381, double %106)
  ...
  %113 = fmul double %112, 3.060300e+00
  %114 = fsub double -0.000000e+00, %113
  %115 = tail call double @llvm.fmuladd.f64(double %110, double 0xBF8F06F694467381, double %114)
  ...
  %121 = fmul double %120, 3.060300e+00
  %122 = fsub double -0.000000e+00, %121
  %123 = tail call double @llvm.fmuladd.f64(double %118, double 0xBF8F06F694467381, double %122)
  ...
  %129 = fmul double %128, 3.060300e+00
  %130 = fsub double -0.000000e+00, %129
  %131 = tail call double @llvm.fmuladd.f64(double %126, double 0xBF8F06F694467381, double %130)
  ...
  %137 = fmul double %136, 3.060300e+00
  %138 = fsub double -0.000000e+00, %137
  %139 = tail call double @llvm.fmuladd.f64(double %134, double 0xBF8F06F694467381, double %138)
  ...
  %145 = fmul double %144, 3.060300e+00
  %146 = fsub double -0.000000e+00, %145
  %147 = tail call double @llvm.fmuladd.f64(double %142, double 0xBF8F06F694467381, double %146)
  %148 = tail call double @llvm.fmuladd.f64(double -3.060300e+00, double 7.500000e-01, double %147)
  ...
  %154 = fmul double %153, 3.060300e+00
  %155 = fsub double -0.000000e+00, %154
  %156 = tail call double @llvm.fmuladd.f64(double %151, double 0xBF8F06F694467381, double %155)
  ...
  %162 = fmul double %161, 3.060300e+00
  %163 = fsub double -0.000000e+00, %162
  %164 = tail call double @llvm.fmuladd.f64(double %159, double 0xBF8F06F694467381, double %163)
  ...
  %170 = fmul double %169, 3.060300e+00
  %171 = fsub double -0.000000e+00, %170
  %172 = tail call double @llvm.fmuladd.f64(double %167, double 0xBF8F06F694467381, double %171)
  ...
  %178 = fmul double %177, 3.060300e+00
  %179 = fsub double -0.000000e+00, %178
  %180 = tail call double @llvm.fmuladd.f64(double %175, double 0xBF8F06F694467381, double %179)
  ...
  %186 = fmul double %185, 3.060300e+00
  %187 = fsub double -0.000000e+00, %186
  %188 = tail call double @llvm.fmuladd.f64(double %183, double 0xBF8F06F694467381, double %187)
  ...
  %194 = fmul double %193, 3.060300e+00
  %195 = fsub double -0.000000e+00, %194
  %196 = tail call double @llvm.fmuladd.f64(double %191, double 0xBF8F06F694467381, double %195)
  %197 = tail call double @llvm.fmuladd.f64(double -3.060300e+00, double 7.500000e-01, double %196)
  ...
  %203 = fmul double %202, 3.060300e+00
  %204 = fsub double -0.000000e+00, %203
  %205 = tail call double @llvm.fmuladd.f64(double %200, double 0xBF8F06F694467381, double %204)
  ...
  %211 = fmul double %210, 3.060300e+00
  %212 = fsub double -0.000000e+00, %211
  %213 = tail call double @llvm.fmuladd.f64(double %208, double 0xBF8F06F694467381, double %212)
  ...
  %219 = fmul double %218, 3.060300e+00
  %220 = fsub double -0.000000e+00, %219
  %221 = tail call double @llvm.fmuladd.f64(double %216, double 0xBF8F06F694467381, double %220)
  ...
  %227 = fmul double %226, 3.060300e+00
  %228 = fsub double -0.000000e+00, %227
  %229 = tail call double @llvm.fmuladd.f64(double %224, double 0xBF8F06F694467381, double %228)
  ...
  %235 = fmul double %234, 3.060300e+00
  %236 = fsub double -0.000000e+00, %235
  %237 = tail call double @llvm.fmuladd.f64(double %232, double 0xBF8F06F694467381, double %236)
  ...
  %243 = fmul double %242, 3.060300e+00
  %244 = fsub double -0.000000e+00, %243
  %245 = tail call double @llvm.fmuladd.f64(double %240, double 0xBF8F06F694467381, double %244)
  %246 = tail call double @llvm.fmuladd.f64(double -3.060300e+00, double 7.500000e-01, double %245)
  ...
  %250 = tail call double @llvm.fmuladd.f64(double %249, double 0x40187B7E90FF9724, double 1.000000e+00)
  %251 = tail call double @llvm.fmuladd.f64(double 0x40187B7E90FF9724, double 7.500000e-01, double %250)
  ...
  %255 = fmul double %254, 0x40187B7E90FF9724
  ...
  %259 = fmul double %258, 0x40187B7E90FF9724
  ...
  %263 = fmul double %262, 0x40187B7E90FF9724
  ...
  %267 = fmul double %266, 0x40187B7E90FF9724
  ...
  %271 = fmul double %270, 0x40187B7E90FF9724
  ...
  %275 = tail call double @llvm.fmuladd.f64(double %274, double 0x40187B7E90FF9724, double 1.000000e+00)
  %276 = tail call double @llvm.fmuladd.f64(double 0x40187B7E90FF9724, double 7.500000e-01, double %275)
  ...
  %280 = fmul double %279, 0x40187B7E90FF9724
  ...
  %284 = fmul double %283, 0x40187B7E90FF9724
  ...
  %288 = fmul double %287, 0x40187B7E90FF9724
  ...
  %292 = fmul double %291, 0x40187B7E90FF9724
  ...
  %296 = fmul double %295, 0x40187B7E90FF9724
  ...
  %300 = tail call double @llvm.fmuladd.f64(double %299, double 0x40187B7E90FF9724, double 1.000000e+00)
  %301 = tail call double @llvm.fmuladd.f64(double 0x40187B7E90FF9724, double 7.500000e-01, double %300)
  ...
  %305 = fmul double %304, 0x40187B7E90FF9724
  ...
  %309 = fmul double %308, 0x40187B7E90FF9724
  ...
  %313 = fmul double %312, 0x40187B7E90FF9724
  ...
  %317 = fmul double %316, 0x40187B7E90FF9724
  ...
  %321 = fmul double %320, 0x40187B7E90FF9724
  ...
  %325 = tail call double @llvm.fmuladd.f64(double %324, double 0x40187B7E90FF9724, double 1.000000e+00)
  %326 = tail call double @llvm.fmuladd.f64(double 0x40187B7E90FF9724, double 7.500000e-01, double %325)
  ...
  %330 = fmul double %329, 0x40187B7E90FF9724
  ...
  %334 = fmul double %333, 0x40187B7E90FF9724
  ...
  %338 = fmul double %337, 0x40187B7E90FF9724
  ...
  %342 = fmul double %341, 0x40187B7E90FF9724
  ...
  %346 = fmul double %345, 0x40187B7E90FF9724
  ...
  %350 = tail call double @llvm.fmuladd.f64(double %349, double 0x40187B7E90FF9724, double 1.000000e+00)
  %351 = tail call double @llvm.fmuladd.f64(double 0x40187B7E90FF9724, double 7.500000e-01, double %350)
  ...
  %359 = fmul double %358, 3.060300e+00
  %360 = fsub double -0.000000e+00, %359
  %361 = tail call double @llvm.fmuladd.f64(double %356, double 0x3F8F06F694467381, double %360)
  %362 = tail call double @llvm.fmuladd.f64(double -3.060300e+00, double 7.500000e-01, double %361)
  ...
  %368 = fmul double %367, 3.060300e+00
  %369 = fsub double -0.000000e+00, %368
  %370 = tail call double @llvm.fmuladd.f64(double %365, double 0x3F8F06F694467381, double %369)
  ...
  %376 = fmul double %375, 3.060300e+00
  %377 = fsub double -0.000000e+00, %376
  %378 = tail call double @llvm.fmuladd.f64(double %373, double 0x3F8F06F694467381, double %377)
  ...
  %384 = fmul double %383, 3.060300e+00
  %385 = fsub double -0.000000e+00, %384
  %386 = tail call double @llvm.fmuladd.f64(double %381, double 0x3F8F06F694467381, double %385)
  ...
  %392 = fmul double %391, 3.060300e+00
  %393 = fsub double -0.000000e+00, %392
  %394 = tail call double @llvm.fmuladd.f64(double %389, double 0x3F8F06F694467381, double %393)
  ...
  %400 = fmul double %399, 3.060300e+00
  %401 = fsub double -0.000000e+00, %400
  %402 = tail call double @llvm.fmuladd.f64(double %397, double 0x3F8F06F694467381, double %401)
  ...
  %408 = fmul double %407, 3.060300e+00
  %409 = fsub double -0.000000e+00, %408
  %410 = tail call double @llvm.fmuladd.f64(double %405, double 0x3F8F06F694467381, double %409)
  %411 = tail call double @llvm.fmuladd.f64(double -3.060300e+00, double 7.500000e-01, double %410)
  ...
  %417 = fmul double %416, 3.060300e+00
  %418 = fsub double -0.000000e+00, %417
  %419 = tail call double @llvm.fmuladd.f64(double %414, double 0x3F8F06F694467381, double %418)
  ...
  %425 = fmul double %424, 3.060300e+00
  %426 = fsub double -0.000000e+00, %425
  %427 = tail call double @llvm.fmuladd.f64(double %422, double 0x3F8F06F694467381, double %426)
  ...
  %433 = fmul double %432, 3.060300e+00
  %434 = fsub double -0.000000e+00, %433
  %435 = tail call double @llvm.fmuladd.f64(double %430, double 0x3F8F06F694467381, double %434)
  ...
  %441 = fmul double %440, 3.060300e+00
  %442 = fsub double -0.000000e+00, %441
  %443 = tail call double @llvm.fmuladd.f64(double %438, double 0x3F8F06F694467381, double %442)
  ...
  %449 = fmul double %448, 3.060300e+00
  %450 = fsub double -0.000000e+00, %449
  %451 = tail call double @llvm.fmuladd.f64(double %446, double 0x3F8F06F694467381, double %450)
  ...
  %457 = fmul double %456, 3.060300e+00
  %458 = fsub double -0.000000e+00, %457
  %459 = tail call double @llvm.fmuladd.f64(double %454, double 0x3F8F06F694467381, double %458)
  %460 = tail call double @llvm.fmuladd.f64(double -3.060300e+00, double 7.500000e-01, double %459)
  ...
  %466 = fmul double %465, 3.060300e+00
  %467 = fsub double -0.000000e+00, %466
  %468 = tail call double @llvm.fmuladd.f64(double %463, double 0x3F8F06F694467381, double %467)
  ...
  %474 = fmul double %473, 3.060300e+00
  %475 = fsub double -0.000000e+00, %474
  %476 = tail call double @llvm.fmuladd.f64(double %471, double 0x3F8F06F694467381, double %475)
  ...
  %482 = fmul double %481, 3.060300e+00
  %483 = fsub double -0.000000e+00, %482
  %484 = tail call double @llvm.fmuladd.f64(double %479, double 0x3F8F06F694467381, double %483)
  ...
  %490 = fmul double %489, 3.060300e+00
  %491 = fsub double -0.000000e+00, %490
  %492 = tail call double @llvm.fmuladd.f64(double %487, double 0x3F8F06F694467381, double %491)
  ...
  %498 = fmul double %497, 3.060300e+00
  %499 = fsub double -0.000000e+00, %498
  %500 = tail call double @llvm.fmuladd.f64(double %495, double 0x3F8F06F694467381, double %499)
  ...
  %506 = fmul double %505, 3.060300e+00
  %507 = fsub double -0.000000e+00, %506
  %508 = tail call double @llvm.fmuladd.f64(double %503, double 0x3F8F06F694467381, double %507)
  %509 = tail call double @llvm.fmuladd.f64(double -3.060300e+00, double 7.500000e-01, double %508)
  ...
  %515 = fmul double %514, 3.060300e+00
  %516 = fsub double -0.000000e+00, %515
  %517 = tail call double @llvm.fmuladd.f64(double %512, double 0x3F8F06F694467381, double %516)
  ...
  %523 = fmul double %522, 3.060300e+00
  %524 = fsub double -0.000000e+00, %523
  %525 = tail call double @llvm.fmuladd.f64(double %520, double 0x3F8F06F694467381, double %524)
  ...
  %531 = fmul double %530, 3.060300e+00
  %532 = fsub double -0.000000e+00, %531
  %533 = tail call double @llvm.fmuladd.f64(double %528, double 0x3F8F06F694467381, double %532)
  ...
  %539 = fmul double %538, 3.060300e+00
  %540 = fsub double -0.000000e+00, %539
  %541 = tail call double @llvm.fmuladd.f64(double %536, double 0x3F8F06F694467381, double %540)
  ...
  %547 = fmul double %546, 3.060300e+00
  %548 = fsub double -0.000000e+00, %547
  %549 = tail call double @llvm.fmuladd.f64(double %544, double 0x3F8F06F694467381, double %548)
  ...
  %555 = fmul double %554, 3.060300e+00
  %556 = fsub double -0.000000e+00, %555
  %557 = tail call double @llvm.fmuladd.f64(double %552, double 0x3F8F06F694467381, double %556)
  %558 = tail call double @llvm.fmuladd.f64(double -3.060300e+00, double 7.500000e-01, double %557)
