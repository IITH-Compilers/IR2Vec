; ModuleID = 'npb-SP-exact_rhs3.cl'
source_filename = "npb-SP-exact_rhs3.cl"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.13.0"

; Function Attrs: nounwind ssp uwtable
define spir_kernel void @exact_rhs3(double* nocapture, double*, double* nocapture, double* nocapture, double* nocapture, double*, i32, i32, i32) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
...
; <label>:23:                                     ; preds = %9
  ...
  %28 = mul nsw i32 %27, 162
  %29 = mul i32 %27, 810
  %30 = bitcast double* %0 to [163 x [163 x [5 x double]]]*
  ...
  %40 = fmul double %39, 0x3F7970E4F80CB872
  %41 = sitofp i32 %17 to double
  %42 = fmul double %41, 0x3F7970E4F80CB872
  %43 = icmp sgt i32 %7, 0
...
; <label>:53:                                     ; preds = %53, %46
  ...
  %61 = fmul double %60, 0x3F7970E4F80CB872
  call void @exact_solution(double %42, double %61, double %40, double* nonnull %47, double* %5) #5
  ...
  %85 = load double, double* %69, align 8, !tbaa !8
...
; <label>:113:                                    ; preds = %113, %106
  ...
  %117 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %108, i64 %114, i64 %110, i64 0
  %118 = load double, double* %117, align 8, !tbaa !8
  %119 = getelementptr inbounds [5 x double], [5 x double]* %33, i64 %116, i64 2
  %120 = load double, double* %119, align 8, !tbaa !8
  %121 = getelementptr inbounds [5 x double], [5 x double]* %33, i64 %115, i64 2
  %122 = load double, double* %121, align 8, !tbaa !8
  %123 = fsub double %120, %122
  %124 = call double @llvm.fmuladd.f64(double %123, double -8.050000e+01, double %118)
  ...
  %133 = call double @llvm.fmuladd.f64(double %132, double 0x40D2FC3000000001, double %124)
  store double %133, double* %117, align 8, !tbaa !8
  %134 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %108, i64 %114, i64 %110, i64 1
  ...
  %138 = getelementptr inbounds [5 x double], [5 x double]* %35, i64 %116, i64 2
  ...
  %142 = getelementptr inbounds [5 x double], [5 x double]* %35, i64 %115, i64 2
  ...
  %147 = call double @llvm.fmuladd.f64(double %146, double -8.050000e+01, double %135)
  ...
  %156 = call double @llvm.fmuladd.f64(double %155, double 0x40A4403333333334, double %147)
  ...
  %161 = call double @llvm.fmuladd.f64(double %160, double 0x40D2FC3000000001, double %156)
  store double %161, double* %134, align 8, !tbaa !8
  %162 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %108, i64 %114, i64 %110, i64 2
  %163 = load double, double* %162, align 8, !tbaa !8
  %164 = load double, double* %119, align 8, !tbaa !8
  %165 = load double, double* %138, align 8, !tbaa !8
  %166 = getelementptr inbounds [5 x double], [5 x double]* %33, i64 %116, i64 4
  %167 = load double, double* %166, align 8, !tbaa !8
  %168 = getelementptr inbounds double, double* %38, i64 %116
  %169 = load double, double* %168, align 8, !tbaa !8
  %170 = fsub double %167, %169
  %171 = fmul double %170, 4.000000e-01
  %172 = call double @llvm.fmuladd.f64(double %164, double %165, double %171)
  %173 = load double, double* %121, align 8, !tbaa !8
  %174 = load double, double* %142, align 8, !tbaa !8
  %175 = getelementptr inbounds [5 x double], [5 x double]* %33, i64 %115, i64 4
  %176 = load double, double* %175, align 8, !tbaa !8
  %177 = getelementptr inbounds double, double* %38, i64 %115
  %178 = load double, double* %177, align 8, !tbaa !8
  %179 = fsub double %176, %178
  %180 = fmul double %179, 4.000000e-01
  %181 = call double @llvm.fmuladd.f64(double %173, double %174, double %180)
  %182 = fsub double %172, %181
  %183 = call double @llvm.fmuladd.f64(double %182, double -8.050000e+01, double %163)
  %184 = getelementptr inbounds [5 x double], [5 x double]* %35, i64 %114, i64 2
  %185 = load double, double* %184, align 8, !tbaa !8
  %186 = call double @llvm.fmuladd.f64(double %185, double -2.000000e+00, double %165)
  %187 = fadd double %174, %186
  %188 = call double @llvm.fmuladd.f64(double %187, double 0x40AB004444444445, double %183)
  %189 = getelementptr inbounds [5 x double], [5 x double]* %33, i64 %114, i64 2
  %190 = load double, double* %189, align 8, !tbaa !8
  %191 = call double @llvm.fmuladd.f64(double %190, double -2.000000e+00, double %164)
  %192 = fadd double %173, %191
  %193 = call double @llvm.fmuladd.f64(double %192, double 0x40D2FC3000000001, double %188)
  store double %193, double* %162, align 8, !tbaa !8
  %194 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %108, i64 %114, i64 %110, i64 3
  ...
  %214 = call double @llvm.fmuladd.f64(double %213, double 0x40A4403333333334, double %205)
  ...
  %219 = call double @llvm.fmuladd.f64(double %218, double 0x40D2FC3000000001, double %214)
  store double %219, double* %194, align 8, !tbaa !8
  %220 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %108, i64 %114, i64 %110, i64 4
  %221 = load double, double* %220, align 8, !tbaa !8
  %222 = load double, double* %138, align 8, !tbaa !8
  %223 = load double, double* %166, align 8, !tbaa !8
  %224 = load double, double* %168, align 8, !tbaa !8
  ...
  %229 = load double, double* %175, align 8, !tbaa !8
  %230 = load double, double* %177, align 8, !tbaa !8
  ...
  %237 = call double @llvm.fmuladd.f64(double %236, double -8.050000e+01, double %221)
  ...
  %246 = call double @llvm.fmuladd.f64(double %245, double 0xC09370D4FDF3B645, double %237)
  ...
  %255 = call double @llvm.fmuladd.f64(double %254, double 0x407B004444444445, double %246)
  ...
  %264 = call double @llvm.fmuladd.f64(double %263, double 0x40B3D884189374BC, double %255)
  ...
  %269 = call double @llvm.fmuladd.f64(double %268, double 0x40D2FC3000000001, double %264)
...
; <label>:271:                                    ; preds = %113, %100
  ...
  %279 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 1, i64 %273, i64 0
  ...
  %289 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 2, i64 %273, i64 0
  ...
  %300 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 1, i64 %273, i64 1
  ...
  %313 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 2, i64 %273, i64 1
  ...
  %325 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 1, i64 %273, i64 2
  ...
  %338 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 2, i64 %273, i64 2
  ...
  %350 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 1, i64 %273, i64 3
  ...
  %363 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 2, i64 %273, i64 3
  ...
  %375 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 1, i64 %273, i64 4
  ...
  %388 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 2, i64 %273, i64 4
...
; <label>:404:                                    ; preds = %404, %402
  ...
  %406 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %405, i64 %273, i64 0
...
; <label>:432:                                    ; preds = %432, %430
  ...
  %434 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %433, i64 %273, i64 1
...
; <label>:459:                                    ; preds = %459, %457
  ...
  %461 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %460, i64 %273, i64 2
...
; <label>:486:                                    ; preds = %486, %484
  ...
  %488 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %487, i64 %273, i64 3
...
; <label>:513:                                    ; preds = %513, %511
  ...
  %515 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %514, i64 %273, i64 4
...
; <label>:537:                                    ; preds = %513, %271, %428, %456, %483, %510
  ...
  %544 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %538, i64 %273, i64 0
  ...
  %558 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %543, i64 %273, i64 0
  ...
  %566 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %538, i64 %273, i64 1
  ...
  %580 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %543, i64 %273, i64 1
  ...
  %588 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %538, i64 %273, i64 2
  ...
  %602 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %543, i64 %273, i64 2
  ...
  %610 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %538, i64 %273, i64 3
  ...
  %624 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %543, i64 %273, i64 3
  ...
  %632 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %538, i64 %273, i64 4
  ...
  %646 = getelementptr inbounds [163 x [163 x [5 x double]]], [163 x [163 x [5 x double]]]* %30, i64 %274, i64 %543, i64 %273, i64 4
