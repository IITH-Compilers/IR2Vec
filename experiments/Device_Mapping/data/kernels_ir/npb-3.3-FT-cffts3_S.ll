...
@cffts3.ty1 = internal global [64 x %struct.dcomplex] undef, align 16
@cffts3.ty2 = internal global [64 x %struct.dcomplex] undef, align 16
...
; <label>:29:                                     ; preds = %19
  ...
  %37 = getelementptr inbounds [64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 %22
  ...
  %42 = getelementptr inbounds [64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 %22, i32 1
...
; <label>:49:                                     ; preds = %45, %84, %8
  ...
  tail call void @cfftz(i32 %3, i32 %7, i32 %6, %struct.dcomplex* %2, %struct.dcomplex* getelementptr inbounds ([64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 0), %struct.dcomplex* getelementptr inbounds ([64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty2, i64 0, i64 0)) #6
  tail call void @_Z7barrierj(i32 1) #5
...
; <label>:64:                                     ; preds = %51
  ...
  %68 = getelementptr inbounds [64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 %54
  ...
  %74 = getelementptr inbounds [64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 %54, i32 1
...
; <label>:84:                                     ; preds = %84, %48
  ...
  %93 = getelementptr inbounds [64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 %85
  ...
  %98 = getelementptr inbounds [64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 %85, i32 1
  ...
  %108 = getelementptr inbounds [64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 %100
  ...
  %113 = getelementptr inbounds [64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 %100, i32 1
...
; <label>:118:                                    ; preds = %118, %83
  ...
  %123 = getelementptr inbounds [64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 %119
  ...
  %129 = getelementptr inbounds [64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 %119, i32 1
  ...
  %138 = getelementptr inbounds [64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 %134
  ...
  %144 = getelementptr inbounds [64 x %struct.dcomplex], [64 x %struct.dcomplex]* @cffts3.ty1, i64 0, i64 %134, i32 1
