...
@cffts2.ty1 = internal global [128 x %struct.dcomplex] undef, align 16
@cffts2.ty2 = internal global [128 x %struct.dcomplex] undef, align 16
...
; <label>:31:                                     ; preds = %20
  ...
  %37 = getelementptr inbounds [128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 %22
  ...
  %42 = getelementptr inbounds [128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 %22, i32 1
...
; <label>:49:                                     ; preds = %45, %83, %8
  ...
  tail call void @cfftz(i32 %3, i32 %7, i32 %5, %struct.dcomplex* %2, %struct.dcomplex* getelementptr inbounds ([128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 0), %struct.dcomplex* getelementptr inbounds ([128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty2, i64 0, i64 0)) #6
  tail call void @_Z7barrierj(i32 1) #5
...
; <label>:65:                                     ; preds = %51
  ...
  %68 = getelementptr inbounds [128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 %53
  ...
  %73 = getelementptr inbounds [128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 %53, i32 1
...
; <label>:83:                                     ; preds = %83, %48
  ...
  %90 = getelementptr inbounds [128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 %84
  ...
  %95 = getelementptr inbounds [128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 %84, i32 1
  ...
  %103 = getelementptr inbounds [128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 %97
  ...
  %108 = getelementptr inbounds [128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 %97, i32 1
...
; <label>:113:                                    ; preds = %113, %82
  ...
  %117 = getelementptr inbounds [128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 %114
  ...
  %122 = getelementptr inbounds [128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 %114, i32 1
  ...
  %130 = getelementptr inbounds [128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 %127
  ...
  %135 = getelementptr inbounds [128 x %struct.dcomplex], [128 x %struct.dcomplex]* @cffts2.ty1, i64 0, i64 %127, i32 1
