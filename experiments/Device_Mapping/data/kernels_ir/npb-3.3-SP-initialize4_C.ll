; ModuleID = 'npb-SP-initialize4.cl'
source_filename = "npb-SP-initialize4.cl"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.13.0"

; Function Attrs: nounwind ssp uwtable
define spir_kernel void @initialize4(double* nocapture, double*, i32, i32, i32) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
...
; <label>:15:                                     ; preds = %5
  ...
  call void @exact_solution(double %19, double 0.000000e+00, double %17, double* nonnull %20, double* %1) #4
  %21 = shl i64 %8, 32
  %22 = ashr exact i64 %21, 32
  %23 = shl i64 %10, 32
  %24 = ashr exact i64 %23, 32
  %25 = mul nsw i64 %22, 132845
  %26 = mul nsw i64 %24, 5
  %27 = add i64 %25, %26
  ...
  %30 = add nsw i32 %3, -1
  call void @exact_solution(double %19, double 1.000000e+00, double %17, double* nonnull %20, double* %1) #4
  %31 = sext i32 %30 to i64
  %32 = mul nsw i64 %31, 815
  %33 = add i64 %25, %32
  %34 = add i64 %33, %26
