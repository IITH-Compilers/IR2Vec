...
; <label>:14:                                     ; preds = %10
  %15 = bitcast i32* %4 to [14 x i32]*
  %16 = bitcast double* %5 to [14 x double]*
...
; <label>:63:                                     ; preds = %61, %149
  ...
  %66 = getelementptr inbounds [14 x i32], [14 x i32]* %15, i64 %56, i64 %65
  %67 = load i32, i32* %66, align 4, !tbaa !8
  %68 = icmp eq i32 %67, %12
  br i1 %68, label %69, label %149

; <label>:69:                                     ; preds = %63
  %70 = getelementptr inbounds [14 x double], [14 x double]* %16, i64 %56, i64 %65
...
; <label>:75:                                     ; preds = %74, %139
  ...
  %77 = getelementptr inbounds [14 x i32], [14 x i32]* %15, i64 %56, i64 %76
  %78 = load i32, i32* %77, align 4, !tbaa !8
  %79 = getelementptr inbounds [14 x double], [14 x double]* %16, i64 %56, i64 %76
  %80 = load double, double* %79, align 8, !tbaa !12
  %81 = fmul double %72, %80
  %82 = icmp eq i32 %78, %12
  %83 = and i1 %62, %82
  %84 = fadd double %81, 1.000000e-01
  %85 = fadd double %84, -6.000000e+01
