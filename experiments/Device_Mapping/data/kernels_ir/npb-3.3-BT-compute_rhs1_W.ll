; ModuleID = 'npb-BT-compute_rhs1_W.cl'
source_filename = "npb-BT-compute_rhs1_W.cl"
...
; <label>:22:                                     ; preds = %10
  %23 = bitcast double* %0 to [25 x [25 x [5 x double]]]*
  %24 = bitcast double* %1 to [25 x [25 x double]]*
  %25 = bitcast double* %2 to [25 x [25 x double]]*
  %26 = bitcast double* %3 to [25 x [25 x double]]*
  %27 = bitcast double* %4 to [25 x [25 x double]]*
  %28 = bitcast double* %5 to [25 x [25 x double]]*
  %29 = bitcast double* %6 to [25 x [25 x double]]*
  %30 = shl i64 %11, 32
  ...
  %36 = getelementptr inbounds [25 x [25 x [5 x double]]], [25 x [25 x [5 x double]]]* %23, i64 %31, i64 %33, i64 %35, i64 0
  %37 = load double, double* %36, align 8, !tbaa !8
  %38 = getelementptr inbounds [25 x [25 x [5 x double]]], [25 x [25 x [5 x double]]]* %23, i64 %31, i64 %33, i64 %35, i64 1
  %39 = load double, double* %38, align 8, !tbaa !8
  %40 = getelementptr inbounds [25 x [25 x [5 x double]]], [25 x [25 x [5 x double]]]* %23, i64 %31, i64 %33, i64 %35, i64 2
  %41 = load double, double* %40, align 8, !tbaa !8
  %42 = getelementptr inbounds [25 x [25 x [5 x double]]], [25 x [25 x [5 x double]]]* %23, i64 %31, i64 %33, i64 %35, i64 3
  %43 = load double, double* %42, align 8, !tbaa !8
  %44 = fdiv double 1.000000e+00, %37
  %45 = getelementptr inbounds [25 x [25 x double]], [25 x [25 x double]]* %28, i64 %31, i64 %33, i64 %35
  store double %44, double* %45, align 8, !tbaa !8
  %46 = fmul double %39, %44
  %47 = getelementptr inbounds [25 x [25 x double]], [25 x [25 x double]]* %24, i64 %31, i64 %33, i64 %35
  store double %46, double* %47, align 8, !tbaa !8
  %48 = fmul double %44, %41
  %49 = getelementptr inbounds [25 x [25 x double]], [25 x [25 x double]]* %25, i64 %31, i64 %33, i64 %35
  store double %48, double* %49, align 8, !tbaa !8
  %50 = fmul double %44, %43
  %51 = getelementptr inbounds [25 x [25 x double]], [25 x [25 x double]]* %26, i64 %31, i64 %33, i64 %35
  ...
  %57 = getelementptr inbounds [25 x [25 x double]], [25 x [25 x double]]* %29, i64 %31, i64 %33, i64 %35
  store double %56, double* %57, align 8, !tbaa !8
  %58 = fmul double %44, %56
  %59 = getelementptr inbounds [25 x [25 x double]], [25 x [25 x double]]* %27, i64 %31, i64 %33, i64 %35
