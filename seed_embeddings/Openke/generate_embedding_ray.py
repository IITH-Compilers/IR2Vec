...
def train(arg_conf):
    ...
    model = NegativeSampling(
        ...
        # train the model
    trainer = Trainer(model = model, data_loader = train_dataloader, train_times = arg_conf["epoch"], alpha = arg_conf["alpha"])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--is_analogy", dest="is_analogy", help="Uses Analogies while training", required=False, type=bool, default= False
    )
    parser.add_argument(
        "--dim",
        dest="dim",
