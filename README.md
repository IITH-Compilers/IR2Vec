...
IR2Vec installation has alternatives which have been provided to accommodate individual preferences and requirements effectively. You may select Python for a streamlined and user-friendly setup or opt for C++ if you necessitate advanced control and enhanced integration capabilities.The detailed setup steps are mentioned in the following sections.

## Python

If you prefer working with Python, you can easily install IR2Vec using pip. Ensure you have Python installed on your system. If not, download and install Python from [Python's official website](https://www.python.org/downloads/).
