...
[![LLVM](https://img.shields.io/badge/LLVM-v16.0.6-blue)](https://github.com/llvm/llvm-project/releases/tag/llvmorg-16.0.6)
...
* cmake (>= 3.13.4)
* GNU Make (4.2.1)
* LLVM (16.0.6) - [src](https://github.com/llvm/llvm-project/tree/release/16.x), [release](https://releases.llvm.org/download.html#16.0.6)
