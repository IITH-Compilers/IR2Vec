...
# Generating .ll files for re-training.
   ...
   - CPU/SPEC .c++ files compilation with the relevant LLVM version.
      - For detailed instructions on this step, refer to [here](spec_compilation.md).
...
# Cosmetics
   ...
   - The instructions to generate a new Docker image for the updated version are available [here](docker_update.md)
