...
define dso_local i32 @_Z9maxDivideii(i32 %0, i32 %1) #0 {
...
; Function Attrs: noinline nounwind uwtable mustprogress
define dso_local i32 @_Z6isUglyi(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = call i32 @_Z9maxDivideii(i32 %3, i32 2)
  store i32 %4, i32* %2, align 4
  %5 = load i32, i32* %2, align 4
  %6 = call i32 @_Z9maxDivideii(i32 %5, i32 3)
  store i32 %6, i32* %2, align 4
  %7 = load i32, i32* %2, align 4
  %8 = call i32 @_Z9maxDivideii(i32 %7, i32 5)
...
; Function Attrs: noinline nounwind uwtable mustprogress
define dso_local i32 @_Z12getNthUglyNoi(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
...
define dso_local i32 @main() #1 {
  ...
  %3 = call i32 @_Z12getNthUglyNoi(i32 150)
  store i32 %3, i32* %2, align 4
  %4 = load i32, i32* %2, align 4
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0), i32 %4)
  %6 = call i32 @getchar()
  ret i32 0
}
