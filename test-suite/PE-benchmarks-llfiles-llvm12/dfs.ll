...
; Function Attrs: noinline uwtable mustprogress
define dso_local void @_ZN5Graph3DFSEi(%class.Graph* nonnull dereferenceable(16) %0, i32 %1) #7 align 2 {
  %3 = alloca %class.Graph*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i8*, align 8
  %6 = alloca i32, align 4
...
25:                                               ; preds = %12
  ...
  call void @_ZN5Graph7DFSUtilEiPb(%class.Graph* nonnull dereferenceable(16) %7, i32 %26, i8* %27)
  ret void
}
...
define dso_local i32 @main() #10 {
  ...
  %3 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([62 x i8], [62 x i8]* @.str.1, i64 0, i64 0))
  call void @_ZN5Graph3DFSEi(%class.Graph* nonnull dereferenceable(16) %2, i32 2)
  ret i32 0
}
