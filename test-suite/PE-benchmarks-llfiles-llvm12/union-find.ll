...
define dso_local %class.Graph* @_Z11createGraphii(i32 %0, i32 %1) #4 {
  ...
  %24 = call noalias nonnull i8* @_Znam(i64 %23) #9
...
; Function Attrs: noinline uwtable mustprogress
define dso_local i32 @_Z4findPii(i32* %0, i32 %1) #4 {
  %3 = alloca i32, align 4
...
14:                                               ; preds = %2
  ...
  %21 = call i32 @_Z4findPii(i32* %15, i32 %20)
...
; Function Attrs: noinline uwtable mustprogress
define dso_local void @_Z5UnionPiii(i32* %0, i32 %1, i32 %2) #4 {
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
  ...
  %11 = call i32 @_Z4findPii(i32* %9, i32 %10)
  store i32 %11, i32* %7, align 4
  %12 = load i32*, i32** %4, align 8
  %13 = load i32, i32* %6, align 4
  %14 = call i32 @_Z4findPii(i32* %12, i32 %13)
...
; Function Attrs: noinline uwtable mustprogress
define dso_local i32 @_Z7isCycleP5Graph(%class.Graph* %0) #4 {
  ...
  %17 = call noalias nonnull i8* @_Znam(i64 %16) #9
...
32:                                               ; preds = %26
  ...
  %42 = call i32 @_Z4findPii(i32* %33, i32 %41)
  ...
  %52 = call i32 @_Z4findPii(i32* %43, i32 %51)
...
57:                                               ; preds = %32
  ...
  call void @_Z5UnionPiii(i32* %58, i32 %59, i32 %60)
  br label %61
...
define dso_local i32 @main() #8 {
  ...
  %7 = call %class.Graph* @_Z11createGraphii(i32 %5, i32 %6)
  ...
  %39 = call i32 @_Z7isCycleP5Graph(%class.Graph* %38)
  %40 = icmp ne i32 %39, 0
  br i1 %40, label %41, label %43

41:                                               ; preds = %0
  %42 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0))
  br label %45

43:                                               ; preds = %0
  %44 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i64 0, i64 0))
  br label %45
