...
define dso_local double @_Z3mindd(double %0, double %1) #4 {
...
define dso_local double @_Z4dist5PointS_(i64 %0, i64 %1) #5 {
...
; Function Attrs: noinline uwtable mustprogress
define dso_local double @_Z4costP5Pointiii(%struct.Point* %0, i32 %1, i32 %2, i32 %3) #5 {
  ...
  %44 = call double @_Z4dist5PointS_(i64 %41, i64 %43)
  ...
  %53 = call double @_Z4dist5PointS_(i64 %50, i64 %52)
  ...
  %63 = call double @_Z4dist5PointS_(i64 %60, i64 %62)
...
; Function Attrs: noinline uwtable mustprogress
define dso_local double @_Z5mTCDPP5Pointi(%struct.Point* %0, i32 %1) #5 {
  %3 = alloca double, align 8
...
62:                                               ; preds = %58
  ...
  %84 = call double @_Z4costP5Pointiii(%struct.Point* %80, i32 %81, i32 %82, i32 %83)
...
define dso_local i32 @main() #8 {
  ...
  %18 = call double @_Z5mTCDPP5Pointi(%struct.Point* %16, i32 %17)
  %19 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* nonnull dereferenceable(8) @_ZSt4cout, double %18)
  ret i32 0
}
...
declare dso_local nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* nonnull dereferenceable(8), double) #1
