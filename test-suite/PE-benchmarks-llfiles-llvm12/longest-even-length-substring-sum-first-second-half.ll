...
define dso_local i32 @_Z10findLengthPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
define dso_local i32 @main() #7 {
  ...
  %4 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i64 0, i64 0))
  %5 = getelementptr inbounds [7 x i8], [7 x i8]* %2, i64 0, i64 0
  %6 = call i32 @_Z10findLengthPc(i8* %5)
