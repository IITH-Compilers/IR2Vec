...
; Function Attrs: noinline nounwind uwtable mustprogress
define dso_local i32 @_Z7eggDropii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i8*, align 8
...
76:                                               ; preds = %72
  ...
  %97 = call i32 @_Z3maxii(i32 %86, i32 %96)
  %98 = add nsw i32 1, %97
...
define dso_local i32 @main() #2 {
  ...
  %8 = call i32 @_Z7eggDropii(i32 %6, i32 %7)
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([75 x i8], [75 x i8]* @.str, i64 0, i64 0), i32 %4, i32 %5, i32 %8)
  ret i32 0
}
