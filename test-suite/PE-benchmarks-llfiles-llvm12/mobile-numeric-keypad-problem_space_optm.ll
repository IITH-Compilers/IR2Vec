...
define dso_local i32 @main() #1 {
  ...
  %5 = call i32 @_Z8getCountPA3_ci([3 x i8]* %4, i32 1)
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 1, i32 %5)
  %7 = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %2, i64 0, i64 0
  %8 = call i32 @_Z8getCountPA3_ci([3 x i8]* %7, i32 2)
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 2, i32 %8)
  %10 = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %2, i64 0, i64 0
  %11 = call i32 @_Z8getCountPA3_ci([3 x i8]* %10, i32 3)
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 3, i32 %11)
  %13 = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %2, i64 0, i64 0
  %14 = call i32 @_Z8getCountPA3_ci([3 x i8]* %13, i32 4)
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 4, i32 %14)
  %16 = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %2, i64 0, i64 0
  %17 = call i32 @_Z8getCountPA3_ci([3 x i8]* %16, i32 5)
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 5, i32 %17)
  ret i32 0
}
