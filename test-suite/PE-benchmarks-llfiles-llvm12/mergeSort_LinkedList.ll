...
define dso_local void @_Z9MergeSortPP4Node(%class.Node** %0) #4 {
...
16:                                               ; preds = %10
  ...
  call void @_Z14FrontBackSplitP4NodePS0_S1_(%class.Node* %17, %class.Node** %4, %class.Node** %5)
  call void @_Z9MergeSortPP4Node(%class.Node** %4)
  call void @_Z9MergeSortPP4Node(%class.Node** %5)
  %18 = load %class.Node*, %class.Node** %4, align 8
  %19 = load %class.Node*, %class.Node** %5, align 8
  %20 = call %class.Node* @_Z11SortedMergeP4NodeS0_(%class.Node* %18, %class.Node* %19)
...
define dso_local void @_Z14FrontBackSplitP4NodePS0_S1_(%class.Node* %0, %class.Node** %1, %class.Node** %2) #5 {
  %4 = alloca %class.Node*, align 8
  %5 = alloca %class.Node**, align 8
...
; Function Attrs: noinline uwtable mustprogress
define dso_local %class.Node* @_Z11SortedMergeP4NodeS0_(%class.Node* %0, %class.Node* %1) #4 {
  %3 = alloca %class.Node*, align 8
  %4 = alloca %class.Node*, align 8
  %5 = alloca %class.Node*, align 8
  %6 = alloca %class.Node*, align 8
...
25:                                               ; preds = %17
  ...
  %31 = call %class.Node* @_Z11SortedMergeP4NodeS0_(%class.Node* %29, %class.Node* %30)
...
34:                                               ; preds = %17
  ...
  %40 = call %class.Node* @_Z11SortedMergeP4NodeS0_(%class.Node* %36, %class.Node* %39)
...
; Function Attrs: noinline uwtable mustprogress
define dso_local void @_Z9printListP4Node(%class.Node* %0) #4 {
  %2 = alloca %class.Node*, align 8
  store %class.Node* %0, %class.Node** %2, align 8
  br label %3
...
; Function Attrs: noinline uwtable mustprogress
define dso_local void @_Z4pushPP4Nodei(%class.Node** %0, i32 %1) #4 {
  %3 = alloca %class.Node**, align 8
...
define dso_local i32 @main() #8 {
  ...
  call void @_Z4pushPP4Nodei(%class.Node** %3, i32 15)
  call void @_Z4pushPP4Nodei(%class.Node** %3, i32 10)
  call void @_Z4pushPP4Nodei(%class.Node** %3, i32 5)
  call void @_Z4pushPP4Nodei(%class.Node** %3, i32 20)
  call void @_Z4pushPP4Nodei(%class.Node** %3, i32 3)
  call void @_Z4pushPP4Nodei(%class.Node** %3, i32 2)
  call void @_Z9MergeSortPP4Node(%class.Node** %3)
  %4 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i64 0, i64 0))
  %5 = load %class.Node*, %class.Node** %3, align 8
  call void @_Z9printListP4Node(%class.Node* %5)
  ret i32 0
}
