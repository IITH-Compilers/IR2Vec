...
define dso_local zeroext i1 @_Z6isSafePA4_iii([4 x i32]* %0, i32 %1, i32 %2) #2 {
  %4 = alloca i1, align 1
...
; Function Attrs: noinline uwtable mustprogress
define dso_local zeroext i1 @_Z9solveMazePA4_i([4 x i32]* %0) #0 {
  %2 = alloca i1, align 1
  ...
  %8 = call zeroext i1 @_Z13solveMazeUtilPA4_iiiS0_([4 x i32]* %6, i32 0, i32 0, [4 x i32]* %7)
  %9 = zext i1 %8 to i32
  %10 = icmp eq i32 %9, 0
  br i1 %10, label %11, label %13

11:                                               ; preds = %1
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i64 0, i64 0))
  store i1 false, i1* %2, align 1
  br label %15

13:                                               ; preds = %1
  %14 = getelementptr inbounds [4 x [4 x i32]], [4 x [4 x i32]]* %4, i64 0, i64 0
  call void @_Z13printSolutionPA4_i([4 x i32]* %14)
...
; Function Attrs: noinline uwtable mustprogress
define dso_local zeroext i1 @_Z13solveMazeUtilPA4_iiiS0_([4 x i32]* %0, i32 %1, i32 %2, [4 x i32]* %3) #0 {
  %5 = alloca i1, align 1
...
23:                                               ; preds = %12, %4
  ...
  %27 = call zeroext i1 @_Z6isSafePA4_iii([4 x i32]* %24, i32 %25, i32 %26)
...
30:                                               ; preds = %23
  ...
  %43 = call zeroext i1 @_Z13solveMazeUtilPA4_iiiS0_([4 x i32]* %38, i32 %40, i32 %41, [4 x i32]* %42)
...
47:                                               ; preds = %30
  ...
  %53 = call zeroext i1 @_Z13solveMazeUtilPA4_iiiS0_([4 x i32]* %48, i32 %49, i32 %51, [4 x i32]* %52)
...
define dso_local i32 @main() #4 {
  ...
  %5 = call zeroext i1 @_Z9solveMazePA4_i([4 x i32]* %4)
  ret i32 0
}
