...
def main():
    parser = argparse.ArgumentParser(description="Generate vocabulary and factory files.")
    parser.add_argument('type', choices=['vocab', 'base'], help="Type of files to generate.")
    parser.add_argument('input', help="Input vocabulary text file or dimensions as a comma-separated list.")
    ...
    if args.type == 'vocab':
        ...
        dim = os.path.splitext(os.path.basename(vocab_file))[0].split("D")[0].split("Vocab")[-1]
        ...
        class_names = [f"Vocabulary{dim}D" for dim in dimensions]  # Create class names based on dimensions
