...
// vec matrixTimesVector( const matrix &A, const vec &V )     // Matrix times
// vector
// {
//    int n = A.size();
//    vec C( n );
...
// double innerProduct( const vec &U, const vec &V )          // Inner product
// of U and V
// {
...
//     matrix M(rows, std::vector<double>(1)); // Initialize matrix with n rows
//     and 1 column for (size_t i = 0; i < V.size(); ++i) {
