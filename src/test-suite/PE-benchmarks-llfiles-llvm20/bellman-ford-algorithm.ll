...
define dso_local noundef ptr @_Z11createGraphii(i32 noundef %0, i32 noundef %1) #0 {
  ...
  %21 = getelementptr inbounds nuw %struct.Graph, ptr %20, i32 0, i32 2
...
55:                                               ; preds = %51
  ...
  %62 = getelementptr inbounds nuw %struct.Edge, ptr %61, i32 0, i32 0
  %63 = load i32, ptr %62, align 4
  store i32 %63, ptr %12, align 4
  %64 = load ptr, ptr %3, align 8
  %65 = getelementptr inbounds nuw %struct.Graph, ptr %64, i32 0, i32 2
  %66 = load ptr, ptr %65, align 8
  %67 = load i32, ptr %11, align 4
  %68 = sext i32 %67 to i64
  %69 = getelementptr inbounds %struct.Edge, ptr %66, i64 %68
  %70 = getelementptr inbounds nuw %struct.Edge, ptr %69, i32 0, i32 1
  %71 = load i32, ptr %70, align 4
  store i32 %71, ptr %13, align 4
  %72 = load ptr, ptr %3, align 8
  %73 = getelementptr inbounds nuw %struct.Graph, ptr %72, i32 0, i32 2
...
120:                                              ; preds = %116
  ...
  %122 = getelementptr inbounds nuw %struct.Graph, ptr %121, i32 0, i32 2
  %123 = load ptr, ptr %122, align 8
  %124 = load i32, ptr %15, align 4
  %125 = sext i32 %124 to i64
  %126 = getelementptr inbounds %struct.Edge, ptr %123, i64 %125
  %127 = getelementptr inbounds nuw %struct.Edge, ptr %126, i32 0, i32 0
  %128 = load i32, ptr %127, align 4
  store i32 %128, ptr %16, align 4
  %129 = load ptr, ptr %3, align 8
  %130 = getelementptr inbounds nuw %struct.Graph, ptr %129, i32 0, i32 2
  %131 = load ptr, ptr %130, align 8
  %132 = load i32, ptr %15, align 4
  %133 = sext i32 %132 to i64
  %134 = getelementptr inbounds %struct.Edge, ptr %131, i64 %133
  %135 = getelementptr inbounds nuw %struct.Edge, ptr %134, i32 0, i32 1
  %136 = load i32, ptr %135, align 4
  store i32 %136, ptr %17, align 4
  %137 = load ptr, ptr %3, align 8
  %138 = getelementptr inbounds nuw %struct.Graph, ptr %137, i32 0, i32 2
  %139 = load ptr, ptr %138, align 8
  %140 = load i32, ptr %15, align 4
  %141 = sext i32 %140 to i64
  %142 = getelementptr inbounds %struct.Edge, ptr %139, i64 %141
  %143 = getelementptr inbounds nuw %struct.Edge, ptr %142, i32 0, i32 2
...
define dso_local noundef i32 @main() #5 {
  ...
  %84 = getelementptr inbounds nuw %struct.Graph, ptr %83, i32 0, i32 2
  %85 = load ptr, ptr %84, align 8
  %86 = getelementptr inbounds %struct.Edge, ptr %85, i64 5
  %87 = getelementptr inbounds nuw %struct.Edge, ptr %86, i32 0, i32 0
  store i32 3, ptr %87, align 4
  %88 = load ptr, ptr %4, align 8
  %89 = getelementptr inbounds nuw %struct.Graph, ptr %88, i32 0, i32 2
  %90 = load ptr, ptr %89, align 8
  %91 = getelementptr inbounds %struct.Edge, ptr %90, i64 5
  %92 = getelementptr inbounds nuw %struct.Edge, ptr %91, i32 0, i32 1
  store i32 2, ptr %92, align 4
  %93 = load ptr, ptr %4, align 8
  %94 = getelementptr inbounds nuw %struct.Graph, ptr %93, i32 0, i32 2
  ...
  %99 = getelementptr inbounds nuw %struct.Graph, ptr %98, i32 0, i32 2
  %100 = load ptr, ptr %99, align 8
  %101 = getelementptr inbounds %struct.Edge, ptr %100, i64 6
  %102 = getelementptr inbounds nuw %struct.Edge, ptr %101, i32 0, i32 0
  store i32 3, ptr %102, align 4
  %103 = load ptr, ptr %4, align 8
  %104 = getelementptr inbounds nuw %struct.Graph, ptr %103, i32 0, i32 2
  %105 = load ptr, ptr %104, align 8
  %106 = getelementptr inbounds %struct.Edge, ptr %105, i64 6
  %107 = getelementptr inbounds nuw %struct.Edge, ptr %106, i32 0, i32 1
  store i32 1, ptr %107, align 4
  %108 = load ptr, ptr %4, align 8
  %109 = getelementptr inbounds nuw %struct.Graph, ptr %108, i32 0, i32 2
  %110 = load ptr, ptr %109, align 8
  %111 = getelementptr inbounds %struct.Edge, ptr %110, i64 6
  %112 = getelementptr inbounds nuw %struct.Edge, ptr %111, i32 0, i32 2
  store i32 1, ptr %112, align 4
  %113 = load ptr, ptr %4, align 8
  %114 = getelementptr inbounds nuw %struct.Graph, ptr %113, i32 0, i32 2
  %115 = load ptr, ptr %114, align 8
  %116 = getelementptr inbounds %struct.Edge, ptr %115, i64 7
  %117 = getelementptr inbounds nuw %struct.Edge, ptr %116, i32 0, i32 0
  store i32 4, ptr %117, align 4
  %118 = load ptr, ptr %4, align 8
  %119 = getelementptr inbounds nuw %struct.Graph, ptr %118, i32 0, i32 2
  %120 = load ptr, ptr %119, align 8
  %121 = getelementptr inbounds %struct.Edge, ptr %120, i64 7
  %122 = getelementptr inbounds nuw %struct.Edge, ptr %121, i32 0, i32 1
  store i32 3, ptr %122, align 4
  %123 = load ptr, ptr %4, align 8
  %124 = getelementptr inbounds nuw %struct.Graph, ptr %123, i32 0, i32 2
  %125 = load ptr, ptr %124, align 8
  %126 = getelementptr inbounds %struct.Edge, ptr %125, i64 7
  %127 = getelementptr inbounds nuw %struct.Edge, ptr %126, i32 0, i32 2
