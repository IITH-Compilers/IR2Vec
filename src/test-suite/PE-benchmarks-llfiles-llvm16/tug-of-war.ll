...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_tug_of_war.cpp, ptr null }]
...
define dso_local void @_Z7TOWUtilPiiPbiS0_S_iii(ptr noundef %0, i32 noundef %1, ptr noundef %2, i32 noundef %3, ptr noundef %4, ptr noundef %5, i32 noundef %6, i32 noundef %7, i32 noundef %8) #4 {
...
62:                                               ; preds = %34
  ...
  %67 = call i32 @abs(i32 noundef %66) #9
...
71:                                               ; preds = %62
  ...
  %76 = call i32 @abs(i32 noundef %75) #9
...
; Function Attrs: mustprogress noinline uwtable
define dso_local void @_Z8tugOfWarPii(ptr noundef %0, i32 noundef %1) #4 {
  ...
  %17 = call noalias noundef nonnull ptr @_Znam(i64 noundef %16) #10
