...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_maximum_length_chain_of_pairs.cpp, ptr null }]
...
define dso_local noundef i32 @_Z14maxChainLengthP4Pairi(ptr noundef %0, i32 noundef %1) #4 {
  ...
  %16 = call noalias noundef nonnull ptr @_Znam(i64 noundef %15) #9
