...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_union_find.cpp, ptr null }]
...
define dso_local noundef ptr @_Z11createGraphii(i32 noundef %0, i32 noundef %1) #4 {
  ...
  %22 = call noalias noundef nonnull ptr @_Znam(i64 noundef %21) #9
...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef i32 @_Z4findPii(ptr noundef %0, i32 noundef %1) #4 {
  %3 = alloca i32, align 4
...
; Function Attrs: mustprogress noinline uwtable
define dso_local void @_Z5UnionPiii(ptr noundef %0, i32 noundef %1, i32 noundef %2) #4 {
  %4 = alloca ptr, align 8
  %5 = alloca i32, align 4
...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef i32 @_Z7isCycleP5Graph(ptr noundef %0) #4 {
  ...
  %17 = call noalias noundef nonnull ptr @_Znam(i64 noundef %16) #9
