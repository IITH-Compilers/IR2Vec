; ModuleID = 'PE-benchmarks/little-and-big-endian-mystery.cpp'
...
define dso_local void @_Z12show_mem_repPci(ptr noundef %0, i32 noundef %1) #0 {
...
define dso_local noundef i32 @main() #2 {
  ...
  call void @_Z12show_mem_repPci(ptr noundef %2, i32 noundef 4)
  %3 = call i32 @getchar()
  ret i32 0
}
...
<<<<<<<< HEAD:src/test-suite/PE-benchmarks-llfiles-llvm18/little-and-big-endian-mystery.ll
...
>>>>>>>> llvm19.1.7:src/test-suite/PE-benchmarks-llfiles-llvm19/little-and-big-endian-mystery.ll
!6 = distinct !{!6, !7}
