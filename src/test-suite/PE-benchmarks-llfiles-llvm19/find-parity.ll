...
define dso_local noundef i32 @_Z9getParityj(i32 noundef %0) #0 {
...
<<<<<<<< HEAD:src/test-suite/PE-benchmarks-llfiles-llvm18/find-parity.ll
...
>>>>>>>> llvm19.1.7:src/test-suite/PE-benchmarks-llfiles-llvm19/find-parity.ll
!6 = distinct !{!6, !7}
