...
<<<<<<<< HEAD:src/test-suite/PE-benchmarks-llfiles-llvm18/matrix-chain-multiplication.ll
...
>>>>>>>> llvm19.1.7:src/test-suite/PE-benchmarks-llfiles-llvm19/matrix-chain-multiplication.ll
!6 = distinct !{!6, !7}
