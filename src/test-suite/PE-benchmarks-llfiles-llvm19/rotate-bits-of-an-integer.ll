...
<<<<<<<< HEAD:src/test-suite/PE-benchmarks-llfiles-llvm18/rotate-bits-of-an-integer.ll
...
>>>>>>>> llvm19.1.7:src/test-suite/PE-benchmarks-llfiles-llvm19/rotate-bits-of-an-integer.ll
