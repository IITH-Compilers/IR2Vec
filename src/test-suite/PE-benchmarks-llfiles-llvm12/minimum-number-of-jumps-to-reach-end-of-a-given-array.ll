...
define dso_local i32 @_Z8minJumpsPii(i32* %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  ...
  %15 = call noalias nonnull i8* @_Znam(i64 %14) #10
...
58:                                               ; preds = %51
  ...
  %69 = add nsw i32 %68, 1
  %70 = call i32 @_Z3minii(i32 %63, i32 %69)
...
define dso_local i32 @main() #8 {
  ...
  %5 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str, i64 0, i64 0))
  %6 = getelementptr inbounds [6 x i32], [6 x i32]* %2, i64 0, i64 0
  %7 = load i32, i32* %3, align 4
  %8 = call i32 @_Z8minJumpsPii(i32* %6, i32 %7)
