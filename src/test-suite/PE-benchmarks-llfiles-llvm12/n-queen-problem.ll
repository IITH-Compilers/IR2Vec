...
; Function Attrs: noinline uwtable mustprogress
define dso_local zeroext i1 @_Z11solveNQUtilPA4_ii([4 x i32]* %0, i32 %1) #0 {
  %3 = alloca i1, align 1
...
38:                                               ; preds = %32
  ...
  %63 = add nsw i32 %62, 1
  %64 = call zeroext i1 @_Z11solveNQUtilPA4_ii([4 x i32]* %61, i32 %63)
...
define dso_local zeroext i1 @_Z7solveNQv() #0 {
  ...
  %5 = call zeroext i1 @_Z11solveNQUtilPA4_ii([4 x i32]* %4, i32 0)
  %6 = zext i1 %5 to i32
  %7 = icmp eq i32 %6, 0
...
10:                                               ; preds = %0
  ...
  call void @_Z13printSolutionPA4_i([4 x i32]* %11)
