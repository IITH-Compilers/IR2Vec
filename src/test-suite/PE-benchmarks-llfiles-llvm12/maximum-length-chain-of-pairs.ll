...
define dso_local i32 @_Z14maxChainLengthP4Pairi(%class.Pair* %0, i32 %1) #4 {
  ...
  %16 = call noalias nonnull i8* @_Znam(i64 %15) #9
...
define dso_local i32 @main() #7 {
  ...
  %5 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str, i64 0, i64 0))
  %6 = getelementptr inbounds [4 x %class.Pair], [4 x %class.Pair]* %2, i64 0, i64 0
  %7 = load i32, i32* %3, align 4
  %8 = call i32 @_Z14maxChainLengthP4Pairi(%class.Pair* %6, i32 %7)
