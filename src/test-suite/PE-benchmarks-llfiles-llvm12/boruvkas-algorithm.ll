...
define dso_local void @_Z10boruvkaMSTP5Graph(%struct.Graph* %0) #0 {
  ...
  %33 = call noalias nonnull i8* @_Znam(i64 %32) #5
  ...
  %41 = call noalias nonnull i8* @_Znam(i64 %40) #5
...
89:                                               ; preds = %85
  ...
  %97 = call i32 @_Z4findP6subseti(%struct.subset* %90, i32 %96)
  ...
  %105 = call i32 @_Z4findP6subseti(%struct.subset* %98, i32 %104)
...
189:                                              ; preds = %182
  ...
  %201 = call i32 @_Z4findP6subseti(%struct.subset* %190, i32 %200)
  ...
  %213 = call i32 @_Z4findP6subseti(%struct.subset* %202, i32 %212)
...
218:                                              ; preds = %189
  ...
  %251 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i64 0, i64 0), i32 %240, i32 %250)
  %252 = load %struct.subset*, %struct.subset** %6, align 8
  %253 = load i32, i32* %16, align 4
  %254 = load i32, i32* %17, align 4
  call void @_Z5UnionP6subsetii(%struct.subset* %252, i32 %253, i32 %254)
...
262:                                              ; preds = %68
  ...
  %264 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0), i32 %263)
  ret void
}
...
; Function Attrs: noinline uwtable mustprogress
define dso_local i32 @_Z4findP6subseti(%struct.subset* %0, i32 %1) #0 {
...
13:                                               ; preds = %2
  ...
  %21 = call i32 @_Z4findP6subseti(%struct.subset* %14, i32 %20)
...
; Function Attrs: noinline uwtable mustprogress
define dso_local void @_Z5UnionP6subsetii(%struct.subset* %0, i32 %1, i32 %2) #0 {
  ...
  %11 = call i32 @_Z4findP6subseti(%struct.subset* %9, i32 %10)
  store i32 %11, i32* %7, align 4
  %12 = load %struct.subset*, %struct.subset** %4, align 8
  %13 = load i32, i32* %6, align 4
  %14 = call i32 @_Z4findP6subseti(%struct.subset* %12, i32 %13)
...
; Function Attrs: noinline uwtable mustprogress
define dso_local %struct.Graph* @_Z11createGraphii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  ...
  %20 = call noalias nonnull i8* @_Znam(i64 %19) #5
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z10boruvkaMSTP5Graph(%struct.Graph* %83)
  ret i32 0
}
