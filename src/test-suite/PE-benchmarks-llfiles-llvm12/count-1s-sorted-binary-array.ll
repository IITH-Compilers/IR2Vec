...
define dso_local i32 @_Z9countOnesPbii(i8* %0, i32 %1, i32 %2) #4 {
...
53:                                               ; preds = %44
  ...
  %58 = call i32 @_Z9countOnesPbii(i8* %54, i32 %56, i32 %57)
...
59:                                               ; preds = %44
  ...
  %63 = sub nsw i32 %62, 1
  %64 = call i32 @_Z9countOnesPbii(i8* %60, i32 %61, i32 %63)
...
define dso_local i32 @main() #5 {
  ...
  %5 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str, i64 0, i64 0))
  %6 = getelementptr inbounds [7 x i8], [7 x i8]* %2, i64 0, i64 0
  %7 = load i32, i32* %3, align 4
  %8 = sub nsw i32 %7, 1
  %9 = call i32 @_Z9countOnesPbii(i8* %6, i32 0, i32 %8)
  %10 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* nonnull dereferenceable(8) %5, i32 %9)
  ret i32 0
}
