...
define dso_local i32 @_Z8superSeqPcS_ii(i8* %0, i8* %1, i32 %2, i32 %3) #4 {
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
...
91:                                               ; preds = %56
  ...
  %108 = call nonnull align 4 dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* nonnull align 4 dereferenceable(4) %99, i32* nonnull align 4 dereferenceable(4) %107)
...
define dso_local i32 @main() #7 {
  ...
  %6 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str, i64 0, i64 0))
  ...
  %15 = call i32 @_Z8superSeqPcS_ii(i8* %7, i8* %8, i32 %11, i32 %14)
  %16 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* nonnull dereferenceable(8) %6, i32 %15)
  ret i32 0
}
