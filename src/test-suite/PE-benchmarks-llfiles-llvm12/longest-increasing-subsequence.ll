...
define dso_local i32 @_Z4_lisPiiS_(i32* %0, i32 %1, i32* %2) #0 {
...
19:                                               ; preds = %15
  ...
  %23 = call i32 @_Z4_lisPiiS_(i32* %20, i32 %21, i32* %22)
...
; Function Attrs: noinline uwtable mustprogress
define dso_local i32 @_Z3lisPii(i32* %0, i32 %1) #0 {
  ...
  %8 = call i32 @_Z4_lisPiiS_(i32* %6, i32 %7, i32* %5)
...
define dso_local i32 @main() #1 {
  ...
  %7 = call i32 @_Z3lisPii(i32* %5, i32 %6)
