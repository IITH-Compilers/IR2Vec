...
; Function Attrs: noinline nounwind uwtable mustprogress
define dso_local i32 @_Z13minPalPartionPc(i8* %0) #0 {
  %2 = alloca i8*, align 8
  %3 = alloca i32, align 4
  %4 = alloca i8*, align 8
...
define dso_local i32 @main() #3 {
  ...
  %5 = call i32 @_Z13minPalPartionPc(i8* %4)
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str, i64 0, i64 0), i32 %5)
  ret i32 0
}
