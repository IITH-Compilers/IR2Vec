...
define dso_local i32 @_Z9maxProfitPii(i32* %0, i32 %1) #4 {
  ...
  %20 = call noalias nonnull i8* @_Znam(i64 %19) #11
...
60:                                               ; preds = %54, %46
  ...
  %73 = call nonnull align 4 dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* nonnull align 4 dereferenceable(4) %65, i32* nonnull align 4 dereferenceable(4) %9)
...
104:                                              ; preds = %98, %90
  ...
  %123 = call nonnull align 4 dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* nonnull align 4 dereferenceable(4) %109, i32* nonnull align 4 dereferenceable(4) %12)
...
define linkonce_odr dso_local nonnull align 4 dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* nonnull align 4 dereferenceable(4) %0, i32* nonnull align 4 dereferenceable(4) %1) #7 comdat {
  %3 = alloca i32*, align 8
...
define dso_local i32 @main() #9 {
  ...
  %5 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0))
  %6 = getelementptr inbounds [7 x i32], [7 x i32]* %2, i64 0, i64 0
  %7 = load i32, i32* %3, align 4
  %8 = call i32 @_Z9maxProfitPii(i32* %6, i32 %7)
...
attributes #8 = { nobuiltin nounwind "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" "unsafe-fp-math"="false" "use-soft-float"="false" }
