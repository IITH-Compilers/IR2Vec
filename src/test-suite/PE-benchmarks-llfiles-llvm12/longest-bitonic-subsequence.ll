...
define dso_local i32 @_Z3lbsPii(i32* %0, i32 %1) #0 {
  ...
  %16 = call noalias nonnull i8* @_Znam(i64 %15) #6
...
84:                                               ; preds = %31
  ...
  %91 = call noalias nonnull i8* @_Znam(i64 %90) #6
...
define dso_local i32 @main() #3 {
  ...
  %7 = call i32 @_Z3lbsPii(i32* %5, i32 %6)
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0), i32 %7)
  ret i32 0
}
