...
define dso_local i32 @_Z8maxSumISPii(i32* %0, i32 %1) #4 {
...
define dso_local i32 @main() #6 {
  ...
  %5 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str, i64 0, i64 0))
  %6 = getelementptr inbounds [7 x i32], [7 x i32]* %2, i64 0, i64 0
  %7 = load i32, i32* %3, align 4
  %8 = call i32 @_Z8maxSumISPii(i32* %6, i32 %7)
  ...
  %10 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* nonnull dereferenceable(8) %9, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  ret i32 0
}
