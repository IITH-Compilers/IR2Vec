...
; Function Attrs: noinline nounwind uwtable mustprogress
define dso_local i32 @_Z6cutRodPii(i32* %0, i32 %1) #0 {
...
25:                                               ; preds = %21
  ...
  %40 = call i32 @_Z3maxii(i32 %26, i32 %39)
...
define dso_local i32 @main() #2 {
  ...
  %7 = call i32 @_Z6cutRodPii(i32* %5, i32 %6)
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str, i64 0, i64 0), i32 %7)
  %9 = call i32 @getchar()
  ret i32 0
}
