...
define dso_local void @_Z4pushPP4Nodei(%struct.Node** %0, i32 %1) #4 {
...
; Function Attrs: noinline uwtable mustprogress
define dso_local void @_Z9printListP4Node(%struct.Node* %0) #4 {
...
define dso_local %struct.Node* @_Z7getTailP4Node(%struct.Node* %0) #6 {
  %2 = alloca %struct.Node*, align 8
  store %struct.Node* %0, %struct.Node** %2, align 8
  br label %3
...
; Function Attrs: noinline nounwind uwtable mustprogress
define dso_local %struct.Node* @_Z9partitionP4NodeS0_PS0_S1_(%struct.Node* %0, %struct.Node* %1, %struct.Node** %2, %struct.Node** %3) #6 {
  %5 = alloca %struct.Node*, align 8
...
; Function Attrs: noinline uwtable mustprogress
define dso_local %struct.Node* @_Z14quickSortRecurP4NodeS0_(%struct.Node* %0, %struct.Node* %1) #4 {
  %3 = alloca %struct.Node*, align 8
...
18:                                               ; preds = %12
  ...
  %21 = call %struct.Node* @_Z9partitionP4NodeS0_PS0_S1_(%struct.Node* %19, %struct.Node* %20, %struct.Node** %6, %struct.Node** %7)
...
37:                                               ; preds = %27
  ...
  %42 = call %struct.Node* @_Z14quickSortRecurP4NodeS0_(%struct.Node* %40, %struct.Node* %41)
  store %struct.Node* %42, %struct.Node** %6, align 8
  %43 = load %struct.Node*, %struct.Node** %6, align 8
  %44 = call %struct.Node* @_Z7getTailP4Node(%struct.Node* %43)
...
48:                                               ; preds = %37, %18
  ...
  %53 = call %struct.Node* @_Z14quickSortRecurP4NodeS0_(%struct.Node* %51, %struct.Node* %52)
...
; Function Attrs: noinline uwtable mustprogress
define dso_local void @_Z9quickSortPP4Node(%struct.Node** %0) #4 {
  %2 = alloca %struct.Node**, align 8
  store %struct.Node** %0, %struct.Node*** %2, align 8
  ...
  %7 = call %struct.Node* @_Z7getTailP4Node(%struct.Node* %6)
  %8 = call %struct.Node* @_Z14quickSortRecurP4NodeS0_(%struct.Node* %4, %struct.Node* %7)
...
define dso_local i32 @main() #7 {
  ...
  %3 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0))
  %4 = load %struct.Node*, %struct.Node** %2, align 8
  call void @_Z9printListP4Node(%struct.Node* %4)
  call void @_Z9quickSortPP4Node(%struct.Node** %2)
  %5 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i64 0, i64 0))
