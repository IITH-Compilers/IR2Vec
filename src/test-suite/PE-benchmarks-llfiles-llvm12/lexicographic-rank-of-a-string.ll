...
define dso_local i32 @_Z4facti(i32 %0) #4 {
...
define dso_local i32 @_Z18findSmallerInRightPcii(i8* %0, i32 %1, i32 %2) #5 {
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable mustprogress
define dso_local i32 @_Z8findRankPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
17:                                               ; preds = %13
  ...
  %26 = sub nsw i32 %25, 1
  %27 = call i32 @_Z18findSmallerInRightPcii(i8* %23, i32 %24, i32 %26)
