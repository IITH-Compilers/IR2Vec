...
define dso_local i32 @_Z8getCountPA3_ci([3 x i8]* %0, i32 %1) #0 {
...
define dso_local i32 @main(i32 %0, i8** %1) #3 {
  ...
  %9 = call i32 @_Z8getCountPA3_ci([3 x i8]* %8, i32 1)
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 1, i32 %9)
  %11 = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %6, i64 0, i64 0
  %12 = call i32 @_Z8getCountPA3_ci([3 x i8]* %11, i32 2)
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 2, i32 %12)
  %14 = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %6, i64 0, i64 0
  %15 = call i32 @_Z8getCountPA3_ci([3 x i8]* %14, i32 3)
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 3, i32 %15)
  %17 = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %6, i64 0, i64 0
  %18 = call i32 @_Z8getCountPA3_ci([3 x i8]* %17, i32 4)
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 4, i32 %18)
  %20 = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %6, i64 0, i64 0
  %21 = call i32 @_Z8getCountPA3_ci([3 x i8]* %20, i32 5)
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0), i32 5, i32 %21)
  ret i32 0
}
