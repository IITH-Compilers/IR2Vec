...
define dso_local noundef i32 @_Z9maxProfitPii(i32* noundef %0, i32 noundef %1) #0 {
  ...
  %20 = call noalias noundef nonnull i8* @_Znam(i64 noundef %19) #8
...
141:                                              ; preds = %132
  ...
  call void @_ZdaPv(i8* noundef %142) #9
  br label %143
