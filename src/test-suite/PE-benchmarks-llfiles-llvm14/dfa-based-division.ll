...
define dso_local void @_Z10preprocessiPA2_i(i32 noundef %0, [2 x i32]* noundef %1) #0 {
...
define dso_local void @_Z15isDivisibleUtiliPiPA2_i(i32 noundef %0, i32* noundef %1, [2 x i32]* noundef %2) #1 {
...
9:                                                ; preds = %3
  ...
  call void @_Z15isDivisibleUtiliPiPA2_i(i32 noundef %11, i32* noundef %12, [2 x i32]* noundef %13)
...
define dso_local noundef i32 @_Z11isDivisibleii(i32 noundef %0, i32 noundef %1) #1 {
  ...
  call void @_Z10preprocessiPA2_i(i32 noundef %12, [2 x i32]* noundef %13)
  store i32 0, i32* %6, align 4
  %14 = load i32, i32* %3, align 4
  %15 = load [2 x i32]*, [2 x i32]** %5, align 8
  call void @_Z15isDivisibleUtiliPiPA2_i(i32 noundef %14, i32* noundef %6, [2 x i32]* noundef %15)
...
10:                                               ; preds = %0
  %11 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0))
  br label %15

12:                                               ; preds = %0
  %13 = load i32, i32* %4, align 4
  %14 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([32 x i8], [32 x i8]* @.str.1, i64 0, i64 0), i32 noundef %13)
  br label %15
