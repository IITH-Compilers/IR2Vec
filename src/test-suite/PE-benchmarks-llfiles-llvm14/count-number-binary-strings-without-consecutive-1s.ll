...
define dso_local noundef i32 @_Z12countStringsi(i32 noundef %0) #4 {
...
define dso_local noundef i32 @main() #6 {
  ...
  %3 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %2)
