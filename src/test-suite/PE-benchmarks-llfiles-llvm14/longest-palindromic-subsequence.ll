...
; Function Attrs: mustprogress noinline nounwind uwtable
define dso_local noundef i32 @_Z3lpsPc(i8* noundef %0) #0 {
  %2 = alloca i8*, align 8
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
define dso_local noundef i32 @main() #3 {
  ...
  %9 = call noundef i32 @_Z3lpsPc(i8* noundef %8)
  %10 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i64 0, i64 0), i32 noundef %9)
  %11 = call i32 @getchar()
  ret i32 0
}
