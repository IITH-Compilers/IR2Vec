...
define dso_local noundef i32 @_Z20buildMatchingMachinePNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEi(%"class.std::__cxx11::basic_string"* noundef %0, i32 noundef %1) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
28:                                               ; preds = %67, %23
  ...
  %32 = call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4sizeEv(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %31) #13
...
34:                                               ; preds = %28
  ...
  %38 = call noundef nonnull align 1 dereferenceable(1) i8* @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %35, i64 noundef %37) #13
...
120:                                              ; preds = %169, %135, %133, %129, %109
  ...
  call void @_ZNSt5queueIiSt5dequeIiSaIiEEED2Ev(%"class.std::queue"* noundef nonnull align 8 dereferenceable(80) %12) #13
  br label %216
...
define linkonce_odr dso_local void @_ZNSt5queueIiSt5dequeIiSaIiEEEC2IS2_vEEv(%"class.std::queue"* noundef nonnull align 8 dereferenceable(80) %0) unnamed_addr #3 comdat align 2 {
...
define linkonce_odr dso_local noundef i64 @_ZNKSt5queueIiSt5dequeIiSaIiEEE4sizeEv(%"class.std::queue"* noundef nonnull align 8 dereferenceable(80) %0) #4 comdat align 2 {
  %2 = alloca %"class.std::queue"*, align 8
  store %"class.std::queue"* %0, %"class.std::queue"** %2, align 8
  %3 = load %"class.std::queue"*, %"class.std::queue"** %2, align 8
  %4 = getelementptr inbounds %"class.std::queue", %"class.std::queue"* %3, i32 0, i32 0
  %5 = call noundef i64 @_ZNKSt5dequeIiSaIiEE4sizeEv(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %4) #13
  ret i64 %5
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef nonnull align 4 dereferenceable(4) i32* @_ZNSt5queueIiSt5dequeIiSaIiEEE5frontEv(%"class.std::queue"* noundef nonnull align 8 dereferenceable(80) %0) #4 comdat align 2 {
  %2 = alloca %"class.std::queue"*, align 8
  store %"class.std::queue"* %0, %"class.std::queue"** %2, align 8
  %3 = load %"class.std::queue"*, %"class.std::queue"** %2, align 8
  %4 = getelementptr inbounds %"class.std::queue", %"class.std::queue"* %3, i32 0, i32 0
  %5 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZNSt5dequeIiSaIiEE5frontEv(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %4) #13
  ret i32* %5
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt5queueIiSt5dequeIiSaIiEEE3popEv(%"class.std::queue"* noundef nonnull align 8 dereferenceable(80) %0) #4 comdat align 2 {
  %2 = alloca %"class.std::queue"*, align 8
  store %"class.std::queue"* %0, %"class.std::queue"** %2, align 8
  %3 = load %"class.std::queue"*, %"class.std::queue"** %2, align 8
  %4 = getelementptr inbounds %"class.std::queue", %"class.std::queue"* %3, i32 0, i32 0
  call void @_ZNSt5dequeIiSaIiEE9pop_frontEv(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %4) #13
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt5queueIiSt5dequeIiSaIiEEED2Ev(%"class.std::queue"* noundef nonnull align 8 dereferenceable(80) %0) unnamed_addr #5 comdat align 2 {
  %2 = alloca %"class.std::queue"*, align 8
  store %"class.std::queue"* %0, %"class.std::queue"** %2, align 8
  %3 = load %"class.std::queue"*, %"class.std::queue"** %2, align 8
  %4 = getelementptr inbounds %"class.std::queue", %"class.std::queue"* %3, i32 0, i32 0
  call void @_ZNSt5dequeIiSaIiEED2Ev(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %4) #13
  ret void
}

; Function Attrs: mustprogress noinline nounwind uwtable
define dso_local noundef i32 @_Z13findNextStateic(i32 noundef %0, i8 noundef signext %1) #4 {
...
; Function Attrs: mustprogress noinline uwtable
define dso_local void @_Z11searchWordsPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEiS4_(%"class.std::__cxx11::basic_string"* noundef %0, i32 noundef %1, %"class.std::__cxx11::basic_string"* noundef %2) #0 {
...
12:                                               ; preds = %71, %3
  ...
  %15 = call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4sizeEv(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %2) #13
...
44:                                               ; preds = %35
  ...
  %58 = call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4sizeEv(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %57) #13
  %59 = sub i64 %53, %58
  %60 = add i64 %59, 1
...
declare noundef nonnull align 1 dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32), i64 noundef) #6
...
declare noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8), %"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32)) #6

declare noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8), i64 noundef) #6
...
declare noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8), %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* noundef) #6

declare noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8)) #6
...
define dso_local noundef i32 @main() #7 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %22 = alloca [4 x %"class.std::__cxx11::basic_string"], align 16
  ...
  %35 = getelementptr inbounds [4 x %"class.std::__cxx11::basic_string"], [4 x %"class.std::__cxx11::basic_string"]* %22, i64 0, i64 0
  store i1 true, i1* %30, align 1
  store %"class.std::__cxx11::basic_string"* %35, %"class.std::__cxx11::basic_string"** %23, align 8
  store %"class.std::allocator"* %24, %"class.std::allocator"** %20, align 8
  %36 = load %"class.std::allocator"*, %"class.std::allocator"** %20, align 8
  %37 = bitcast %"class.std::allocator"* %36 to %"class.std::__new_allocator"*
  store %"class.std::__new_allocator"* %37, %"class.std::__new_allocator"** %1, align 8
  %38 = load %"class.std::__new_allocator"*, %"class.std::__new_allocator"** %1, align 8
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %35, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), %"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %24)
...
39:                                               ; preds = %0
  ...
  store %"class.std::__cxx11::basic_string"* %40, %"class.std::__cxx11::basic_string"** %23, align 8
  store %"class.std::allocator"* %27, %"class.std::allocator"** %19, align 8
  %41 = load %"class.std::allocator"*, %"class.std::allocator"** %19, align 8
  %42 = bitcast %"class.std::allocator"* %41 to %"class.std::__new_allocator"*
  store %"class.std::__new_allocator"* %42, %"class.std::__new_allocator"** %2, align 8
  %43 = load %"class.std::__new_allocator"*, %"class.std::__new_allocator"** %2, align 8
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %40, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), %"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %27)
          to label %44 unwind label %79

44:                                               ; preds = %39
  %45 = getelementptr inbounds %"class.std::__cxx11::basic_string", %"class.std::__cxx11::basic_string"* %40, i64 1
  store %"class.std::__cxx11::basic_string"* %45, %"class.std::__cxx11::basic_string"** %23, align 8
  store %"class.std::allocator"* %28, %"class.std::allocator"** %18, align 8
  %46 = load %"class.std::allocator"*, %"class.std::allocator"** %18, align 8
  %47 = bitcast %"class.std::allocator"* %46 to %"class.std::__new_allocator"*
  store %"class.std::__new_allocator"* %47, %"class.std::__new_allocator"** %3, align 8
  %48 = load %"class.std::__new_allocator"*, %"class.std::__new_allocator"** %3, align 8
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %45, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i64 0, i64 0), %"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %28)
...
49:                                               ; preds = %44
  ...
  store %"class.std::__cxx11::basic_string"* %50, %"class.std::__cxx11::basic_string"** %23, align 8
  store %"class.std::allocator"* %29, %"class.std::allocator"** %17, align 8
  %51 = load %"class.std::allocator"*, %"class.std::allocator"** %17, align 8
  %52 = bitcast %"class.std::allocator"* %51 to %"class.std::__new_allocator"*
  store %"class.std::__new_allocator"* %52, %"class.std::__new_allocator"** %4, align 8
  %53 = load %"class.std::__new_allocator"*, %"class.std::__new_allocator"** %4, align 8
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %50, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i64 0, i64 0), %"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %29)
          to label %54 unwind label %87

54:                                               ; preds = %49
  store i1 false, i1* %30, align 1
  store %"class.std::allocator"* %29, %"class.std::allocator"** %15, align 8
  %55 = load %"class.std::allocator"*, %"class.std::allocator"** %15, align 8
  %56 = bitcast %"class.std::allocator"* %55 to %"class.std::__new_allocator"*
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %56) #13
  store %"class.std::allocator"* %28, %"class.std::allocator"** %13, align 8
  %57 = load %"class.std::allocator"*, %"class.std::allocator"** %13, align 8
  %58 = bitcast %"class.std::allocator"* %57 to %"class.std::__new_allocator"*
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %58) #13
  store %"class.std::allocator"* %27, %"class.std::allocator"** %11, align 8
  %59 = load %"class.std::allocator"*, %"class.std::allocator"** %11, align 8
  %60 = bitcast %"class.std::allocator"* %59 to %"class.std::__new_allocator"*
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %60) #13
  store %"class.std::allocator"* %24, %"class.std::allocator"** %9, align 8
  %61 = load %"class.std::allocator"*, %"class.std::allocator"** %9, align 8
  %62 = bitcast %"class.std::allocator"* %61 to %"class.std::__new_allocator"*
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %62) #13
  store %"class.std::allocator"* %32, %"class.std::allocator"** %16, align 8
  %63 = load %"class.std::allocator"*, %"class.std::allocator"** %16, align 8
  %64 = bitcast %"class.std::allocator"* %63 to %"class.std::__new_allocator"*
  store %"class.std::__new_allocator"* %64, %"class.std::__new_allocator"** %5, align 8
  %65 = load %"class.std::__new_allocator"*, %"class.std::__new_allocator"** %5, align 8
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %31, i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str.7, i64 0, i64 0), %"class.std::allocator"* noundef nonnull align 1 dereferenceable(1) %32)
          to label %66 unwind label %112

66:                                               ; preds = %54
  store %"class.std::allocator"* %32, %"class.std::allocator"** %7, align 8
  %67 = load %"class.std::allocator"*, %"class.std::allocator"** %7, align 8
  %68 = bitcast %"class.std::allocator"* %67 to %"class.std::__new_allocator"*
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %68) #13
  store i32 4, i32* %33, align 4
  %69 = getelementptr inbounds [4 x %"class.std::__cxx11::basic_string"], [4 x %"class.std::__cxx11::basic_string"]* %22, i64 0, i64 0
  %70 = load i32, i32* %33, align 4
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1ERKS4_(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %34, %"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %31)
          to label %71 unwind label %118

71:                                               ; preds = %66
  invoke void @_Z11searchWordsPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEiS4_(%"class.std::__cxx11::basic_string"* noundef %69, i32 noundef %70, %"class.std::__cxx11::basic_string"* noundef %34)
          to label %72 unwind label %122

72:                                               ; preds = %71
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %34) #13
  store i32 0, i32* %21, align 4
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %31) #13
  %73 = getelementptr inbounds [4 x %"class.std::__cxx11::basic_string"], [4 x %"class.std::__cxx11::basic_string"]* %22, i32 0, i32 0
  %74 = getelementptr inbounds %"class.std::__cxx11::basic_string", %"class.std::__cxx11::basic_string"* %73, i64 4
  br label %127
...
87:                                               ; preds = %49
  ...
  store %"class.std::allocator"* %29, %"class.std::allocator"** %14, align 8
  %91 = load %"class.std::allocator"*, %"class.std::allocator"** %14, align 8
  %92 = bitcast %"class.std::allocator"* %91 to %"class.std::__new_allocator"*
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %92) #13
  br label %93

93:                                               ; preds = %87, %83
  store %"class.std::allocator"* %28, %"class.std::allocator"** %12, align 8
  %94 = load %"class.std::allocator"*, %"class.std::allocator"** %12, align 8
  %95 = bitcast %"class.std::allocator"* %94 to %"class.std::__new_allocator"*
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %95) #13
  br label %96

96:                                               ; preds = %93, %79
  store %"class.std::allocator"* %27, %"class.std::allocator"** %10, align 8
  %97 = load %"class.std::allocator"*, %"class.std::allocator"** %10, align 8
  %98 = bitcast %"class.std::allocator"* %97 to %"class.std::__new_allocator"*
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %98) #13
  br label %99

99:                                               ; preds = %96, %75
  store %"class.std::allocator"* %24, %"class.std::allocator"** %8, align 8
  %100 = load %"class.std::allocator"*, %"class.std::allocator"** %8, align 8
  %101 = bitcast %"class.std::allocator"* %100 to %"class.std::__new_allocator"*
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %101) #13
  %102 = load i1, i1* %30, align 1
  br i1 %102, label %103, label %111

103:                                              ; preds = %99
  %104 = load %"class.std::__cxx11::basic_string"*, %"class.std::__cxx11::basic_string"** %23, align 8
  %105 = icmp eq %"class.std::__cxx11::basic_string"* %35, %104
  br i1 %105, label %110, label %106

106:                                              ; preds = %106, %103
  %107 = phi %"class.std::__cxx11::basic_string"* [ %104, %103 ], [ %108, %106 ]
  %108 = getelementptr inbounds %"class.std::__cxx11::basic_string", %"class.std::__cxx11::basic_string"* %107, i64 -1
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %108) #13
  %109 = icmp eq %"class.std::__cxx11::basic_string"* %108, %35
...
112:                                              ; preds = %54
  ...
  store %"class.std::allocator"* %32, %"class.std::allocator"** %6, align 8
  %116 = load %"class.std::allocator"*, %"class.std::allocator"** %6, align 8
  %117 = bitcast %"class.std::allocator"* %116 to %"class.std::__new_allocator"*
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %117) #13
  br label %133
...
127:                                              ; preds = %127, %72
  %128 = phi %"class.std::__cxx11::basic_string"* [ %74, %72 ], [ %129, %127 ]
  %129 = getelementptr inbounds %"class.std::__cxx11::basic_string", %"class.std::__cxx11::basic_string"* %128, i64 -1
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %129) #13
  %130 = icmp eq %"class.std::__cxx11::basic_string"* %129, %73
...
133:                                              ; preds = %126, %112
  %134 = getelementptr inbounds [4 x %"class.std::__cxx11::basic_string"], [4 x %"class.std::__cxx11::basic_string"]* %22, i32 0, i32 0
  %135 = getelementptr inbounds %"class.std::__cxx11::basic_string", %"class.std::__cxx11::basic_string"* %134, i64 4
  br label %136

136:                                              ; preds = %136, %133
  %137 = phi %"class.std::__cxx11::basic_string"* [ %135, %133 ], [ %138, %136 ]
  %138 = getelementptr inbounds %"class.std::__cxx11::basic_string", %"class.std::__cxx11::basic_string"* %137, i64 -1
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %138) #13
  %139 = icmp eq %"class.std::__cxx11::basic_string"* %138, %134
...
declare void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32), i8* noundef, %"class.std::allocator"* noundef nonnull align 1 dereferenceable(1)) unnamed_addr #6
...
declare void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1ERKS4_(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32), %"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32)) unnamed_addr #6

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt5dequeIiSaIiEED2Ev(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %0) unnamed_addr #5 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZNSt5dequeIiSaIiEE5beginEv(%"struct.std::_Deque_iterator"* sret(%"struct.std::_Deque_iterator") align 8 %3, %"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %7) #13
  call void @_ZNSt5dequeIiSaIiEE3endEv(%"struct.std::_Deque_iterator"* sret(%"struct.std::_Deque_iterator") align 8 %4, %"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %7) #13
  %8 = bitcast %"class.std::deque"* %7 to %"class.std::_Deque_base"*
  %9 = call noundef nonnull align 1 dereferenceable(1) %"class.std::allocator.0"* @_ZNSt11_Deque_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %8) #13
...
10:                                               ; preds = %1
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEED2Ev(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %11) #13
  ret void
...
12:                                               ; preds = %1
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEED2Ev(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %16) #13
  br label %17
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt5dequeIiSaIiEE5beginEv(%"struct.std::_Deque_iterator"* noalias sret(%"struct.std::_Deque_iterator") align 8 %0, %"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %1) #4 comdat align 2 {
  %3 = alloca i8*, align 8
  ...
  call void @_ZNSt15_Deque_iteratorIiRiPiEC2ERKS2_(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %0, %"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %10) #13
  ret void
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt5dequeIiSaIiEE3endEv(%"struct.std::_Deque_iterator"* noalias sret(%"struct.std::_Deque_iterator") align 8 %0, %"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %1) #4 comdat align 2 {
  %3 = alloca i8*, align 8
  %4 = alloca %"class.std::deque"*, align 8
  %5 = bitcast %"struct.std::_Deque_iterator"* %0 to i8*
  store i8* %5, i8** %3, align 8
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef nonnull align 1 dereferenceable(1) %"class.std::allocator.0"* @_ZNSt11_Deque_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %0) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt11_Deque_baseIiSaIiEED2Ev(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %0) unnamed_addr #5 comdat align 2 {
  %2 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %0, %"class.std::_Deque_base"** %2, align 8
  %3 = load %"class.std::_Deque_base"*, %"class.std::_Deque_base"** %2, align 8
  %4 = getelementptr inbounds %"class.std::_Deque_base", %"class.std::_Deque_base"* %3, i32 0, i32 0
...
9:                                                ; preds = %1
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEE16_M_destroy_nodesEPPiS3_(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %3, i32** noundef %14, i32** noundef %20) #13
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEE17_M_deallocate_mapEPPim(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %3, i32** noundef %24, i64 noundef %28) #13
  br label %29

29:                                               ; preds = %9, %1
  %30 = getelementptr inbounds %"class.std::_Deque_base", %"class.std::_Deque_base"* %3, i32 0, i32 0
  call void @_ZNSt11_Deque_baseIiSaIiEE11_Deque_implD2Ev(%"struct.std::_Deque_base<int, std::allocator<int>>::_Deque_impl"* noundef nonnull align 8 dereferenceable(80) %30) #13
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt15_Deque_iteratorIiRiPiEC2ERKS2_(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %0, %"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %1) unnamed_addr #5 comdat align 2 {
  %3 = alloca %"struct.std::_Deque_iterator"*, align 8
  %4 = alloca %"struct.std::_Deque_iterator"*, align 8
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt11_Deque_baseIiSaIiEE16_M_destroy_nodesEPPiS3_(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %0, i32** noundef %1, i32** noundef %2) #4 comdat align 2 {
...
14:                                               ; preds = %10
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEE18_M_deallocate_nodeEPi(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %8, i32* noundef %16) #13
  br label %17
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt11_Deque_baseIiSaIiEE17_M_deallocate_mapEPPim(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %0, i32** noundef %1, i64 noundef %2) #5 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZNKSt11_Deque_baseIiSaIiEE20_M_get_map_allocatorEv(%"class.std::allocator.3"* sret(%"class.std::allocator.3") align 1 %12, %"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %15) #13
...
22:                                               ; preds = %3
  ...
  call void @_ZNSt15__new_allocatorIPiED2Ev(%"class.std::__new_allocator.4"* noundef nonnull align 1 dereferenceable(1) %24) #13
  ret void
...
25:                                               ; No predecessors!
  ...
  call void @_ZNSt15__new_allocatorIPiED2Ev(%"class.std::__new_allocator.4"* noundef nonnull align 1 dereferenceable(1) %30) #13
  br label %31
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt11_Deque_baseIiSaIiEE11_Deque_implD2Ev(%"struct.std::_Deque_base<int, std::allocator<int>>::_Deque_impl"* noundef nonnull align 8 dereferenceable(80) %0) unnamed_addr #5 comdat align 2 {
  ...
  call void @_ZNSt15__new_allocatorIiED2Ev(%"class.std::__new_allocator.1"* noundef nonnull align 1 dereferenceable(1) %7) #13
  ret void
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt11_Deque_baseIiSaIiEE18_M_deallocate_nodeEPi(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %0, i32* noundef %1) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt15__new_allocatorIiE10deallocateEPim(%"class.std::__new_allocator.1"* noundef nonnull align 1 dereferenceable(1) %0, i32* noundef %1, i64 noundef %2) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNKSt11_Deque_baseIiSaIiEE20_M_get_map_allocatorEv(%"class.std::allocator.3"* noalias sret(%"class.std::allocator.3") align 1 %0, %"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %1) #5 comdat align 2 {
  ...
  %10 = call noundef nonnull align 1 dereferenceable(1) %"class.std::allocator.0"* @_ZNKSt11_Deque_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %9) #13
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef nonnull align 1 dereferenceable(1) %"class.std::allocator.0"* @_ZNKSt11_Deque_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %0) #4 comdat align 2 {
  %2 = alloca %"class.std::_Deque_base"*, align 8
  store %"class.std::_Deque_base"* %0, %"class.std::_Deque_base"** %2, align 8
  %3 = load %"class.std::_Deque_base"*, %"class.std::_Deque_base"** %2, align 8
  %4 = getelementptr inbounds %"class.std::_Deque_base", %"class.std::_Deque_base"* %3, i32 0, i32 0
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt15__new_allocatorIPiE10deallocateEPS0_m(%"class.std::__new_allocator.4"* noundef nonnull align 1 dereferenceable(1) %0, i32** noundef %1, i64 noundef %2) #4 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt15__new_allocatorIPiED2Ev(%"class.std::__new_allocator.4"* noundef nonnull align 1 dereferenceable(1) %0) unnamed_addr #5 comdat align 2 {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt15__new_allocatorIiED2Ev(%"class.std::__new_allocator.1"* noundef nonnull align 1 dereferenceable(1) %0) unnamed_addr #5 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZNSt5dequeIiSaIiEEC2Ev(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %0) unnamed_addr #3 comdat align 2 {
  %2 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %0, %"class.std::deque"** %2, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZNSt11_Deque_baseIiSaIiEEC2Ev(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %0) unnamed_addr #3 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %"class.std::_Deque_base"*, align 8
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
  store %"class.std::_Deque_base"* %0, %"class.std::_Deque_base"** %2, align 8
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEE11_Deque_implC2Ev(%"struct.std::_Deque_base<int, std::allocator<int>>::_Deque_impl"* noundef nonnull align 8 dereferenceable(80) %6) #13
...
8:                                                ; preds = %1
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEE11_Deque_implD2Ev(%"struct.std::_Deque_base<int, std::allocator<int>>::_Deque_impl"* noundef nonnull align 8 dereferenceable(80) %6) #13
  br label %12
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt11_Deque_baseIiSaIiEE11_Deque_implC2Ev(%"struct.std::_Deque_base<int, std::allocator<int>>::_Deque_impl"* noundef nonnull align 8 dereferenceable(80) %0) unnamed_addr #5 comdat align 2 {
  %2 = alloca %"class.std::__new_allocator.1"*, align 8
  %3 = alloca %"class.std::allocator.0"*, align 8
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEE16_Deque_impl_dataC2Ev(%"struct.std::_Deque_base<int, std::allocator<int>>::_Deque_impl_data"* noundef nonnull align 8 dereferenceable(80) %10) #13
  ret void
}
...
54:                                               ; preds = %50
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEE17_M_deallocate_mapEPPim(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %12, i32** noundef %60, i64 noundef %64) #13
...
76:                                               ; preds = %49
  ...
  call void @_ZNSt15_Deque_iteratorIiRiPiE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %79, i32** noundef %80) #13
  ...
  call void @_ZNSt15_Deque_iteratorIiRiPiE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %83, i32** noundef %85) #13
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt11_Deque_baseIiSaIiEE16_Deque_impl_dataC2Ev(%"struct.std::_Deque_base<int, std::allocator<int>>::_Deque_impl_data"* noundef nonnull align 8 dereferenceable(80) %0) unnamed_addr #5 comdat align 2 {
  ...
  call void @_ZNSt15_Deque_iteratorIiRiPiEC2Ev(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %6) #13
  ...
  call void @_ZNSt15_Deque_iteratorIiRiPiEC2Ev(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %7) #13
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt15_Deque_iteratorIiRiPiEC2Ev(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %0) unnamed_addr #5 comdat align 2 {
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local noundef i32** @_ZNSt11_Deque_baseIiSaIiEE15_M_allocate_mapEm(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %0, i64 noundef %1) #3 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  call void @_ZNKSt11_Deque_baseIiSaIiEE20_M_get_map_allocatorEv(%"class.std::allocator.3"* sret(%"class.std::allocator.3") align 1 %9, %"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %12) #13
...
19:                                               ; preds = %18
  ...
  call void @_ZNSt15__new_allocatorIPiED2Ev(%"class.std::__new_allocator.4"* noundef nonnull align 1 dereferenceable(1) %21) #13
  ret i32** %17
...
22:                                               ; preds = %2
  ...
  call void @_ZNSt15__new_allocatorIPiED2Ev(%"class.std::__new_allocator.4"* noundef nonnull align 1 dereferenceable(1) %27) #13
  br label %28
...
27:                                               ; preds = %23
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEE16_M_destroy_nodesEPPiS3_(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %10, i32** noundef %30, i32** noundef %31) #13
  invoke void @__cxa_rethrow() #16
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt15_Deque_iteratorIiRiPiE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %0, i32** noundef %1) #4 comdat align 2 {
  %3 = alloca %"struct.std::_Deque_iterator"*, align 8
  %4 = alloca i32**, align 8
  store %"struct.std::_Deque_iterator"* %0, %"struct.std::_Deque_iterator"** %3, align 8
  store i32** %1, i32*** %4, align 8
...
; Function Attrs: mustprogress noinline uwtable
define linkonce_odr dso_local noundef i32** @_ZNSt15__new_allocatorIPiE8allocateEmPKv(%"class.std::__new_allocator.4"* noundef nonnull align 1 dereferenceable(1) %0, i64 noundef %1, i8* noundef %2) #0 comdat align 2 {
  %4 = alloca %"class.std::__new_allocator.4"*, align 8
...
; Function Attrs: mustprogress noinline uwtable
define linkonce_odr dso_local noundef i32* @_ZNSt15__new_allocatorIiE8allocateEmPKv(%"class.std::__new_allocator.1"* noundef nonnull align 1 dereferenceable(1) %0, i64 noundef %1, i8* noundef %2) #0 comdat align 2 {
  %4 = alloca %"class.std::__new_allocator.1"*, align 8
...
26:                                               ; preds = %2
  ...
  %41 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt7forwardIRKiEOT_RNSt16remove_referenceIS2_E4typeE(i32* noundef nonnull align 4 dereferenceable(4) %40) #13
  ...
  %46 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt7forwardIRKiEOT_RNSt16remove_referenceIS2_E4typeE(i32* noundef nonnull align 4 dereferenceable(4) %45) #13
...
define linkonce_odr dso_local void @_ZNSt5dequeIiSaIiEE16_M_push_back_auxIJRKiEEEvDpOT_(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %0, i32* noundef nonnull align 4 dereferenceable(4) %1) #0 comdat align 2 {
  ...
  store i32* %1, i32** %10, align 8
  %11 = load %"class.std::deque"*, %"class.std::deque"** %9, align 8
  %12 = call noundef i64 @_ZNKSt5dequeIiSaIiEE4sizeEv(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %11) #13
  %13 = call noundef i64 @_ZNKSt5dequeIiSaIiEE8max_sizeEv(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %11) #13
  %14 = icmp eq i64 %12, %13
  br i1 %14, label %15, label %16

15:                                               ; preds = %2
  call void @_ZSt20__throw_length_errorPKc(i8* noundef getelementptr inbounds ([48 x i8], [48 x i8]* @.str.8, i64 0, i64 0)) #16
  unreachable
...
16:                                               ; preds = %2
  ...
  %36 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt7forwardIRKiEOT_RNSt16remove_referenceIS2_E4typeE(i32* noundef nonnull align 4 dereferenceable(4) %35) #13
  ...
  call void @_ZNSt15_Deque_iteratorIiRiPiE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %51, i32** noundef %58) #13
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef i64 @_ZNKSt5dequeIiSaIiEE4sizeEv(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %0) #4 comdat align 2 {
  %2 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %0, %"class.std::deque"** %2, align 8
  %3 = load %"class.std::deque"*, %"class.std::deque"** %2, align 8
  %4 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  ...
  %12 = call noundef i64 @_ZStmiRKSt15_Deque_iteratorIiRiPiES4_(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %7, %"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %11) #13
  ret i64 %12
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef i64 @_ZNKSt5dequeIiSaIiEE8max_sizeEv(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %0) #4 comdat align 2 {
  %2 = alloca %"class.std::deque"*, align 8
  store %"class.std::deque"* %0, %"class.std::deque"** %2, align 8
  %3 = load %"class.std::deque"*, %"class.std::deque"** %2, align 8
  %4 = bitcast %"class.std::deque"* %3 to %"class.std::_Deque_base"*
  %5 = call noundef nonnull align 1 dereferenceable(1) %"class.std::allocator.0"* @_ZNKSt11_Deque_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %4) #13
  %6 = call noundef i64 @_ZNSt5dequeIiSaIiEE11_S_max_sizeERKS0_(%"class.std::allocator.0"* noundef nonnull align 1 dereferenceable(1) %5) #13
  ret i64 %6
}
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef i64 @_ZStmiRKSt15_Deque_iteratorIiRiPiES4_(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %0, %"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %1) #4 comdat {
  %3 = alloca %"struct.std::_Deque_iterator"*, align 8
  %4 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %0, %"struct.std::_Deque_iterator"** %3, align 8
  store %"struct.std::_Deque_iterator"* %1, %"struct.std::_Deque_iterator"** %4, align 8
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef i64 @_ZNSt5dequeIiSaIiEE11_S_max_sizeERKS0_(%"class.std::allocator.0"* noundef nonnull align 1 dereferenceable(1) %0) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %"class.std::__new_allocator.1"*, align 8
  %3 = alloca %"class.std::__new_allocator.1"*, align 8
...
136:                                              ; preds = %135, %133
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEE17_M_deallocate_mapEPPim(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %154, i32** noundef %159, i64 noundef %164) #13
...
175:                                              ; preds = %136, %107
  ...
  call void @_ZNSt15_Deque_iteratorIiRiPiE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %179, i32** noundef %180) #13
  ...
  call void @_ZNSt15_Deque_iteratorIiRiPiE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %184, i32** noundef %188) #13
  ret void
}
...
define linkonce_odr dso_local noundef i32** @_ZSt13__copy_move_aILb0EPPiS1_ET1_T0_S3_S2_(i32** noundef %0, i32** noundef %1, i32** noundef %2) #0 comdat {
  ...
  store i32** %2, i32*** %6, align 8
  %7 = load i32**, i32*** %4, align 8
  %8 = call noundef i32** @_ZSt12__niter_baseIPPiET_S2_(i32** noundef %7) #13
  %9 = load i32**, i32*** %5, align 8
  %10 = call noundef i32** @_ZSt12__niter_baseIPPiET_S2_(i32** noundef %9) #13
  %11 = load i32**, i32*** %6, align 8
  %12 = call noundef i32** @_ZSt12__niter_baseIPPiET_S2_(i32** noundef %11) #13
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef i32** @_ZSt12__miter_baseIPPiET_S2_(i32** noundef %0) #4 comdat {
  %2 = alloca i32**, align 8
  store i32** %0, i32*** %2, align 8
  %3 = load i32**, i32*** %2, align 8
  ret i32** %3
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef i32** @_ZSt12__niter_wrapIPPiET_RKS2_S2_(i32*** noundef nonnull align 8 dereferenceable(8) %0, i32** noundef %1) #4 comdat {
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef i32** @_ZSt12__niter_baseIPPiET_S2_(i32** noundef %0) #4 comdat {
  %2 = alloca i32**, align 8
  store i32** %0, i32*** %2, align 8
  %3 = load i32**, i32*** %2, align 8
  ret i32** %3
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt11__copy_moveILb0ELb0ESt26random_access_iterator_tagE12__assign_oneIPiS3_EEvPT_PT0_(i32** noundef %0, i32** noundef %1) #4 comdat align 2 {
  %3 = alloca i32**, align 8
  %4 = alloca i32**, align 8
  store i32** %0, i32*** %3, align 8
  store i32** %1, i32*** %4, align 8
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef i32** @_ZNSt20__copy_move_backwardILb0ELb1ESt26random_access_iterator_tagE13__copy_move_bIPiS3_EEPT0_PT_S7_S5_(i32** noundef %0, i32** noundef %1, i32** noundef %2) #4 comdat align 2 {
  %4 = alloca i32**, align 8
  %5 = alloca i32**, align 8
  %6 = alloca i32**, align 8
  %7 = alloca i64, align 8
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef nonnull align 4 dereferenceable(4) i32* @_ZNSt5dequeIiSaIiEE5frontEv(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %0) #4 comdat align 2 {
  %2 = alloca %"class.std::deque"*, align 8
  %3 = alloca %"struct.std::_Deque_iterator", align 8
  store %"class.std::deque"* %0, %"class.std::deque"** %2, align 8
  %4 = load %"class.std::deque"*, %"class.std::deque"** %2, align 8
  call void @_ZNSt5dequeIiSaIiEE5beginEv(%"struct.std::_Deque_iterator"* sret(%"struct.std::_Deque_iterator") align 8 %3, %"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %4) #13
  %5 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZNKSt15_Deque_iteratorIiRiPiEdeEv(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %3) #13
  ret i32* %5
}

; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local noundef nonnull align 4 dereferenceable(4) i32* @_ZNKSt15_Deque_iteratorIiRiPiEdeEv(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %0) #4 comdat align 2 {
  %2 = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %0, %"struct.std::_Deque_iterator"** %2, align 8
  %3 = load %"struct.std::_Deque_iterator"*, %"struct.std::_Deque_iterator"** %2, align 8
  %4 = getelementptr inbounds %"struct.std::_Deque_iterator", %"struct.std::_Deque_iterator"* %3, i32 0, i32 0
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt5dequeIiSaIiEE9pop_frontEv(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %0) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  %2 = alloca %"class.std::__new_allocator.1"*, align 8
  %3 = alloca i32*, align 8
  %4 = alloca %"class.std::allocator.0"*, align 8
  %5 = alloca i32*, align 8
...
22:                                               ; preds = %1
  ...
  %24 = call noundef nonnull align 1 dereferenceable(1) %"class.std::allocator.0"* @_ZNSt11_Deque_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %23) #13
  ...
  store %"class.std::allocator.0"* %24, %"class.std::allocator.0"** %4, align 8
  store i32* %30, i32** %5, align 8
  %31 = load %"class.std::allocator.0"*, %"class.std::allocator.0"** %4, align 8
  %32 = bitcast %"class.std::allocator.0"* %31 to %"class.std::__new_allocator.1"*
  %33 = load i32*, i32** %5, align 8
  store %"class.std::__new_allocator.1"* %32, %"class.std::__new_allocator.1"** %2, align 8
  store i32* %33, i32** %3, align 8
  %34 = load %"class.std::__new_allocator.1"*, %"class.std::__new_allocator.1"** %2, align 8
...
; Function Attrs: mustprogress noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt5dequeIiSaIiEE16_M_pop_front_auxEv(%"class.std::deque"* noundef nonnull align 8 dereferenceable(80) %0) #4 comdat align 2 {
  %2 = alloca %"class.std::__new_allocator.1"*, align 8
  %3 = alloca i32*, align 8
  %4 = alloca %"class.std::allocator.0"*, align 8
  %5 = alloca i32*, align 8
  ...
  store %"class.std::allocator.0"* %9, %"class.std::allocator.0"** %4, align 8
  store i32* %15, i32** %5, align 8
  %16 = load %"class.std::allocator.0"*, %"class.std::allocator.0"** %4, align 8
  %17 = bitcast %"class.std::allocator.0"* %16 to %"class.std::__new_allocator.1"*
  %18 = load i32*, i32** %5, align 8
  store %"class.std::__new_allocator.1"* %17, %"class.std::__new_allocator.1"** %2, align 8
  store i32* %18, i32** %3, align 8
  %19 = load %"class.std::__new_allocator.1"*, %"class.std::__new_allocator.1"** %2, align 8
  ...
  call void @_ZNSt11_Deque_baseIiSaIiEE18_M_deallocate_nodeEPi(%"class.std::_Deque_base"* noundef nonnull align 8 dereferenceable(80) %21, i32* noundef %27) #13
  ...
  call void @_ZNSt15_Deque_iteratorIiRiPiE11_M_set_nodeEPS1_(%"struct.std::_Deque_iterator"* noundef nonnull align 8 dereferenceable(32) %31, i32** noundef %38) #13
