; ModuleID = 'PE-benchmarks/cut-vertices.cpp'
source_filename = "PE-benchmarks/cut-vertices.cpp"
...
@_ZZN5Graph6APUtilEiPbPiS1_S1_S0_E4time = internal global i32 0, align 4
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_cut_vertices.cpp, i8* null }]
...
; Function Attrs: mustprogress noinline uwtable
define dso_local void @_ZN5Graph6APUtilEiPbPiS1_S1_S0_(%class.Graph* noundef nonnull align 8 dereferenceable(16) %0, i32 noundef %1, i8* noundef %2, i32* noundef %3, i32* noundef %4, i32* noundef %5, i8* noundef %6) #7 align 2 {
  ...
  %20 = load %class.Graph*, %class.Graph** %8, align 8
  ...
  %25 = load i32, i32* @_ZZN5Graph6APUtilEiPbPiS1_S1_S0_E4time, align 4
  %26 = add nsw i32 %25, 1
  store i32 %26, i32* @_ZZN5Graph6APUtilEiPbPiS1_S1_S0_E4time, align 4
  ...
  call void @_ZNSt14_List_iteratorIiEC2Ev(%"struct.std::_List_iterator"* noundef nonnull align 8 dereferenceable(8) %16) #3
  %35 = getelementptr inbounds %class.Graph, %class.Graph* %20, i32 0, i32 1
  %36 = load %"class.std::__cxx11::list"*, %"class.std::__cxx11::list"** %35, align 8
  %37 = load i32, i32* %9, align 4
  %38 = sext i32 %37 to i64
  %39 = getelementptr inbounds %"class.std::__cxx11::list", %"class.std::__cxx11::list"* %36, i64 %38
  %40 = call %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIiSaIiEE5beginEv(%"class.std::__cxx11::list"* noundef nonnull align 8 dereferenceable(24) %39) #3
  %41 = getelementptr inbounds %"struct.std::_List_iterator", %"struct.std::_List_iterator"* %17, i32 0, i32 0
  ...
  %43 = bitcast %"struct.std::_List_iterator"* %17 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %42, i8* align 8 %43, i64 8, i1 false)
  br label %44

44:                                               ; preds = %154, %7
  %45 = getelementptr inbounds %class.Graph, %class.Graph* %20, i32 0, i32 1
  ...
  %50 = call %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIiSaIiEE3endEv(%"class.std::__cxx11::list"* noundef nonnull align 8 dereferenceable(24) %49) #3
  %51 = getelementptr inbounds %"struct.std::_List_iterator", %"struct.std::_List_iterator"* %18, i32 0, i32 0
  store %"struct.std::__detail::_List_node_base"* %50, %"struct.std::__detail::_List_node_base"** %51, align 8
  %52 = call noundef zeroext i1 @_ZStneRKSt14_List_iteratorIiES2_(%"struct.std::_List_iterator"* noundef nonnull align 8 dereferenceable(8) %16, %"struct.std::_List_iterator"* noundef nonnull align 8 dereferenceable(8) %18) #3
  br i1 %52, label %53, label %156

53:                                               ; preds = %44
  %54 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZNKSt14_List_iteratorIiEdeEv(%"struct.std::_List_iterator"* noundef nonnull align 8 dereferenceable(8) %16) #3
...
62:                                               ; preds = %53
  ...
  call void @_ZN5Graph6APUtilEiPbPiS1_S1_S0_(%class.Graph* noundef nonnull align 8 dereferenceable(16) %20, i32 noundef %70, i8* noundef %71, i32* noundef %72, i32* noundef %73, i32* noundef %74, i8* noundef %75)
  ...
  %84 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %79, i32* noundef nonnull align 4 dereferenceable(4) %83)
...
137:                                              ; preds = %129
  ...
  %146 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %141, i32* noundef nonnull align 4 dereferenceable(4) %145)
...
154:                                              ; preds = %153
  %155 = call noundef nonnull align 8 dereferenceable(8) %"struct.std::_List_iterator"* @_ZNSt14_List_iteratorIiEppEv(%"struct.std::_List_iterator"* noundef nonnull align 8 dereferenceable(8) %16) #3
...
; Function Attrs: mustprogress noinline uwtable
define dso_local void @_ZN5Graph2APEv(%class.Graph* noundef nonnull align 8 dereferenceable(16) %0) #7 align 2 {
  ...
  %15 = call noalias noundef nonnull i8* @_Znam(i64 noundef %14) #14
  store i8* %15, i8** %3, align 8
  %16 = getelementptr inbounds %class.Graph, %class.Graph* %11, i32 0, i32 0
  ...
  %23 = call noalias noundef nonnull i8* @_Znam(i64 noundef %22) #14
  %24 = bitcast i8* %23 to i32*
  store i32* %24, i32** %4, align 8
  %25 = getelementptr inbounds %class.Graph, %class.Graph* %11, i32 0, i32 0
  ...
  %34 = getelementptr inbounds %class.Graph, %class.Graph* %11, i32 0, i32 0
  ...
  %41 = call noalias noundef nonnull i8* @_Znam(i64 noundef %40) #14
  %42 = bitcast i8* %41 to i32*
  store i32* %42, i32** %6, align 8
  %43 = getelementptr inbounds %class.Graph, %class.Graph* %11, i32 0, i32 0
  %44 = load i32, i32* %43, align 8
  %45 = sext i32 %44 to i64
  %46 = call noalias noundef nonnull i8* @_Znam(i64 noundef %45) #14
...
47:                                               ; preds = %65, %1
  ...
  %49 = getelementptr inbounds %class.Graph, %class.Graph* %11, i32 0, i32 0
...
69:                                               ; preds = %91, %68
  ...
  %71 = getelementptr inbounds %class.Graph, %class.Graph* %11, i32 0, i32 0
...
83:                                               ; preds = %74
  ...
  call void @_ZN5Graph6APUtilEiPbPiS1_S1_S0_(%class.Graph* noundef nonnull align 8 dereferenceable(16) %11, i32 noundef %84, i8* noundef %85, i32* noundef %86, i32* noundef %87, i32* noundef %88, i8* noundef %89)
  br label %90
...
95:                                               ; preds = %114, %94
  ...
  %97 = getelementptr inbounds %class.Graph, %class.Graph* %11, i32 0, i32 0
...
109:                                              ; preds = %100
  ...
  %111 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef %110)
  %112 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %111, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
  br label %113
...
define dso_local noundef i32 @main() #10 {
  ...
  %5 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1, i64 0, i64 0))
  ...
  call void @_ZN5Graph2APEv(%class.Graph* noundef nonnull align 8 dereferenceable(16) %2)
  %6 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([39 x i8], [39 x i8]* @.str.2, i64 0, i64 0))
  ...
  call void @_ZN5Graph2APEv(%class.Graph* noundef nonnull align 8 dereferenceable(16) %3)
  %7 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([38 x i8], [38 x i8]* @.str.3, i64 0, i64 0))
  ...
  call void @_ZN5Graph2APEv(%class.Graph* noundef nonnull align 8 dereferenceable(16) %4)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_cut_vertices.cpp() #0 section ".text.startup" {
