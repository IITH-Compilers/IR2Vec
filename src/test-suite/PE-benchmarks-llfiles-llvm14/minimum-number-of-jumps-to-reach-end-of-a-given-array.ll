...
define dso_local noundef i32 @_Z3minii(i32 noundef %0, i32 noundef %1) #4 {
...
define dso_local noundef i32 @_Z8minJumpsPii(i32* noundef %0, i32 noundef %1) #5 {
  %3 = alloca i32, align 4
  ...
  %15 = call noalias noundef nonnull i8* @_Znam(i64 noundef %14) #10
...
58:                                               ; preds = %51
  ...
  %69 = add nsw i32 %68, 1
  %70 = call noundef i32 @_Z3minii(i32 noundef %63, i32 noundef %69)
...
define dso_local noundef i32 @main() #8 {
  ...
  %5 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([41 x i8], [41 x i8]* @.str, i64 0, i64 0))
  %6 = getelementptr inbounds [6 x i32], [6 x i32]* %2, i64 0, i64 0
  %7 = load i32, i32* %3, align 4
  %8 = call noundef i32 @_Z8minJumpsPii(i32* noundef %6, i32 noundef %7)
