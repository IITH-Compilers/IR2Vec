...
define dso_local void @_Z17transitiveClosurePA4_i([4 x i32]* noundef %0) #0 {
...
97:                                               ; preds = %37
  ...
  call void @_Z13printSolutionPA4_i([4 x i32]* noundef %98)
  ret void
}
...
define dso_local void @_Z13printSolutionPA4_i([4 x i32]* noundef %0) #0 {
  ...
  %4 = alloca i32, align 4
  store [4 x i32]* %0, [4 x i32]** %2, align 8
  %5 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([59 x i8], [59 x i8]* @.str, i64 0, i64 0))
...
define dso_local noundef i32 @main() #2 {
  ...
  call void @_Z17transitiveClosurePA4_i([4 x i32]* noundef %4)
  ret i32 0
}
