...
; Function Attrs: mustprogress noinline nounwind uwtable
define dso_local noundef i32 @_Z7comparePKvS0_(i8* noundef %0, i8* noundef %1) #0 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
define dso_local noundef i32 @_Z14maxStackHeightP3Boxi(%struct.Box* noundef %0, i32 noundef %1) #1 {
...
166:                                              ; preds = %20
  ...
  call void @qsort(i8* noundef %169, i64 noundef %171, i64 noundef 12, i32 (i8*, i8*)* noundef @_Z7comparePKvS0_)
...
define dso_local noundef i32 @main() #4 {
  ...
  %7 = call noundef i32 @_Z14maxStackHeightP3Boxi(%struct.Box* noundef %5, i32 noundef %6)
  %8 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([44 x i8], [44 x i8]* @.str, i64 0, i64 0), i32 noundef %7)
  ret i32 0
}
