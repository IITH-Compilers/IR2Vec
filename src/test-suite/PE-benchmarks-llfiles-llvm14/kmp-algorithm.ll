...
define dso_local void @_Z9KMPSearchPcS_(i8* noundef %0, i8* noundef %1) #0 {
  ...
  call void @_Z15computeLPSArrayPciPi(i8* noundef %21, i32 noundef %22, i32* noundef %20)
...
50:                                               ; preds = %46
  ...
  %54 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i64 0, i64 0), i32 noundef %53)
...
define dso_local noundef i32 @main() #5 {
  ...
  call void @_Z9KMPSearchPcS_(i8* noundef %6, i8* noundef %7)
  ret i32 0
}
