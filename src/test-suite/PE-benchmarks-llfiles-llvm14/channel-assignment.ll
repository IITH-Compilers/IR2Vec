...
define dso_local noundef zeroext i1 @_Z3bpmPA4_iiPbPi([4 x i32]* noundef %0, i32 noundef %1, i8* noundef %2, i32* noundef %3) #4 {
  %5 = alloca i1, align 1
...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef i32 @_Z6maxBPMPA4_i([4 x i32]* noundef %0) #4 {
