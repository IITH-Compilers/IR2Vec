...
define dso_local noundef zeroext i1 @_Z12findPartiionPii(i32* noundef %0, i32 noundef %1) #0 {
  %3 = alloca i1, align 1
...
define dso_local noundef i32 @main() #2 {
  ...
  %7 = call noundef zeroext i1 @_Z12findPartiionPii(i32* noundef %5, i32 noundef %6)
  %8 = zext i1 %7 to i32
  %9 = icmp eq i32 %8, 1
  br i1 %9, label %10, label %12

10:                                               ; preds = %0
  %11 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([45 x i8], [45 x i8]* @.str, i64 0, i64 0))
  br label %14

12:                                               ; preds = %0
  %13 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([49 x i8], [49 x i8]* @.str.1, i64 0, i64 0))
  br label %14
