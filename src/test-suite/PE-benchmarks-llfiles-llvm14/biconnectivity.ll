...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef zeroext i1 @_ZN5Graph8isBCUtilEiPbPiS1_S1_(%class.Graph* noundef nonnull align 8 dereferenceable(16) %0, i32 noundef %1, i8* noundef %2, i32* noundef %3, i32* noundef %4, i32* noundef %5) #7 align 2 {
  %7 = alloca i1, align 1
  ...
  call void @_ZNSt14_List_iteratorIiEC2Ev(%"struct.std::_List_iterator"* noundef nonnull align 8 dereferenceable(8) %15) #3
...
43:                                               ; preds = %147, %6
  ...
  %51 = call noundef zeroext i1 @_ZStneRKSt14_List_iteratorIiES2_(%"struct.std::_List_iterator"* noundef nonnull align 8 dereferenceable(8) %15, %"struct.std::_List_iterator"* noundef nonnull align 8 dereferenceable(8) %17) #3
  br i1 %51, label %52, label %149

52:                                               ; preds = %43
  %53 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZNKSt14_List_iteratorIiEdeEv(%"struct.std::_List_iterator"* noundef nonnull align 8 dereferenceable(8) %15) #3
...
147:                                              ; preds = %146
  %148 = call noundef nonnull align 8 dereferenceable(8) %"struct.std::_List_iterator"* @_ZNSt14_List_iteratorIiEppEv(%"struct.std::_List_iterator"* noundef nonnull align 8 dereferenceable(8) %15) #3
...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef zeroext i1 @_ZN5Graph4isBCEv(%class.Graph* noundef nonnull align 8 dereferenceable(16) %0) #7 align 2 {
  %2 = alloca i1, align 1
  %3 = alloca %class.Graph*, align 8
  %4 = alloca i8*, align 8
  %5 = alloca i32*, align 8
  ...
  %14 = call noalias noundef nonnull i8* @_Znam(i64 noundef %13) #14
  ...
  %22 = call noalias noundef nonnull i8* @_Znam(i64 noundef %21) #14
  ...
  %40 = call noalias noundef nonnull i8* @_Znam(i64 noundef %39) #14
