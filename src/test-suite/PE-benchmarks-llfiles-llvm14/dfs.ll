...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_dfs.cpp, i8* null }]
...
; Function Attrs: mustprogress noinline uwtable
define dso_local void @_ZN5Graph3DFSEi(%class.Graph* noundef nonnull align 8 dereferenceable(16) %0, i32 noundef %1) #7 align 2 {
  %3 = alloca %class.Graph*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i8*, align 8
  %6 = alloca i32, align 4
...
25:                                               ; preds = %12
  ...
  call void @_ZN5Graph7DFSUtilEiPb(%class.Graph* noundef nonnull align 8 dereferenceable(16) %7, i32 noundef %26, i8* noundef %27)
  ret void
}
...
define dso_local noundef i32 @main() #10 {
  ...
  %3 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([62 x i8], [62 x i8]* @.str.1, i64 0, i64 0))
  call void @_ZN5Graph3DFSEi(%class.Graph* noundef nonnull align 8 dereferenceable(16) %2, i32 noundef 2)
  ret i32 0
}
