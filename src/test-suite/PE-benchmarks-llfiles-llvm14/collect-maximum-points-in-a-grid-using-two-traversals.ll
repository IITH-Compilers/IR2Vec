...
define dso_local noundef i32 @_Z10getMaxUtilPA4_iPA4_S_iii([4 x i32]* noundef %0, [4 x [4 x i32]]* noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %4) #1 {
  %6 = alloca i32, align 4
...
130:                                              ; preds = %112, %103
  ...
  %140 = call noundef i32 @_Z10getMaxUtilPA4_iPA4_S_iii([4 x i32]* noundef %133, [4 x [4 x i32]]* noundef %134, i32 noundef %136, i32 noundef %137, i32 noundef %139)
  %141 = add nsw i32 %132, %140
  store i32 %141, i32* %14, align 4
  %142 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %12, i32* noundef nonnull align 4 dereferenceable(4) %14)
  ...
  %152 = call noundef i32 @_Z10getMaxUtilPA4_iPA4_S_iii([4 x i32]* noundef %145, [4 x [4 x i32]]* noundef %146, i32 noundef %148, i32 noundef %149, i32 noundef %151)
  %153 = add nsw i32 %144, %152
  store i32 %153, i32* %15, align 4
  %154 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %12, i32* noundef nonnull align 4 dereferenceable(4) %15)
  ...
  %163 = call noundef i32 @_Z10getMaxUtilPA4_iPA4_S_iii([4 x i32]* noundef %157, [4 x [4 x i32]]* noundef %158, i32 noundef %160, i32 noundef %161, i32 noundef %162)
  %164 = add nsw i32 %156, %163
  store i32 %164, i32* %16, align 4
  %165 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %12, i32* noundef nonnull align 4 dereferenceable(4) %16)
  ...
  %175 = call noundef i32 @_Z10getMaxUtilPA4_iPA4_S_iii([4 x i32]* noundef %168, [4 x [4 x i32]]* noundef %169, i32 noundef %171, i32 noundef %173, i32 noundef %174)
  %176 = add nsw i32 %167, %175
  store i32 %176, i32* %17, align 4
  %177 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %12, i32* noundef nonnull align 4 dereferenceable(4) %17)
  ...
  %188 = call noundef i32 @_Z10getMaxUtilPA4_iPA4_S_iii([4 x i32]* noundef %180, [4 x [4 x i32]]* noundef %181, i32 noundef %183, i32 noundef %185, i32 noundef %187)
  %189 = add nsw i32 %179, %188
  store i32 %189, i32* %18, align 4
  %190 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %12, i32* noundef nonnull align 4 dereferenceable(4) %18)
  ...
  %201 = call noundef i32 @_Z10getMaxUtilPA4_iPA4_S_iii([4 x i32]* noundef %193, [4 x [4 x i32]]* noundef %194, i32 noundef %196, i32 noundef %198, i32 noundef %200)
  %202 = add nsw i32 %192, %201
  store i32 %202, i32* %19, align 4
  %203 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %12, i32* noundef nonnull align 4 dereferenceable(4) %19)
  ...
  %213 = call noundef i32 @_Z10getMaxUtilPA4_iPA4_S_iii([4 x i32]* noundef %206, [4 x [4 x i32]]* noundef %207, i32 noundef %209, i32 noundef %211, i32 noundef %212)
  %214 = add nsw i32 %205, %213
  store i32 %214, i32* %20, align 4
  %215 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %12, i32* noundef nonnull align 4 dereferenceable(4) %20)
  ...
  %226 = call noundef i32 @_Z10getMaxUtilPA4_iPA4_S_iii([4 x i32]* noundef %218, [4 x [4 x i32]]* noundef %219, i32 noundef %221, i32 noundef %223, i32 noundef %225)
  %227 = add nsw i32 %217, %226
  store i32 %227, i32* %21, align 4
  %228 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %12, i32* noundef nonnull align 4 dereferenceable(4) %21)
  ...
  %239 = call noundef i32 @_Z10getMaxUtilPA4_iPA4_S_iii([4 x i32]* noundef %231, [4 x [4 x i32]]* noundef %232, i32 noundef %234, i32 noundef %236, i32 noundef %238)
  %240 = add nsw i32 %230, %239
  store i32 %240, i32* %22, align 4
  %241 = call noundef nonnull align 4 dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* noundef nonnull align 4 dereferenceable(4) %12, i32* noundef nonnull align 4 dereferenceable(4) %22)
...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef i32 @_Z15geMaxCollectionPA4_i([4 x i32]* noundef %0) #1 {
  ...
  %8 = call noundef i32 @_Z10getMaxUtilPA4_iPA4_S_iii([4 x i32]* noundef %6, [4 x [4 x i32]]* noundef %7, i32 noundef 0, i32 noundef 0, i32 noundef 3)
  ret i32 %8
}
...
define dso_local noundef i32 @main() #3 {
  ...
  %4 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0))
  %5 = getelementptr inbounds [5 x [4 x i32]], [5 x [4 x i32]]* %2, i64 0, i64 0
  %6 = call noundef i32 @_Z15geMaxCollectionPA4_i([4 x i32]* noundef %5)
