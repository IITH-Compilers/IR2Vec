...
define dso_local noundef %class.Graph* @_Z11createGraphii(i32 noundef %0, i32 noundef %1) #0 {
  ...
  %24 = call noalias noundef nonnull i8* @_Znam(i64 noundef %23) #6
...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef i32 @_Z4findPii(i32* noundef %0, i32 noundef %1) #0 {
  %3 = alloca i32, align 4
...
; Function Attrs: mustprogress noinline uwtable
define dso_local void @_Z5UnionPiii(i32* noundef %0, i32 noundef %1, i32 noundef %2) #0 {
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef i32 @_Z7isCycleP5Graph(%class.Graph* noundef %0) #0 {
  ...
  %17 = call noalias noundef nonnull i8* @_Znam(i64 noundef %16) #6
