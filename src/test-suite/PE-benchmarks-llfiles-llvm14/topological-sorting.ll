...
; Function Attrs: mustprogress noinline uwtable
define dso_local void @_ZN5Graph19topologicalSortUtilEiPbRSt5stackIiSt5dequeIiSaIiEEE(%class.Graph* noundef nonnull align 8 dereferenceable(16) %0, i32 noundef %1, i8* noundef %2, %"class.std::stack"* noundef nonnull align 8 dereferenceable(80) %3) #7 align 2 {
...
43:                                               ; preds = %35
  ...
  call void @_ZN5Graph19topologicalSortUtilEiPbRSt5stackIiSt5dequeIiSaIiEEE(%class.Graph* noundef nonnull align 8 dereferenceable(16) %12, i32 noundef %45, i8* noundef %46, %"class.std::stack"* noundef nonnull align 8 dereferenceable(80) %47)
  br label %48
...
; Function Attrs: mustprogress noinline uwtable
define dso_local void @_ZN5Graph15topologicalSortEv(%class.Graph* noundef nonnull align 8 dereferenceable(16) %0) #7 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %13 = invoke noalias noundef nonnull i8* @_Znam(i64 noundef %12) #14
...
47:                                               ; preds = %38
  ...
  invoke void @_ZN5Graph19topologicalSortUtilEiPbRSt5stackIiSt5dequeIiSaIiEEE(%class.Graph* noundef nonnull align 8 dereferenceable(16) %9, i32 noundef %48, i8* noundef %49, %"class.std::stack"* noundef nonnull align 8 dereferenceable(80) %3)
...
56:                                               ; preds = %69, %55
  %57 = invoke noundef zeroext i1 @_ZNKSt5stackIiSt5dequeIiSaIiEEE5emptyEv(%"class.std::stack"* noundef nonnull align 8 dereferenceable(80) %3)
...
61:                                               ; preds = %58
  %62 = invoke noundef nonnull align 4 dereferenceable(4) i32* @_ZNSt5stackIiSt5dequeIiSaIiEEE3topEv(%"class.std::stack"* noundef nonnull align 8 dereferenceable(80) %3)
...
66:                                               ; preds = %63
  %67 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %65, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
...
define dso_local noundef i32 @main() #10 {
  ...
  call void @_ZN5Graph7addEdgeEii(%class.Graph* noundef nonnull align 8 dereferenceable(16) %2, i32 noundef 5, i32 noundef 2)
  call void @_ZN5Graph7addEdgeEii(%class.Graph* noundef nonnull align 8 dereferenceable(16) %2, i32 noundef 5, i32 noundef 0)
  call void @_ZN5Graph7addEdgeEii(%class.Graph* noundef nonnull align 8 dereferenceable(16) %2, i32 noundef 4, i32 noundef 0)
  call void @_ZN5Graph7addEdgeEii(%class.Graph* noundef nonnull align 8 dereferenceable(16) %2, i32 noundef 4, i32 noundef 1)
  call void @_ZN5Graph7addEdgeEii(%class.Graph* noundef nonnull align 8 dereferenceable(16) %2, i32 noundef 2, i32 noundef 3)
  call void @_ZN5Graph7addEdgeEii(%class.Graph* noundef nonnull align 8 dereferenceable(16) %2, i32 noundef 3, i32 noundef 1)
  %3 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([53 x i8], [53 x i8]* @.str.1, i64 0, i64 0))
  call void @_ZN5Graph15topologicalSortEv(%class.Graph* noundef nonnull align 8 dereferenceable(16) %2)
  ret i32 0
}
