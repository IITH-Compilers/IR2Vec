...
define dso_local noundef i32 @_Z4LISSP4node(%class.node* noundef %0) #5 {
...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef %class.node* @_Z7newNodei(i32 noundef %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca %class.node*, align 8
  store i32 %0, i32* %2, align 4
  %4 = call noalias noundef nonnull i8* @_Znwm(i64 noundef 24) #9
