...
define dso_local noundef i32 @_Z12getNextStatePciii(i8* noundef %0, i32 noundef %1, i32 noundef %2, i32 noundef %3) #0 {
...
; Function Attrs: mustprogress noinline nounwind uwtable
define dso_local void @_Z9computeTFPciPA256_i(i8* noundef %0, i32 noundef %1, [256 x i32]* noundef %2) #0 {
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
...
17:                                               ; preds = %14
  ...
  %22 = call noundef i32 @_Z12getNextStatePciii(i8* noundef %18, i32 noundef %19, i32 noundef %20, i32 noundef %21)
...
define dso_local void @_Z6searchPcS_(i8* noundef %0, i8* noundef %1) #1 {
  ...
  call void @_Z9computeTFPciPA256_i(i8* noundef %22, i32 noundef %23, [256 x i32]* noundef %21)
...
43:                                               ; preds = %28
  ...
  %47 = add nsw i32 %46, 1
  %48 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i64 0, i64 0), i32 noundef %47)
  br label %49
...
define dso_local noundef i32 @main() #5 {
  ...
  call void @_Z6searchPcS_(i8* noundef %4, i8* noundef %5)
  ret i32 0
}
