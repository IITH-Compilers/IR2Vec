...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_naive_algorithm.cpp, i8* null }]
...
define dso_local void @_Z6searchPcS_(i8* noundef %0, i8* noundef %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
51:                                               ; preds = %47
  %52 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0))
  %53 = load i32, i32* %7, align 4
  %54 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %52, i32 noundef %53)
...
define dso_local noundef i32 @main() #6 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %4, i8* align 16 getelementptr inbounds ([19 x i8], [19 x i8]* @__const.main.txt, i32 0, i32 0), i64 19, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_naive_algorithm.cpp() #0 section ".text.startup" {
