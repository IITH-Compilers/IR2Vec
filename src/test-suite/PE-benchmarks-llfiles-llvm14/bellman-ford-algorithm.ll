...
define dso_local void @_Z8printArrPii(i32* noundef %0, i32 noundef %1) #4 {
  ...
  store i32 %1, i32* %4, align 4
  %6 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0))
...
11:                                               ; preds = %7
  ...
  %18 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32 noundef %12, i32 noundef %17)
  br label %19
...
162:                                              ; preds = %150
  %163 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([37 x i8], [37 x i8]* @.str.2, i64 0, i64 0))
...
168:                                              ; preds = %116
  ...
  call void @_Z8printArrPii(i32* noundef %29, i32 noundef %169)
  store i32 1, i32* %19, align 4
  br label %170
...
define dso_local noundef i32 @main() #8 {
  ...
  call void @_Z11BellmanFordP5Graphi(%struct.Graph* noundef %128, i32 noundef 0)
  ret i32 0
}
