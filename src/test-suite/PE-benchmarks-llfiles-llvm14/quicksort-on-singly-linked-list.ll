...
define dso_local noundef %struct.Node* @_Z7getTailP4Node(%struct.Node* noundef %0) #3 {
  %2 = alloca %struct.Node*, align 8
  store %struct.Node* %0, %struct.Node** %2, align 8
  br label %3
...
; Function Attrs: mustprogress noinline nounwind uwtable
define dso_local noundef %struct.Node* @_Z9partitionP4NodeS0_PS0_S1_(%struct.Node* noundef %0, %struct.Node* noundef %1, %struct.Node** noundef %2, %struct.Node** noundef %3) #3 {
  %5 = alloca %struct.Node*, align 8
...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef %struct.Node* @_Z14quickSortRecurP4NodeS0_(%struct.Node* noundef %0, %struct.Node* noundef %1) #0 {
  %3 = alloca %struct.Node*, align 8
...
; Function Attrs: mustprogress noinline uwtable
define dso_local void @_Z9quickSortPP4Node(%struct.Node** noundef %0) #0 {
  %2 = alloca %struct.Node**, align 8
  store %struct.Node** %0, %struct.Node*** %2, align 8
