...
define dso_local noundef zeroext i1 @_Z11isSubsetSumPiii(i32* noundef %0, i32 noundef %1, i32 noundef %2) #0 {
...
define dso_local noundef i32 @main() #2 {
  ...
  %9 = call noundef zeroext i1 @_Z11isSubsetSumPiii(i32* noundef %6, i32 noundef %7, i32 noundef %8)
  %10 = zext i1 %9 to i32
  %11 = icmp eq i32 %10, 1
  br i1 %11, label %12, label %14

12:                                               ; preds = %0
  %13 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i64 0, i64 0))
  br label %16

14:                                               ; preds = %0
  %15 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i64 0, i64 0))
  br label %16
