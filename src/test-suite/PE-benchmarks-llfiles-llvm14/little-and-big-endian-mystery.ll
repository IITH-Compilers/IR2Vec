...
define dso_local void @_Z12show_mem_repPci(i8* noundef %0, i32 noundef %1) #0 {
  %3 = alloca i8*, align 8
...
10:                                               ; preds = %6
  ...
  %17 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 noundef %16)
  br label %18
...
define dso_local noundef i32 @main() #2 {
  ...
  store i32 19088743, i32* %2, align 4
  %3 = bitcast i32* %2 to i8*
  call void @_Z12show_mem_repPci(i8* noundef %3, i32 noundef 4)
  %4 = call i32 @getchar()
  ret i32 0
}
