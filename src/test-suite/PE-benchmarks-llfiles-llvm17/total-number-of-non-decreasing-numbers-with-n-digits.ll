...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_total_number_of_non_decreasing_numbers_with_n_digits.cpp, ptr null }]
