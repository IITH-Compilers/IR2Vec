...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_channel_assignment.cpp, ptr null }]
...
define dso_local noundef zeroext i1 @_Z3bpmPA4_iiPbPi(ptr noundef %0, i32 noundef %1, ptr noundef %2, ptr noundef %3) #4 {
  %5 = alloca i1, align 1
...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef i32 @_Z6maxBPMPA4_i(ptr noundef %0) #4 {
