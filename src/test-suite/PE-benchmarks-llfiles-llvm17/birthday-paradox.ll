...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_birthday_paradox.cpp, ptr null }]
...
define dso_local noundef i32 @_Z4findd(double noundef %0) #4 {
...
define dso_local noundef i32 @main() #6 {
  %1 = call noundef i32 @_Z4findd(double noundef 0x3FE6666666666666)
