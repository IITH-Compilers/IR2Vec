...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_magic_square.cpp, ptr null }]
...
define dso_local void @_Z14generateSquarei(i32 noundef %0) #4 {
