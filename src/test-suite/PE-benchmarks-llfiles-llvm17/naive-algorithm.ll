...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_naive_algorithm.cpp, ptr null }]
...
define dso_local void @_Z6searchPcS_(ptr noundef %0, ptr noundef %1) #4 {
