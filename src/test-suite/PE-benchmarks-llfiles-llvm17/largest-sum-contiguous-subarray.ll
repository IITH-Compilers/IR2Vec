...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_largest_sum_contiguous_subarray.cpp, ptr null }]
...
define dso_local noundef i32 @_Z14maxSubArraySumPii(ptr noundef %0, i32 noundef %1) #4 {
