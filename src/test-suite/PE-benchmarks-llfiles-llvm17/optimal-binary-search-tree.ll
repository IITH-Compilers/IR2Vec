...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_optimal_binary_search_tree.cpp, ptr null }]
...
define dso_local noundef i32 @_Z17optimalSearchTreePiS_i(ptr noundef %0, ptr noundef %1, i32 noundef %2) #4 {
...
define dso_local noundef i32 @_Z3sumPiii(ptr noundef %0, i32 noundef %1, i32 noundef %2) #6 {
  %4 = alloca ptr, align 8
