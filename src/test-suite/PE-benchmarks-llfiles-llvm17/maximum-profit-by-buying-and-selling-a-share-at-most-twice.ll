...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_maximum_profit_by_buying_and_selling_a_share_at_most_twice.cpp, ptr null }]
...
define dso_local noundef i32 @_Z9maxProfitPii(ptr noundef %0, i32 noundef %1) #4 {
  ...
  %20 = call noalias noundef nonnull ptr @_Znam(i64 noundef %19) #11
...
140:                                              ; preds = %131
  call void @_ZdaPv(ptr noundef %138) #12
  br label %141
