...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_find_length_of_the_longest_consecutive_path_in_a_character_matrix.cpp, ptr null }]
...
define dso_local noundef i32 @_Z10getLenUtilPA3_ciic(ptr noundef %0, i32 noundef %1, i32 noundef %2, i8 noundef signext %3) #5 {
  %5 = alloca i32, align 4
...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef i32 @_Z6getLenPA3_cc(ptr noundef %0, i8 noundef signext %1) #5 {
  %3 = alloca ptr, align 8
  %4 = alloca i8, align 1
  %5 = alloca i32, align 4
