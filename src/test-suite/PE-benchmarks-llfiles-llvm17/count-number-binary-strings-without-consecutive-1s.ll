...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_count_number_binary_strings_without_consecutive_1s.cpp, ptr null }]
