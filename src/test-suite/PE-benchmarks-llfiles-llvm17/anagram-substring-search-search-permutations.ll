...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_anagram_substring_search_search_permutations.cpp, ptr null }]
...
define dso_local noundef zeroext i1 @_Z7comparePcS_(ptr noundef %0, ptr noundef %1) #4 {
  %3 = alloca i1, align 1
