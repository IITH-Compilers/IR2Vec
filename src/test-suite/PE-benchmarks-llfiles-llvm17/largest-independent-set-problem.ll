...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_largest_independent_set_problem.cpp, ptr null }]
...
define dso_local noundef i32 @_Z3maxii(i32 noundef %0, i32 noundef %1) #4 {
...
define dso_local noundef i32 @_Z4LISSP4node(ptr noundef %0) #5 {
...
; Function Attrs: mustprogress noinline uwtable
define dso_local noundef ptr @_Z7newNodei(i32 noundef %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca ptr, align 8
  store i32 %0, ptr %2, align 4
  %4 = call noalias noundef nonnull ptr @_Znwm(i64 noundef 24) #9
