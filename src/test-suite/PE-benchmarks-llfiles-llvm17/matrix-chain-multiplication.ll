...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_matrix_chain_multiplication.cpp, ptr null }]
...
define dso_local noundef i32 @_Z16MatrixChainOrderPii(ptr noundef %0, i32 noundef %1) #4 {
