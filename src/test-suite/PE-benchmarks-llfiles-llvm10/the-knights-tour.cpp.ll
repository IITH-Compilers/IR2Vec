; ModuleID = 'temp/the-knights-tour.cpp'
source_filename = "temp/the-knights-tour.cpp"
...
for.body3:                                        ; preds = %for.cond1
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %5)
  br label %for.inc
...
for.end8:                                         ; preds = %for.cond
  ...
  %arraydecay = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %sol, i64 0, i64 0
  %arraydecay11 = getelementptr inbounds [8 x i32], [8 x i32]* %xMove, i64 0, i64 0
  %arraydecay12 = getelementptr inbounds [8 x i32], [8 x i32]* %yMove, i64 0, i64 0
...
if.then:                                          ; preds = %for.end8
  %call14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2, i64 0, i64 0))
  store i1 false, i1* %retval, align 1
  br label %return

if.else:                                          ; preds = %for.end8
  %arraydecay15 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %sol, i64 0, i64 0
