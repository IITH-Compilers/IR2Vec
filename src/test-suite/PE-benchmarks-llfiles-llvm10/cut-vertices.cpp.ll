; ModuleID = 'temp/cut-vertices.cpp'
source_filename = "temp/cut-vertices.cpp"
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN5Graph6APUtilEiPbPiS1_S1_S0_(%class.Graph* %this, i32 %u, i8* %visited, i32* %disc, i32* %low, i32* %parent, i8* %ap) #0 align 2 {
entry:
  %this.addr = alloca %class.Graph*, align 8
  ...
  %2 = load i32, i32* @_ZZN5Graph6APUtilEiPbPiS1_S1_S0_E4time, align 4
  %inc = add nsw i32 %2, 1
  store i32 %inc, i32* @_ZZN5Graph6APUtilEiPbPiS1_S1_S0_E4time, align 4
...
if.then:                                          ; preds = %for.body
  ...
  call void @_ZN5Graph6APUtilEiPbPiS1_S1_S0_(%class.Graph* %this1, i32 %21, i8* %22, i32* %23, i32* %24, i32* %25, i8* %26)
  %27 = load i32*, i32** %low.addr, align 8
  %28 = load i32, i32* %u.addr, align 4
  %idxprom21 = sext i32 %28 to i64
  %arrayidx22 = getelementptr inbounds i32, i32* %27, i64 %idxprom21
  %29 = load i32*, i32** %low.addr, align 8
  %30 = load i32, i32* %v, align 4
  %idxprom23 = sext i32 %30 to i64
  %arrayidx24 = getelementptr inbounds i32, i32* %29, i64 %idxprom23
  %call25 = call dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %arrayidx22, i32* dereferenceable(4) %arrayidx24)
  %31 = load i32, i32* %call25, align 4
  %32 = load i32*, i32** %low.addr, align 8
  %33 = load i32, i32* %u.addr, align 4
  ...
  %34 = load i32*, i32** %parent.addr, align 8
  %35 = load i32, i32* %u.addr, align 4
...
if.end:                                           ; preds = %if.then31, %land.lhs.true, %if.then
  %40 = load i32*, i32** %parent.addr, align 8
...
if.then50:                                        ; preds = %if.else
  ...
  %57 = load i32*, i32** %disc.addr, align 8
  %58 = load i32, i32* %v, align 4
  %idxprom53 = sext i32 %58 to i64
  %arrayidx54 = getelementptr inbounds i32, i32* %57, i64 %idxprom53
  %call55 = call dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %arrayidx52, i32* dereferenceable(4) %arrayidx54)
  %59 = load i32, i32* %call55, align 4
  %60 = load i32*, i32** %low.addr, align 8
  %61 = load i32, i32* %u.addr, align 4
  %idxprom56 = sext i32 %61 to i64
  %arrayidx57 = getelementptr inbounds i32, i32* %60, i64 %idxprom56
  store i32 %59, i32* %arrayidx57, align 4
  br label %if.end58

if.end58:                                         ; preds = %if.then50, %if.else
  br label %if.end59
...
for.inc:                                          ; preds = %if.end59
  %call60 = call dereferenceable(8) %"struct.std::_List_iterator"* @_ZNSt14_List_iteratorIiEppEv(%"struct.std::_List_iterator"* %i) #3
  br label %for.cond
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN5Graph2APEv(%class.Graph* %this) #0 align 2 {
entry:
  %this.addr = alloca %class.Graph*, align 8
  ...
  %19 = load i32, i32* %V11, align 8
  %conv12 = sext i32 %19 to i64
  %call13 = call i8* @_Znam(i64 %conv12) #12
  store i8* %call13, i8** %ap, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %20 = load i32, i32* %i, align 4
  %V14 = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 0
  %21 = load i32, i32* %V14, align 8
...
for.cond20:                                       ; preds = %for.inc28, %for.end
  ...
  %V21 = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 0
  %30 = load i32, i32* %V21, align 8
  %cmp22 = icmp slt i32 %29, %30
  br i1 %cmp22, label %for.body23, label %for.end30

for.body23:                                       ; preds = %for.cond20
  %31 = load i8*, i8** %visited, align 8
...
if.then:                                          ; preds = %for.body23
  ...
  %35 = load i8*, i8** %visited, align 8
  %36 = load i32*, i32** %disc, align 8
  %37 = load i32*, i32** %low, align 8
  %38 = load i32*, i32** %parent, align 8
  %39 = load i8*, i8** %ap, align 8
  call void @_ZN5Graph6APUtilEiPbPiS1_S1_S0_(%class.Graph* %this1, i32 %34, i8* %35, i32* %36, i32* %37, i32* %38, i8* %39)
  br label %if.end
...
if.then41:                                        ; preds = %for.body35
  %46 = load i32, i32* %i31, align 4
  %call42 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %46)
  %call43 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call42, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
  br label %if.end44

if.end44:                                         ; preds = %if.then41, %for.body35
  br label %for.inc45
...
entry:
  ...
  call void @_ZN5Graph2APEv(%class.Graph* %g1)
  %call1 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.2, i64 0, i64 0))
  ...
  call void @_ZN5Graph2APEv(%class.Graph* %g2)
  %call2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.3, i64 0, i64 0))
  ...
  call void @_ZN5Graph2APEv(%class.Graph* %g3)
  ret i32 0
}
