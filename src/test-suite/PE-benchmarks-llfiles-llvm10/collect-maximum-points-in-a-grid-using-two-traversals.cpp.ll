; ModuleID = 'temp/collect-maximum-points-in-a-grid-using-two-traversals.cpp'
source_filename = "temp/collect-maximum-points-in-a-grid-using-two-traversals.cpp"
...
entry:
  ...
  store [4 x i32]* %arr, [4 x i32]** %arr.addr, align 8
  %arraydecay = getelementptr inbounds [5 x [4 x [4 x i32]]], [5 x [4 x [4 x i32]]]* %mem, i64 0, i64 0
  ...
  %arraydecay1 = getelementptr inbounds [5 x [4 x [4 x i32]]], [5 x [4 x [4 x i32]]]* %mem, i64 0, i64 0
...
entry:
  ...
  %arraydecay = getelementptr inbounds [5 x [4 x i32]], [5 x [4 x i32]]* %arr, i64 0, i64 0
