; ModuleID = 'temp/insertion-sort-for-singly-linked-list.cpp'
source_filename = "temp/insertion-sort-for-singly-linked-list.cpp"
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0))
