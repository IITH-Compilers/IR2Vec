; ModuleID = 'temp/subset-sum-problem.cpp'
source_filename = "temp/subset-sum-problem.cpp"
...
entry:
  ...
  %arraydecay = getelementptr inbounds [6 x i32], [6 x i32]* %set, i64 0, i64 0
...
if.then:                                          ; preds = %entry
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i64 0, i64 0))
  br label %if.end
