; ModuleID = 'temp/palindrome-partitioning.cpp'
source_filename = "temp/palindrome-partitioning.cpp"
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str, i64 0, i64 0), i32 %call)
  ret i32 0
}
