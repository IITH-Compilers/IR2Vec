; ModuleID = 'temp/minimum-adjacent-swaps-to-move-maximum-and-minimum-to-corners.cpp'
source_filename = "temp/minimum-adjacent-swaps-to-move-maximum-and-minimum-to-corners.cpp"
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5solvePii(i32* %a, i32 %n) #0 {
entry:
...
if.then13:                                        ; preds = %for.end
  ...
  %sub14 = sub nsw i32 %sub, 2
  %add = add nsw i32 %23, %sub14
...
if.else:                                          ; preds = %for.end
  ...
  %add17 = add nsw i32 %26, %sub16
  %call18 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %add17)
  br label %if.end19
...
entry:
  ...
  call void @_Z5solvePii(i32* %arraydecay, i32 %1)
  ret i32 0
}
