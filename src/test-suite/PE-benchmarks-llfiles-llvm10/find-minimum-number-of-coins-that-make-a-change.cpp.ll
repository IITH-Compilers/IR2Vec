; ModuleID = 'temp/find-minimum-number-of-coins-that-make-a-change.cpp'
source_filename = "temp/find-minimum-number-of-coins-that-make-a-change.cpp"
...
entry:
  ...
  %arraydecay = getelementptr inbounds [4 x i32], [4 x i32]* %coins, i64 0, i64 0
