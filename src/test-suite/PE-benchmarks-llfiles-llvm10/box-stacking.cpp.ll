; ModuleID = 'temp/box-stacking.cpp'
source_filename = "temp/box-stacking.cpp"
...
entry:
  ...
  %arraydecay = getelementptr inbounds [4 x %struct.Box], [4 x %struct.Box]* %arr, i64 0, i64 0
  %1 = load i32, i32* %n, align 4
  %call = call i32 @_Z14maxStackHeightP3Boxi(%struct.Box* %arraydecay, i32 %1)
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str, i64 0, i64 0), i32 %call)
  ret i32 0
}
