; ModuleID = 'temp/reservoir-sampling.cpp'
source_filename = "temp/reservoir-sampling.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_reservoir_sampling.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z10printArrayPii(i32* %stream, i32 %n) #0 {
entry:
  %stream.addr = alloca i32*, align 8
  %n.addr = alloca i32, align 4
  %i = alloca i32, align 4
  store i32* %stream, i32** %stream.addr, align 8
...
for.body:                                         ; preds = %for.cond
  %2 = load i32*, i32** %stream.addr, align 8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z12selectKItemsPiii(i32* %stream, i32 %n, i32 %k) #0 {
entry:
  %stream.addr = alloca i32*, align 8
  %n.addr = alloca i32, align 4
...
for.body:                                         ; preds = %for.cond
  %5 = load i32*, i32** %stream.addr, align 8
...
if.then:                                          ; preds = %for.body5
  %15 = load i32*, i32** %stream.addr, align 8
...
for.end14:                                        ; preds = %for.cond3
  %call15 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1, i64 0, i64 0))
  %20 = load i32, i32* %k.addr, align 4
  call void @_Z10printArrayPii(i32* %vla, i32 %20)
...
entry:
  ...
  %stream = alloca [12 x i32], align 16
  %n = alloca i32, align 4
  %k = alloca i32, align 4
  store i32 0, i32* %retval, align 4
  %0 = bitcast [12 x i32]* %stream to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %0, i8* align 16 bitcast ([12 x i32]* @__const.main.stream to i8*), i64 48, i1 false)
  store i32 12, i32* %n, align 4
  store i32 5, i32* %k, align 4
  %arraydecay = getelementptr inbounds [12 x i32], [12 x i32]* %stream, i64 0, i64 0
  %1 = load i32, i32* %n, align 4
  %2 = load i32, i32* %k, align 4
  call void @_Z12selectKItemsPiii(i32* %arraydecay, i32 %1, i32 %2)
  ret i32 0
}
