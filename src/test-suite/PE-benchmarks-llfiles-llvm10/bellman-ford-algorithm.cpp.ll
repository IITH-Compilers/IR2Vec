; ModuleID = 'temp/bellman-ford-algorithm.cpp'
source_filename = "temp/bellman-ford-algorithm.cpp"
...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32 %2, i32 %5)
  br label %for.inc
...
if.then70:                                        ; preds = %land.lhs.true63
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.2, i64 0, i64 0))
