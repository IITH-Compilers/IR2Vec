; ModuleID = 'temp/longest-palindromic-subsequence.cpp'
source_filename = "temp/longest-palindromic-subsequence.cpp"
...
entry:
  ...
  %arraydecay = getelementptr inbounds [16 x i8], [16 x i8]* %seq, i64 0, i64 0
  %call = call i64 @strlen(i8* %arraydecay) #6
  %conv = trunc i64 %call to i32
  store i32 %conv, i32* %n, align 4
  %arraydecay1 = getelementptr inbounds [16 x i8], [16 x i8]* %seq, i64 0, i64 0
