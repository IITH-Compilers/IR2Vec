; ModuleID = 'temp/detect-cycle-in-a-graph.cpp'
source_filename = "temp/detect-cycle-in-a-graph.cpp"
...
; Function Attrs: noinline uwtable
define dso_local zeroext i1 @_ZN5Graph12isCyclicUtilEiPbS0_(%class.Graph* %this, i32 %v, i8* %visited, i8* %recStack) #0 align 2 {
entry:
  %retval = alloca i1, align 1
  %this.addr = alloca %class.Graph*, align 8
  %v.addr = alloca i32, align 4
  %visited.addr = alloca i8*, align 8
  %recStack.addr = alloca i8*, align 8
  ...
  store i8* %recStack, i8** %recStack.addr, align 8
  %this1 = load %class.Graph*, %class.Graph** %this.addr, align 8
...
land.lhs.true:                                    ; preds = %for.body
  %call19 = call dereferenceable(4) i32* @_ZNKSt14_List_iteratorIiEdeEv(%"struct.std::_List_iterator"* %i) #3
  %16 = load i32, i32* %call19, align 4
  %17 = load i8*, i8** %visited.addr, align 8
  %18 = load i8*, i8** %recStack.addr, align 8
  %call20 = call zeroext i1 @_ZN5Graph12isCyclicUtilEiPbS0_(%class.Graph* %this1, i32 %16, i8* %17, i8* %18)
...
if.else:                                          ; preds = %land.lhs.true, %for.body
  %19 = load i8*, i8** %recStack.addr, align 8
  %call22 = call dereferenceable(4) i32* @_ZNKSt14_List_iteratorIiEdeEv(%"struct.std::_List_iterator"* %i) #3
...
for.inc:                                          ; preds = %if.end27
  %call28 = call dereferenceable(8) %"struct.std::_List_iterator"* @_ZNSt14_List_iteratorIiEppEv(%"struct.std::_List_iterator"* %i) #3
  br label %for.cond
...
if.end29:                                         ; preds = %for.end, %entry
  %22 = load i8*, i8** %recStack.addr, align 8
...
return:                                           ; preds = %if.end29, %if.then26, %if.then21
...
; Function Attrs: noinline uwtable
define dso_local zeroext i1 @_ZN5Graph8isCyclicEv(%class.Graph* %this) #0 align 2 {
entry:
  %retval = alloca i1, align 1
  %this.addr = alloca %class.Graph*, align 8
  %visited = alloca i8*, align 8
  %recStack = alloca i8*, align 8
  ...
  %call4 = call i8* @_Znam(i64 %conv3) #12
  store i8* %call4, i8** %recStack, align 8
...
for.cond9:                                        ; preds = %for.inc14, %for.end
  ...
  %V10 = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 0
  %10 = load i32, i32* %V10, align 8
  %cmp11 = icmp slt i32 %9, %10
  br i1 %cmp11, label %for.body12, label %for.end16

for.body12:                                       ; preds = %for.cond9
  %11 = load i32, i32* %i8, align 4
  %12 = load i8*, i8** %visited, align 8
  %13 = load i8*, i8** %recStack, align 8
  %call13 = call zeroext i1 @_ZN5Graph12isCyclicUtilEiPbS0_(%class.Graph* %this1, i32 %11, i8* %12, i8* %13)
...
entry:
  ...
  %call = call zeroext i1 @_ZN5Graph8isCyclicEv(%class.Graph* %g)
  br i1 %call, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %call1 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0))
  br label %if.end

if.else:                                          ; preds = %entry
  %call2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i64 0, i64 0))
  br label %if.end
