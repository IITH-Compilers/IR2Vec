; ModuleID = 'temp/rat-in-a-maze.cpp'
source_filename = "temp/rat-in-a-maze.cpp"
...
entry:
  ...
  %arraydecay = getelementptr inbounds [4 x [4 x i32]], [4 x [4 x i32]]* %sol, i64 0, i64 0
...
if.end:                                           ; preds = %entry
  %arraydecay2 = getelementptr inbounds [4 x [4 x i32]], [4 x [4 x i32]]* %sol, i64 0, i64 0
...
entry:
  ...
  %arraydecay = getelementptr inbounds [4 x [4 x i32]], [4 x [4 x i32]]* %maze, i64 0, i64 0
