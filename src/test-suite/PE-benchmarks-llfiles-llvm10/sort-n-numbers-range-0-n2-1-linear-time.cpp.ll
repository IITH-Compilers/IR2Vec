; ModuleID = 'temp/sort-n-numbers-range-0-n2-1-linear-time.cpp'
source_filename = "temp/sort-n-numbers-range-0-n2-1-linear-time.cpp"
...
entry:
  ...
  %call = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0))
  %arraydecay = getelementptr inbounds [7 x i32], [7 x i32]* %arr, i64 0, i64 0
  %1 = load i32, i32* %n, align 4
  call void @_Z8printArrPii(i32* %arraydecay, i32 %1)
  %arraydecay1 = getelementptr inbounds [7 x i32], [7 x i32]* %arr, i64 0, i64 0
  %2 = load i32, i32* %n, align 4
  call void @_Z4sortPii(i32* %arraydecay1, i32 %2)
  %call2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0))
  %arraydecay3 = getelementptr inbounds [7 x i32], [7 x i32]* %arr, i64 0, i64 0
