; ModuleID = 'temp/mergeSort_LinkedList.cpp'
source_filename = "temp/mergeSort_LinkedList.cpp"
...
entry:
  ...
  call void @_Z9MergeSortPP4Node(%class.Node** %a)
  %call = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i64 0, i64 0))
