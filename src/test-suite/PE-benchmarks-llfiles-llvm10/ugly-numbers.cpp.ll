; ModuleID = 'temp/ugly-numbers.cpp'
source_filename = "temp/ugly-numbers.cpp"
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0), i32 %0)
