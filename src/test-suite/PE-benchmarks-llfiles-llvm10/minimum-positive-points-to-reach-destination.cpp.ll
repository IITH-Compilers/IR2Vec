; ModuleID = 'temp/minimum-positive-points-to-reach-destination.cpp'
source_filename = "temp/minimum-positive-points-to-reach-destination.cpp"
...
entry:
  ...
  %call = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0))
  %arraydecay = getelementptr inbounds [3 x [3 x i32]], [3 x [3 x i32]]* %points, i64 0, i64 0
