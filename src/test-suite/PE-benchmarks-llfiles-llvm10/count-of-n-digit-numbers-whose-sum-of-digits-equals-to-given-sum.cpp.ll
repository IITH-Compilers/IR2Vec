; ModuleID = 'temp/count-of-n-digit-numbers-whose-sum-of-digits-equals-to-given-sum.cpp'
source_filename = "temp/count-of-n-digit-numbers-whose-sum-of-digits-equals-to-given-sum.cpp"
