; ModuleID = 'temp/graph-coloring.cpp'
source_filename = "temp/graph-coloring.cpp"
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN5Graph14greedyColoringEv(%class.Graph* %this) #0 align 2 {
entry:
  %this.addr = alloca %class.Graph*, align 8
...
for.cond6:                                        ; preds = %for.inc12, %for.end
  ...
  %V7 = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 0
  %10 = load i32, i32* %V7, align 8
...
for.body9:                                        ; preds = %for.cond6
  ...
  %arrayidx11 = getelementptr inbounds i8, i8* %vla5, i64 %idxprom10
...
for.cond16:                                       ; preds = %for.inc87, %for.end14
  %13 = load i32, i32* %u15, align 4
  %V17 = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 0
  %14 = load i32, i32* %V17, align 8
...
for.body19:                                       ; preds = %for.cond16
  ...
  %adj = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 1
  %15 = load %"class.std::__cxx11::list"*, %"class.std::__cxx11::list"** %adj, align 8
  %16 = load i32, i32* %u15, align 4
  %idxprom20 = sext i32 %16 to i64
  %arrayidx21 = getelementptr inbounds %"class.std::__cxx11::list", %"class.std::__cxx11::list"* %15, i64 %idxprom20
  %call = call %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIiSaIiEE5beginEv(%"class.std::__cxx11::list"* %arrayidx21) #3
...
for.cond22:                                       ; preds = %for.inc40, %for.body19
  ...
  %call27 = call %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIiSaIiEE3endEv(%"class.std::__cxx11::list"* %arrayidx26) #3
  %coerce.dive28 = getelementptr inbounds %"struct.std::_List_iterator", %"struct.std::_List_iterator"* %ref.tmp23, i32 0, i32 0
  store %"struct.std::__detail::_List_node_base"* %call27, %"struct.std::__detail::_List_node_base"** %coerce.dive28, align 8
  %call29 = call zeroext i1 @_ZNKSt14_List_iteratorIiEneERKS0_(%"struct.std::_List_iterator"* %i, %"struct.std::_List_iterator"* dereferenceable(8) %ref.tmp23) #3
  br i1 %call29, label %for.body30, label %for.end42

for.body30:                                       ; preds = %for.cond22
  %call31 = call dereferenceable(4) i32* @_ZNKSt14_List_iteratorIiEdeEv(%"struct.std::_List_iterator"* %i) #3
  %21 = load i32, i32* %call31, align 4
...
if.then:                                          ; preds = %for.body30
  %call35 = call dereferenceable(4) i32* @_ZNKSt14_List_iteratorIiEdeEv(%"struct.std::_List_iterator"* %i) #3
  ...
  %arrayidx39 = getelementptr inbounds i8, i8* %vla5, i64 %idxprom38
...
for.inc40:                                        ; preds = %if.end
  %call41 = call dereferenceable(8) %"struct.std::_List_iterator"* @_ZNSt14_List_iteratorIiEppEv(%"struct.std::_List_iterator"* %i) #3
  br label %for.cond22
...
for.cond44:                                       ; preds = %for.inc53, %for.end42
  %25 = load i32, i32* %cr43, align 4
  %V45 = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 0
  %26 = load i32, i32* %V45, align 8
  %cmp46 = icmp slt i32 %25, %26
  br i1 %cmp46, label %for.body47, label %for.end55

for.body47:                                       ; preds = %for.cond44
  %27 = load i32, i32* %cr43, align 4
  %idxprom48 = sext i32 %27 to i64
  %arrayidx49 = getelementptr inbounds i8, i8* %vla5, i64 %idxprom48
...
for.end55:                                        ; preds = %if.then51, %for.cond44
  ...
  %adj59 = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 1
  %32 = load %"class.std::__cxx11::list"*, %"class.std::__cxx11::list"** %adj59, align 8
  %33 = load i32, i32* %u15, align 4
  %idxprom60 = sext i32 %33 to i64
  %arrayidx61 = getelementptr inbounds %"class.std::__cxx11::list", %"class.std::__cxx11::list"* %32, i64 %idxprom60
  %call62 = call %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIiSaIiEE5beginEv(%"class.std::__cxx11::list"* %arrayidx61) #3
  %coerce.dive63 = getelementptr inbounds %"struct.std::_List_iterator", %"struct.std::_List_iterator"* %ref.tmp58, i32 0, i32 0
  store %"struct.std::__detail::_List_node_base"* %call62, %"struct.std::__detail::_List_node_base"** %coerce.dive63, align 8
...
for.cond64:                                       ; preds = %for.inc84, %for.end55
  %adj66 = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 1
  %36 = load %"class.std::__cxx11::list"*, %"class.std::__cxx11::list"** %adj66, align 8
  %37 = load i32, i32* %u15, align 4
  %idxprom67 = sext i32 %37 to i64
  %arrayidx68 = getelementptr inbounds %"class.std::__cxx11::list", %"class.std::__cxx11::list"* %36, i64 %idxprom67
  %call69 = call %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIiSaIiEE3endEv(%"class.std::__cxx11::list"* %arrayidx68) #3
  %coerce.dive70 = getelementptr inbounds %"struct.std::_List_iterator", %"struct.std::_List_iterator"* %ref.tmp65, i32 0, i32 0
  store %"struct.std::__detail::_List_node_base"* %call69, %"struct.std::__detail::_List_node_base"** %coerce.dive70, align 8
  %call71 = call zeroext i1 @_ZNKSt14_List_iteratorIiEneERKS0_(%"struct.std::_List_iterator"* %i, %"struct.std::_List_iterator"* dereferenceable(8) %ref.tmp65) #3
  br i1 %call71, label %for.body72, label %for.end86

for.body72:                                       ; preds = %for.cond64
  %call73 = call dereferenceable(4) i32* @_ZNKSt14_List_iteratorIiEdeEv(%"struct.std::_List_iterator"* %i) #3
  %38 = load i32, i32* %call73, align 4
...
if.then77:                                        ; preds = %for.body72
  %call78 = call dereferenceable(4) i32* @_ZNKSt14_List_iteratorIiEdeEv(%"struct.std::_List_iterator"* %i) #3
  %40 = load i32, i32* %call78, align 4
  %idxprom79 = sext i32 %40 to i64
  %arrayidx80 = getelementptr inbounds i32, i32* %vla, i64 %idxprom79
  %41 = load i32, i32* %arrayidx80, align 4
  %idxprom81 = sext i32 %41 to i64
  %arrayidx82 = getelementptr inbounds i8, i8* %vla5, i64 %idxprom81
...
for.inc84:                                        ; preds = %if.end83
  %call85 = call dereferenceable(8) %"struct.std::_List_iterator"* @_ZNSt14_List_iteratorIiEppEv(%"struct.std::_List_iterator"* %i) #3
  br label %for.cond64
...
for.cond91:                                       ; preds = %for.inc102, %for.end89
  %43 = load i32, i32* %u90, align 4
  %V92 = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 0
  %44 = load i32, i32* %V92, align 8
  %cmp93 = icmp slt i32 %43, %44
  br i1 %cmp93, label %for.body94, label %for.end104

for.body94:                                       ; preds = %for.cond91
  %call95 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0))
  %45 = load i32, i32* %u90, align 4
  %call96 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %call95, i32 %45)
  %call97 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call96, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0))
  %46 = load i32, i32* %u90, align 4
  %idxprom98 = sext i32 %46 to i64
  %arrayidx99 = getelementptr inbounds i32, i32* %vla, i64 %idxprom98
  %47 = load i32, i32* %arrayidx99, align 4
  %call100 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %call97, i32 %47)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local zeroext i1 @_ZNKSt14_List_iteratorIiEneERKS0_(%"struct.std::_List_iterator"* %this, %"struct.std::_List_iterator"* dereferenceable(8) %__x) #4 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_List_iterator"*, align 8
...
invoke.cont5:                                     ; preds = %invoke.cont4
  %call = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2, i64 0, i64 0))
...
invoke.cont15:                                    ; preds = %invoke.cont14
  %call17 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i64 0, i64 0))
...
lpad:                                             ; preds = %invoke.cont7, %invoke.cont6, %invoke.cont5, %invoke.cont4, %invoke.cont3, %invoke.cont2, %invoke.cont1, %invoke.cont, %entry
  %1 = landingpad { i8*, i32 }
          cleanup
...
invoke.cont:                                      ; preds = %while.body
  ...
  invoke void @_ZNSt16allocator_traitsISaISt10_List_nodeIiEEE7destroyIiEEvRS2_PT_(%"class.std::allocator"* dereferenceable(1) %call5, i32* %10)
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaISt10_List_nodeIiEEE7destroyIiEEvRS2_PT_(%"class.std::allocator"* dereferenceable(1) %__a, i32* %__p) #0 comdat align 2 {
entry:
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIiEE7destroyIiEEvPT_(%"class.__gnu_cxx::new_allocator"* %1, i32* %2)
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeIiEE10deallocateEPS2_m(%"class.__gnu_cxx::new_allocator"* %this, %"struct.std::_List_node"* %__p, i64 %0) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  %__p.addr = alloca %"struct.std::_List_node"*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local dereferenceable(16) %"struct.std::__allocated_ptr"* @_ZNSt15__allocated_ptrISaISt10_List_nodeIiEEEaSEDn(%"struct.std::__allocated_ptr"* %this, i8* %0) #4 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::__allocated_ptr"*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i64 @_ZNK9__gnu_cxx13new_allocatorISt10_List_nodeIiEE8max_sizeEv(%"class.__gnu_cxx::new_allocator"* %this) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  store %"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator"*, %"class.__gnu_cxx::new_allocator"** %this.addr, align 8
