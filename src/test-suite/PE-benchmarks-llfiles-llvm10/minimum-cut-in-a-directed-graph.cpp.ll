; ModuleID = 'temp/minimum-cut-in-a-directed-graph.cpp'
source_filename = "temp/minimum-cut-in-a-directed-graph.cpp"
...
entry:
  ...
  %arraydecay = getelementptr inbounds [6 x i8], [6 x i8]* %visited, i64 0, i64 0
...
while.cond:                                       ; preds = %for.end44, %for.end12
  %arraydecay = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* %rGraph, i64 0, i64 0
  %10 = load i32, i32* %s.addr, align 4
  %11 = load i32, i32* %t.addr, align 4
  %arraydecay13 = getelementptr inbounds [6 x i32], [6 x i32]* %parent, i64 0, i64 0
...
while.end:                                        ; preds = %while.cond
  %arraydecay45 = getelementptr inbounds [6 x i8], [6 x i8]* %visited, i64 0, i64 0
  call void @llvm.memset.p0i8.i64(i8* align 1 %arraydecay45, i8 0, i64 6, i1 false)
  %arraydecay46 = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* %rGraph, i64 0, i64 0
  %37 = load i32, i32* %s.addr, align 4
  %arraydecay47 = getelementptr inbounds [6 x i8], [6 x i8]* %visited, i64 0, i64 0
...
if.then:                                          ; preds = %land.lhs.true60
  ...
  %call67 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call66, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0))
...
entry:
  ...
  %arraydecay = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* %graph, i64 0, i64 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorIPiE10deallocateEPS1_m(%"class.__gnu_cxx::new_allocator.1"* %this, i32** %__p, i64 %0) #5 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.1"*, align 8
  %__p.addr = alloca i32**, align 8
  %.addr = alloca i64, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32** @_ZN9__gnu_cxx13new_allocatorIPiE8allocateEmPKv(%"class.__gnu_cxx::new_allocator.1"* %this, i64 %__n, i8* %0) #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.1"*, align 8
  %__n.addr = alloca i64, align 8
  ...
  %this1 = load %"class.__gnu_cxx::new_allocator.1"*, %"class.__gnu_cxx::new_allocator.1"** %this.addr, align 8
  %1 = load i64, i64* %__n.addr, align 8
  %call = call i64 @_ZNK9__gnu_cxx13new_allocatorIPiE8max_sizeEv(%"class.__gnu_cxx::new_allocator.1"* %this1) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i64 @_ZNK9__gnu_cxx13new_allocatorIPiE8max_sizeEv(%"class.__gnu_cxx::new_allocator.1"* %this) #5 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator.1"*, align 8
  store %"class.__gnu_cxx::new_allocator.1"* %this, %"class.__gnu_cxx::new_allocator.1"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator.1"*, %"class.__gnu_cxx::new_allocator.1"** %this.addr, align 8
...
entry:
  ...
  %4 = bitcast %"struct.std::_Deque_base<int, std::allocator<int> >::_Deque_impl"* %_M_impl2 to %"class.std::allocator"*
  %5 = bitcast %"class.std::deque"* %this1 to %"class.std::_Deque_base"*
  ...
  invoke void @_ZNSt16allocator_traitsISaIiEE9constructIiJRKiEEEvRS0_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %4, i32* %6, i32* dereferenceable(4) %call5)
          to label %invoke.cont unwind label %lpad
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local zeroext i1 @_ZSteqIiRiPiEbRKSt15_Deque_iteratorIT_T0_T1_ES8_(%"struct.std::_Deque_iterator"* dereferenceable(32) %__x, %"struct.std::_Deque_iterator"* dereferenceable(32) %__y) #5 comdat {
entry:
  %__x.addr = alloca %"struct.std::_Deque_iterator"*, align 8
...
if.then:                                          ; preds = %entry
  ...
  %7 = load i32*, i32** %_M_cur7, align 8
  invoke void @_ZNSt16allocator_traitsISaIiEE7destroyIiEEvRS0_PT_(%"class.std::allocator"* dereferenceable(1) %5, i32* %7)
          to label %invoke.cont unwind label %terminate.lpad
...
entry:
  ...
  call void @_ZNSt16allocator_traitsISaIiEE7destroyIiEEvRS0_PT_(%"class.std::allocator"* dereferenceable(1) %call, i32* %2)
  %3 = bitcast %"class.std::deque"* %this1 to %"class.std::_Deque_base"*
  %4 = bitcast %"class.std::deque"* %this1 to %"class.std::_Deque_base"*
