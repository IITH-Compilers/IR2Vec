; ModuleID = 'temp/finite-automata-algorithm.cpp'
source_filename = "temp/finite-automata-algorithm.cpp"
...
if.then:                                          ; preds = %for.body
  ...
  %call9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i64 0, i64 0), i32 %add8)
  br label %if.end
...
entry:
  ...
  store i32 0, i32* %retval, align 4
  store i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i8** %txt, align 8
  store i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i8** %pat, align 8
