; ModuleID = 'temp/rabin-karp-algorithm.cpp'
source_filename = "temp/rabin-karp-algorithm.cpp"
...
if.then39:                                        ; preds = %for.end37
  %call40 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i64 0, i64 0))
...
entry:
  ...
  %arraydecay1 = getelementptr inbounds [16 x i8], [16 x i8]* %txt, i64 0, i64 0
