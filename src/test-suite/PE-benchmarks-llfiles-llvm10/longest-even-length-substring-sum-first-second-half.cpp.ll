; ModuleID = 'temp/longest-even-length-substring-sum-first-second-half.cpp'
source_filename = "temp/longest-even-length-substring-sum-first-second-half.cpp"
...
entry:
  ...
  %call = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i64 0, i64 0))
