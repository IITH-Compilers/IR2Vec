; ModuleID = 'temp/Nearly_sorted_Algo.cpp'
source_filename = "temp/Nearly_sorted_Algo.cpp"
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local dereferenceable(4) i32* @_ZNKSt14priority_queueIiSt6vectorIiSaIiEESt7greaterIiEE3topEv(%"class.std::priority_queue"* %this) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::priority_queue"*, align 8
  store %"class.std::priority_queue"* %this, %"class.std::priority_queue"** %this.addr, align 8
  %this1 = load %"class.std::priority_queue"*, %"class.std::priority_queue"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local zeroext i1 @_ZNKSt14priority_queueIiSt6vectorIiSaIiEESt7greaterIiEE5emptyEv(%"class.std::priority_queue"* %this) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::priority_queue"*, align 8
  store %"class.std::priority_queue"* %this, %"class.std::priority_queue"** %this.addr, align 8
  %this1 = load %"class.std::priority_queue"*, %"class.std::priority_queue"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt14priority_queueIiSt6vectorIiSaIiEESt7greaterIiEED2Ev(%"class.std::priority_queue"* %this) unnamed_addr #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::priority_queue"*, align 8
  store %"class.std::priority_queue"* %this, %"class.std::priority_queue"** %this.addr, align 8
  %this1 = load %"class.std::priority_queue"*, %"class.std::priority_queue"** %this.addr, align 8
...
entry:
  ...
  %call1 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.1, i64 0, i64 0))
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local dereferenceable(24) %"class.std::vector"* @_ZSt4moveIRSt6vectorIiSaIiEEEONSt16remove_referenceIT_E4typeEOS5_(%"class.std::vector"* dereferenceable(24) %__t) #4 comdat {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt6vectorIiSaIiEEC2EOS1_(%"class.std::vector"* %this, %"class.std::vector"* dereferenceable(24) %__x) unnamed_addr #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  ...
  %call = call dereferenceable(24) %"class.std::vector"* @_ZSt4moveIRSt6vectorIiSaIiEEEONSt16remove_referenceIT_E4typeEOS5_(%"class.std::vector"* dereferenceable(24) %1) #3
  %2 = bitcast %"class.std::vector"* %call to %"struct.std::_Vector_base"*
  call void @_ZNSt12_Vector_baseIiSaIiEEC2EOS1_(%"struct.std::_Vector_base"* %0, %"struct.std::_Vector_base"* dereferenceable(24) %2) #3
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEC2IPiEERKNS0_IT_NS_11__enable_ifIXsr3std10__are_sameIS9_S8_EE7__valueES5_E6__typeEEE(%"class.__gnu_cxx::__normal_iterator.0"* %this, %"class.__gnu_cxx::__normal_iterator"* dereferenceable(8) %__i) unnamed_addr #4 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt12_Vector_baseIiSaIiEEC2EOS1_(%"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"* dereferenceable(24) %__x) unnamed_addr #4 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Vector_base"*, align 8
  %__x.addr = alloca %"struct.std::_Vector_base"*, align 8
  store %"struct.std::_Vector_base"* %this, %"struct.std::_Vector_base"** %this.addr, align 8
  store %"struct.std::_Vector_base"* %__x, %"struct.std::_Vector_base"** %__x.addr, align 8
  %this1 = load %"struct.std::_Vector_base"*, %"struct.std::_Vector_base"** %this.addr, align 8
  %_M_impl = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %this1, i32 0, i32 0
  %0 = load %"struct.std::_Vector_base"*, %"struct.std::_Vector_base"** %__x.addr, align 8
  %call = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %0) #3
  %call2 = call dereferenceable(1) %"class.std::allocator"* @_ZSt4moveIRSaIiEEONSt16remove_referenceIT_E4typeEOS3_(%"class.std::allocator"* dereferenceable(1) %call) #3
  call void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2EOS0_(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl, %"class.std::allocator"* dereferenceable(1) %call2) #3
  %_M_impl3 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %this1, i32 0, i32 0
  %1 = load %"struct.std::_Vector_base"*, %"struct.std::_Vector_base"** %__x.addr, align 8
  %_M_impl4 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %1, i32 0, i32 0
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local dereferenceable(1) %"class.std::allocator"* @_ZSt4moveIRSaIiEEONSt16remove_referenceIT_E4typeEOS3_(%"class.std::allocator"* dereferenceable(1) %__t) #4 comdat {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt12_Vector_baseIiSaIiEE12_Vector_implC2EOS0_(%"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this, %"class.std::allocator"* dereferenceable(1) %__a) unnamed_addr #4 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"*, align 8
  %__a.addr = alloca %"class.std::allocator"*, align 8
  store %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this, %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"** %this.addr, align 8
  ...
  call void @_ZNSaIiEC2ERKS_(%"class.std::allocator"* %0, %"class.std::allocator"* dereferenceable(1) %call) #3
  %_M_start = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this1, i32 0, i32 0
  store i32* null, i32** %_M_start, align 8
  %_M_finish = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %this1, i32 0, i32 1
  store i32* null, i32** %_M_finish, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i64 @_ZN9__gnu_cxxmiIPKiSt6vectorIiSaIiEEEENS_17__normal_iteratorIT_T0_E15difference_typeERKS9_SC_(%"class.__gnu_cxx::__normal_iterator.0"* dereferenceable(8) %__lhs, %"class.__gnu_cxx::__normal_iterator.0"* dereferenceable(8) %__rhs) #4 comdat {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i32* @_ZNKSt6vectorIiSaIiEE6cbeginEv(%"class.std::vector"* %this) #4 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEplEl(%"class.__gnu_cxx::__normal_iterator"* %this, i64 %__n) #4 comdat align 2 {
entry:
  %retval = alloca %"class.__gnu_cxx::__normal_iterator", align 8
...
if.then:                                          ; preds = %entry
  ...
  %6 = load i32*, i32** %_M_end_of_storage, align 8
  %7 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl2 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %7, i32 0, i32 0
  %_M_finish = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl2, i32 0, i32 1
  %8 = load i32*, i32** %_M_finish, align 8
  %sub.ptr.lhs.cast = ptrtoint i32* %6 to i64
  %sub.ptr.rhs.cast = ptrtoint i32* %8 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %sub.ptr.div = sdiv exact i64 %sub.ptr.sub, 4
  %9 = load i64, i64* %__n, align 8
  %cmp3 = icmp uge i64 %sub.ptr.div, %9
...
if.then4:                                         ; preds = %if.then
  ...
  store i32* %11, i32** %__old_finish, align 8
...
if.then11:                                        ; preds = %if.then4
  ...
  %_M_finish13 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl12, i32 0, i32 1
  %15 = load i32*, i32** %_M_finish13, align 8
  %16 = load i64, i64* %__n, align 8
  %idx.neg = sub i64 0, %16
  %add.ptr = getelementptr inbounds i32, i32* %15, i64 %idx.neg
  %17 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl14 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %17, i32 0, i32 0
  %_M_finish15 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl14, i32 0, i32 1
  %18 = load i32*, i32** %_M_finish15, align 8
  %19 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl16 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %19, i32 0, i32 0
  %_M_finish17 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl16, i32 0, i32 1
  %20 = load i32*, i32** %_M_finish17, align 8
  %21 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %call18 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %21) #3
  %call19 = call i32* @_ZSt22__uninitialized_move_aIPiS0_SaIiEET0_T_S3_S2_RT1_(i32* %add.ptr, i32* %18, i32* %20, %"class.std::allocator"* dereferenceable(1) %call18)
  ...
  %_M_finish21 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl20, i32 0, i32 1
  %24 = load i32*, i32** %_M_finish21, align 8
  %add.ptr22 = getelementptr inbounds i32, i32* %24, i64 %22
  ...
  %25 = load i32*, i32** %call23, align 8
  %26 = load i32*, i32** %__old_finish, align 8
  %27 = load i64, i64* %__n, align 8
  %idx.neg24 = sub i64 0, %27
  %add.ptr25 = getelementptr inbounds i32, i32* %26, i64 %idx.neg24
  %28 = load i32*, i32** %__old_finish, align 8
  %call26 = call i32* @_ZSt13move_backwardIPiS0_ET0_T_S2_S1_(i32* %25, i32* %add.ptr25, i32* %28)
  %29 = load i32*, i32** %__first.addr, align 8
  %30 = load i32*, i32** %__last.addr, align 8
  %31 = bitcast %"class.__gnu_cxx::__normal_iterator"* %agg.tmp to i8*
  %32 = bitcast %"class.__gnu_cxx::__normal_iterator"* %__position to i8*
  ...
  %33 = load i32*, i32** %coerce.dive27, align 8
  %call28 = call i32* @_ZSt4copyIPiN9__gnu_cxx17__normal_iteratorIS0_St6vectorIiSaIiEEEEET0_T_S8_S7_(i32* %29, i32* %30, i32* %33)
...
if.else:                                          ; preds = %if.then4
  %34 = load i32*, i32** %__first.addr, align 8
  store i32* %34, i32** %__mid, align 8
  %35 = load i64, i64* %__elems_after, align 8
  call void @_ZSt7advanceIPimEvRT_T0_(i32** dereferenceable(8) %__mid, i64 %35)
  %36 = load i32*, i32** %__mid, align 8
  %37 = load i32*, i32** %__last.addr, align 8
  %38 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl30 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %38, i32 0, i32 0
  %_M_finish31 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl30, i32 0, i32 1
  %39 = load i32*, i32** %_M_finish31, align 8
  %40 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %call32 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %40) #3
  %call33 = call i32* @_ZSt22__uninitialized_copy_aIPiS0_iET0_T_S2_S1_RSaIT1_E(i32* %36, i32* %37, i32* %39, %"class.std::allocator"* dereferenceable(1) %call32)
  %41 = load i64, i64* %__n, align 8
  ...
  %_M_finish35 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl34, i32 0, i32 1
  %44 = load i32*, i32** %_M_finish35, align 8
  %add.ptr36 = getelementptr inbounds i32, i32* %44, i64 %sub
  ...
  %45 = load i32*, i32** %call37, align 8
  %46 = load i32*, i32** %__old_finish, align 8
  ...
  %_M_finish39 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl38, i32 0, i32 1
  %48 = load i32*, i32** %_M_finish39, align 8
  %49 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %call40 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %49) #3
  %call41 = call i32* @_ZSt22__uninitialized_move_aIPiS0_SaIiEET0_T_S3_S2_RT1_(i32* %45, i32* %46, i32* %48, %"class.std::allocator"* dereferenceable(1) %call40)
  %50 = load i64, i64* %__elems_after, align 8
  %51 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl42 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %51, i32 0, i32 0
  %_M_finish43 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl42, i32 0, i32 1
  %52 = load i32*, i32** %_M_finish43, align 8
  %add.ptr44 = getelementptr inbounds i32, i32* %52, i64 %50
  store i32* %add.ptr44, i32** %_M_finish43, align 8
  %53 = load i32*, i32** %__first.addr, align 8
  %54 = load i32*, i32** %__mid, align 8
  %55 = bitcast %"class.__gnu_cxx::__normal_iterator"* %agg.tmp45 to i8*
  %56 = bitcast %"class.__gnu_cxx::__normal_iterator"* %__position to i8*
  ...
  %57 = load i32*, i32** %coerce.dive46, align 8
  %call47 = call i32* @_ZSt4copyIPiN9__gnu_cxx17__normal_iteratorIS0_St6vectorIiSaIiEEEEET0_T_S8_S7_(i32* %53, i32* %54, i32* %57)
...
if.else50:                                        ; preds = %if.then
  %58 = load i64, i64* %__n, align 8
  %call51 = call i64 @_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc(%"class.std::vector"* %this1, i64 %58, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2, i64 0, i64 0))
  ...
  %call52 = call i32* @_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm(%"struct.std::_Vector_base"* %59, i64 %60)
  store i32* %call52, i32** %__new_start, align 8
  %61 = load i32*, i32** %__new_start, align 8
  store i32* %61, i32** %__new_finish, align 8
  %62 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl53 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %62, i32 0, i32 0
  %_M_start = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl53, i32 0, i32 0
  %63 = load i32*, i32** %_M_start, align 8
  ...
  %64 = load i32*, i32** %call54, align 8
  %65 = load i32*, i32** %__new_start, align 8
  %66 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %call55 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %66) #3
  %call56 = invoke i32* @_ZSt34__uninitialized_move_if_noexcept_aIPiS0_SaIiEET0_T_S3_S2_RT1_(i32* %63, i32* %64, i32* %65, %"class.std::allocator"* dereferenceable(1) %call55)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %if.else50
  store i32* %call56, i32** %__new_finish, align 8
  %67 = load i32*, i32** %__first.addr, align 8
  %68 = load i32*, i32** %__last.addr, align 8
  %69 = load i32*, i32** %__new_finish, align 8
  %70 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %call57 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %70) #3
  %call59 = invoke i32* @_ZSt22__uninitialized_copy_aIPiS0_iET0_T_S2_S1_RSaIT1_E(i32* %67, i32* %68, i32* %69, %"class.std::allocator"* dereferenceable(1) %call57)
...
invoke.cont58:                                    ; preds = %invoke.cont
  ...
  %71 = load i32*, i32** %call60, align 8
  %72 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl61 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %72, i32 0, i32 0
  %_M_finish62 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl61, i32 0, i32 1
  %73 = load i32*, i32** %_M_finish62, align 8
  %74 = load i32*, i32** %__new_finish, align 8
  %75 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %call63 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %75) #3
  %call65 = invoke i32* @_ZSt34__uninitialized_move_if_noexcept_aIPiS0_SaIiEET0_T_S3_S2_RT1_(i32* %71, i32* %73, i32* %74, %"class.std::allocator"* dereferenceable(1) %call63)
...
lpad:                                             ; preds = %invoke.cont58, %invoke.cont, %if.else50
  ...
  %exn = load i8*, i8** %exn.slot, align 8
  %79 = call i8* @__cxa_begin_catch(i8* %exn) #3
  %80 = load i32*, i32** %__new_start, align 8
  %81 = load i32*, i32** %__new_finish, align 8
  %82 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %call66 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %82) #3
  invoke void @_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E(i32* %80, i32* %81, %"class.std::allocator"* dereferenceable(1) %call66)
          to label %invoke.cont68 unwind label %lpad67

invoke.cont68:                                    ; preds = %catch
  %83 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %84 = load i32*, i32** %__new_start, align 8
  %85 = load i64, i64* %__len, align 8
...
try.cont:                                         ; preds = %invoke.cont64
  ...
  %_M_impl71 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %89, i32 0, i32 0
  %_M_start72 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl71, i32 0, i32 0
  %90 = load i32*, i32** %_M_start72, align 8
  %91 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl73 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %91, i32 0, i32 0
  %_M_finish74 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl73, i32 0, i32 1
  %92 = load i32*, i32** %_M_finish74, align 8
  %93 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %call75 = call dereferenceable(1) %"class.std::allocator"* @_ZNSt12_Vector_baseIiSaIiEE19_M_get_Tp_allocatorEv(%"struct.std::_Vector_base"* %93) #3
  call void @_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E(i32* %90, i32* %92, %"class.std::allocator"* dereferenceable(1) %call75)
  %94 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %95 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl76 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %95, i32 0, i32 0
  %_M_start77 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl76, i32 0, i32 0
  %96 = load i32*, i32** %_M_start77, align 8
  %97 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl78 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %97, i32 0, i32 0
  %_M_end_of_storage79 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl78, i32 0, i32 2
  %98 = load i32*, i32** %_M_end_of_storage79, align 8
  %99 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl80 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %99, i32 0, i32 0
  %_M_start81 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl80, i32 0, i32 0
  %100 = load i32*, i32** %_M_start81, align 8
  %sub.ptr.lhs.cast82 = ptrtoint i32* %98 to i64
  %sub.ptr.rhs.cast83 = ptrtoint i32* %100 to i64
  %sub.ptr.sub84 = sub i64 %sub.ptr.lhs.cast82, %sub.ptr.rhs.cast83
  %sub.ptr.div85 = sdiv exact i64 %sub.ptr.sub84, 4
  call void @_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim(%"struct.std::_Vector_base"* %94, i32* %96, i64 %sub.ptr.div85)
  %101 = load i32*, i32** %__new_start, align 8
  %102 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl86 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %102, i32 0, i32 0
  %_M_start87 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl86, i32 0, i32 0
  store i32* %101, i32** %_M_start87, align 8
  %103 = load i32*, i32** %__new_finish, align 8
  %104 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl88 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %104, i32 0, i32 0
  %_M_finish89 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl88, i32 0, i32 1
  store i32* %103, i32** %_M_finish89, align 8
  %105 = load i32*, i32** %__new_start, align 8
  %106 = load i64, i64* %__len, align 8
  %add.ptr90 = getelementptr inbounds i32, i32* %105, i64 %106
  %107 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl91 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %107, i32 0, i32 0
  %_M_end_of_storage92 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl91, i32 0, i32 2
...
entry:
  ...
  %call3 = call i32* @_ZSt14__copy_move_a2ILb0EPiN9__gnu_cxx17__normal_iteratorIS0_St6vectorIiSaIiEEEEET1_T0_S8_S7_(i32* %call, i32* %call1, i32* %4)
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32* @_ZSt22__uninitialized_copy_aIPiS0_iET0_T_S2_S1_RSaIT1_E(i32* %__first, i32* %__last, i32* %__result, %"class.std::allocator"* dereferenceable(1) %0) #0 comdat {
entry:
  %__first.addr = alloca i32*, align 8
  %__last.addr = alloca i32*, align 8
  %__result.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i64 @_ZSt10__distanceIPiENSt15iterator_traitsIT_E15difference_typeES2_S2_St26random_access_iterator_tag(i32* %__first, i32* %__last) #4 comdat {
entry:
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32* @_ZSt14__copy_move_a2ILb0EPiN9__gnu_cxx17__normal_iteratorIS0_St6vectorIiSaIiEEEEET1_T0_S8_S7_(i32* %__first, i32* %__last, i32* %__result.coerce) #0 comdat {
entry:
  %retval = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %__result = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %__first.addr = alloca i32*, align 8
  ...
  %coerce.dive2 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %agg.tmp, i32 0, i32 0
  %4 = load i32*, i32** %coerce.dive2, align 8
  %call3 = call i32* @_ZSt12__niter_baseIPiSt6vectorIiSaIiEEET_N9__gnu_cxx17__normal_iteratorIS4_T0_EE(i32* %4)
  %call4 = call i32* @_ZSt13__copy_move_aILb0EPiS0_ET1_T0_S2_S1_(i32* %call, i32* %call1, i32* %call3)
  store i32* %call4, i32** %ref.tmp, align 8
  call void @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEC2ERKS1_(%"class.__gnu_cxx::__normal_iterator"* %retval, i32** dereferenceable(8) %ref.tmp) #3
  %coerce.dive5 = getelementptr inbounds %"class.__gnu_cxx::__normal_iterator", %"class.__gnu_cxx::__normal_iterator"* %retval, i32 0, i32 0
  %5 = load i32*, i32** %coerce.dive5, align 8
  ret i32* %5
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i32* @_ZSt12__niter_baseIPiSt6vectorIiSaIiEEET_N9__gnu_cxx17__normal_iteratorIS4_T0_EE(i32* %__it.coerce) #4 comdat {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZSt9__advanceIPilEvRT_T0_St26random_access_iterator_tag(i32** dereferenceable(8) %__i, i64 %__n) #4 comdat {
entry:
  %0 = alloca %"struct.std::random_access_iterator_tag", align 1
  %__i.addr = alloca i32**, align 8
  %__n.addr = alloca i64, align 8
...
if.then:                                          ; preds = %land.lhs.true
  %4 = load i32**, i32*** %__i.addr, align 8
  %5 = load i32*, i32** %4, align 8
  %incdec.ptr = getelementptr inbounds i32, i32* %5, i32 1
  store i32* %incdec.ptr, i32** %4, align 8
  br label %if.end6
...
if.then3:                                         ; preds = %land.lhs.true1
  %9 = load i32**, i32*** %__i.addr, align 8
  %10 = load i32*, i32** %9, align 8
  %incdec.ptr4 = getelementptr inbounds i32, i32* %10, i32 -1
  store i32* %incdec.ptr4, i32** %9, align 8
  br label %if.end

if.else5:                                         ; preds = %land.lhs.true1, %if.else
  %11 = load i64, i64* %__n.addr, align 8
  %12 = load i32**, i32*** %__i.addr, align 8
  %13 = load i32*, i32** %12, align 8
  %add.ptr = getelementptr inbounds i32, i32* %13, i64 %11
  store i32* %add.ptr, i32** %12, align 8
  br label %if.end
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local dereferenceable(1) %"struct.std::greater"* @_ZSt4moveIRSt7greaterIiEEONSt16remove_referenceIT_E4typeEOS4_(%"struct.std::greater"* dereferenceable(1) %__t) #4 comdat {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx5__ops15_Iter_comp_iterISt7greaterIiEEC2ES3_(%"struct.__gnu_cxx::__ops::_Iter_comp_iter"* %this) unnamed_addr #4 comdat align 2 {
entry:
  %__comp = alloca %"struct.std::greater", align 1
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local dereferenceable(1) %"struct.__gnu_cxx::__ops::_Iter_comp_iter"* @_ZSt4moveIRN9__gnu_cxx5__ops15_Iter_comp_iterISt7greaterIiEEEEONSt16remove_referenceIT_E4typeEOS8_(%"struct.__gnu_cxx::__ops::_Iter_comp_iter"* dereferenceable(1) %__t) #4 comdat {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx5__ops14_Iter_comp_valISt7greaterIiEEC2EONS0_15_Iter_comp_iterIS3_EE(%"struct.__gnu_cxx::__ops::_Iter_comp_val"* %this, %"struct.__gnu_cxx::__ops::_Iter_comp_iter"* dereferenceable(1) %__comp) unnamed_addr #4 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local zeroext i1 @_ZNKSt7greaterIiEclERKiS2_(%"struct.std::greater"* %this, i32* dereferenceable(4) %__x, i32* dereferenceable(4) %__y) #4 comdat align 2 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local dereferenceable(4) i32* @_ZNKSt6vectorIiSaIiEE5frontEv(%"class.std::vector"* %this) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  %ref.tmp = alloca %"class.__gnu_cxx::__normal_iterator.0", align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local dereferenceable(4) i32* @_ZNK9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEdeEv(%"class.__gnu_cxx::__normal_iterator.0"* %this) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::__normal_iterator.0"*, align 8
  store %"class.__gnu_cxx::__normal_iterator.0"* %this, %"class.__gnu_cxx::__normal_iterator.0"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::__normal_iterator.0"*, %"class.__gnu_cxx::__normal_iterator.0"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt6vectorIiSaIiEE8pop_backEv(%"class.std::vector"* %this) #4 comdat align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  store %"class.std::vector"* %this, %"class.std::vector"** %this.addr, align 8
  %this1 = load %"class.std::vector"*, %"class.std::vector"** %this.addr, align 8
  ...
  %2 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl2 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %2, i32 0, i32 0
  %3 = bitcast %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl2 to %"class.std::allocator"*
  %4 = bitcast %"class.std::vector"* %this1 to %"struct.std::_Vector_base"*
  %_M_impl3 = getelementptr inbounds %"struct.std::_Vector_base", %"struct.std::_Vector_base"* %4, i32 0, i32 0
  %_M_finish4 = getelementptr inbounds %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl", %"struct.std::_Vector_base<int, std::allocator<int> >::_Vector_impl"* %_M_impl3, i32 0, i32 1
  %5 = load i32*, i32** %_M_finish4, align 8
  invoke void @_ZNSt16allocator_traitsISaIiEE7destroyIiEEvRS0_PT_(%"class.std::allocator"* dereferenceable(1) %3, i32* %5)
          to label %invoke.cont unwind label %terminate.lpad
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local dereferenceable(8) %"class.__gnu_cxx::__normal_iterator"* @_ZN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEmmEv(%"class.__gnu_cxx::__normal_iterator"* %this) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::__normal_iterator"*, align 8
  store %"class.__gnu_cxx::__normal_iterator"* %this, %"class.__gnu_cxx::__normal_iterator"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::__normal_iterator"*, %"class.__gnu_cxx::__normal_iterator"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx5__ops14_Iter_comp_valISt7greaterIiEEC2ES3_(%"struct.__gnu_cxx::__ops::_Iter_comp_val"* %this) unnamed_addr #4 comdat align 2 {
entry:
  %__comp = alloca %"struct.std::greater", align 1
  %this.addr = alloca %"struct.__gnu_cxx::__ops::_Iter_comp_val"*, align 8
  store %"struct.__gnu_cxx::__ops::_Iter_comp_val"* %this, %"struct.__gnu_cxx::__ops::_Iter_comp_val"** %this.addr, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i32* @_ZNK9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEmiEl(%"class.__gnu_cxx::__normal_iterator"* %this, i64 %__n) #4 comdat align 2 {
entry:
  %retval = alloca %"class.__gnu_cxx::__normal_iterator", align 8
  %this.addr = alloca %"class.__gnu_cxx::__normal_iterator"*, align 8
  %__n.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local zeroext i1 @_ZNKSt6vectorIiSaIiEE5emptyEv(%"class.std::vector"* %this) #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::vector"*, align 8
  %ref.tmp = alloca %"class.__gnu_cxx::__normal_iterator.0", align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local zeroext i1 @_ZN9__gnu_cxxeqIPKiSt6vectorIiSaIiEEEEbRKNS_17__normal_iteratorIT_T0_EESB_(%"class.__gnu_cxx::__normal_iterator.0"* dereferenceable(8) %__lhs, %"class.__gnu_cxx::__normal_iterator.0"* dereferenceable(8) %__rhs) #4 comdat {
entry:
  %__lhs.addr = alloca %"class.__gnu_cxx::__normal_iterator.0"*, align 8
  %__rhs.addr = alloca %"class.__gnu_cxx::__normal_iterator.0"*, align 8
  store %"class.__gnu_cxx::__normal_iterator.0"* %__lhs, %"class.__gnu_cxx::__normal_iterator.0"** %__lhs.addr, align 8
