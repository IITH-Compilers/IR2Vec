; ModuleID = 'temp/boruvkas-algorithm.cpp'
source_filename = "temp/boruvkas-algorithm.cpp"
...
if.end89:                                         ; preds = %if.then72
  ...
  %call105 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i64 0, i64 0), i32 %105, i32 %110)
...
while.end:                                        ; preds = %while.cond
  ...
  %call110 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0), i32 %116)
  ret void
}
