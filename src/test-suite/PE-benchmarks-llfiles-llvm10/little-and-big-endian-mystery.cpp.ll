; ModuleID = 'temp/little-and-big-endian-mystery.cpp'
source_filename = "temp/little-and-big-endian-mystery.cpp"
...
define dso_local void @_Z12show_mem_repPci(i8* %start, i32 %n) #0 {
entry:
...
entry:
  ...
  store i32 19088743, i32* %i, align 4
  %0 = bitcast i32* %i to i8*
  call void @_Z12show_mem_repPci(i8* %0, i32 4)
