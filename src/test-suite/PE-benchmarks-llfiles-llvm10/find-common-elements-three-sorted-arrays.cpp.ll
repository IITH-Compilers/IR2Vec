; ModuleID = 'temp/find-common-elements-three-sorted-arrays.cpp'
source_filename = "temp/find-common-elements-three-sorted-arrays.cpp"
...
if.then:                                          ; preds = %land.lhs.true6
  ...
  %call14 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
...
entry:
  ...
  %call = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0))
  %arraydecay = getelementptr inbounds [6 x i32], [6 x i32]* %ar1, i64 0, i64 0
  %arraydecay1 = getelementptr inbounds [5 x i32], [5 x i32]* %ar2, i64 0, i64 0
  %arraydecay2 = getelementptr inbounds [8 x i32], [8 x i32]* %ar3, i64 0, i64 0
