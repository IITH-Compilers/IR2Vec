; ModuleID = 'temp/euler-circuit-directed-graph.cpp'
source_filename = "temp/euler-circuit-directed-graph.cpp"
...
entry:
  ...
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  %0 = bitcast %class.Graph* %agg.result to i8*
  ...
  %V = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 0
  %1 = load i32, i32* %V, align 8
  call void @_ZN5GraphC1Ei(%class.Graph* %agg.result, i32 %1)
...
for.body:                                         ; preds = %for.cond
  call void @_ZNSt14_List_iteratorIiEC2Ev(%"struct.std::_List_iterator"* %i) #3
  %adj = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 1
  %4 = load %"class.std::__cxx11::list"*, %"class.std::__cxx11::list"** %adj, align 8
  %5 = load i32, i32* %v, align 4
  %idxprom = sext i32 %5 to i64
  %arrayidx = getelementptr inbounds %"class.std::__cxx11::list", %"class.std::__cxx11::list"* %4, i64 %idxprom
  %call = call %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIiSaIiEE5beginEv(%"class.std::__cxx11::list"* %arrayidx) #3
  %coerce.dive = getelementptr inbounds %"struct.std::_List_iterator", %"struct.std::_List_iterator"* %ref.tmp, i32 0, i32 0
  store %"struct.std::__detail::_List_node_base"* %call, %"struct.std::__detail::_List_node_base"** %coerce.dive, align 8
  %6 = bitcast %"struct.std::_List_iterator"* %i to i8*
  %7 = bitcast %"struct.std::_List_iterator"* %ref.tmp to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %6, i8* align 8 %7, i64 8, i1 false)
  br label %for.cond3

for.cond3:                                        ; preds = %for.inc, %for.body
  %adj5 = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 1
  %8 = load %"class.std::__cxx11::list"*, %"class.std::__cxx11::list"** %adj5, align 8
...
for.body11:                                       ; preds = %for.cond3
  ...
  %10 = load %"class.std::__cxx11::list"*, %"class.std::__cxx11::list"** %adj12, align 8
  ...
  %arrayidx15 = getelementptr inbounds %"class.std::__cxx11::list", %"class.std::__cxx11::list"* %10, i64 %idxprom14
...
if.then:                                          ; preds = %invoke.cont6
  %call8 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str, i64 0, i64 0))
...
if.else:                                          ; preds = %invoke.cont6
  %call10 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.1, i64 0, i64 0))
