; ModuleID = 'temp/channel-assignment.cpp'
source_filename = "temp/channel-assignment.cpp"
...
entry:
  ...
  store [4 x i32]* %table, [4 x i32]** %table.addr, align 8
  %arraydecay = getelementptr inbounds [4 x i32], [4 x i32]* %matchR, i64 0, i64 0
...
for.body:                                         ; preds = %for.cond
  %arraydecay1 = getelementptr inbounds [4 x i8], [4 x i8]* %seen, i64 0, i64 0
  ...
  %arraydecay2 = getelementptr inbounds [4 x i8], [4 x i8]* %seen, i64 0, i64 0
  %arraydecay3 = getelementptr inbounds [4 x i32], [4 x i32]* %matchR, i64 0, i64 0
...
for.end:                                          ; preds = %for.cond
  %call5 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str, i64 0, i64 0))
...
if.then12:                                        ; preds = %for.body10
  %call13 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  ...
  %call18 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call17, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0))
  ...
  %call21 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call20, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  br label %if.end22
...
entry:
  ...
  %arraydecay = getelementptr inbounds [3 x [4 x i32]], [3 x [4 x i32]]* %table, i64 0, i64 0
