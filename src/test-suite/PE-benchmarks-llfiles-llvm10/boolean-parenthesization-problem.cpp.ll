; ModuleID = 'temp/boolean-parenthesization-problem.cpp'
source_filename = "temp/boolean-parenthesization-problem.cpp"
...
entry:
  ...
  %arraydecay = getelementptr inbounds [5 x i8], [5 x i8]* %symbols, i64 0, i64 0
  %call = call i64 @strlen(i8* %arraydecay) #8
  %conv = trunc i64 %call to i32
  store i32 %conv, i32* %n, align 4
  %arraydecay1 = getelementptr inbounds [5 x i8], [5 x i8]* %symbols, i64 0, i64 0
  %arraydecay2 = getelementptr inbounds [4 x i8], [4 x i8]* %operators, i64 0, i64 0
