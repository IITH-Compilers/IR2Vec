; ModuleID = 'temp/maximum-sum-increasing-subsequence.cpp'
source_filename = "temp/maximum-sum-increasing-subsequence.cpp"
...
entry:
  ...
  %call = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str, i64 0, i64 0))
