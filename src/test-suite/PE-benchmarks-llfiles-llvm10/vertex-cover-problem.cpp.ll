; ModuleID = 'temp/vertex-cover-problem.cpp'
source_filename = "temp/vertex-cover-problem.cpp"
...
; Function Attrs: noinline uwtable
define dso_local void @_ZN5Graph16printVertexCoverEv(%class.Graph* %this) #0 align 2 {
entry:
  %this.addr = alloca %class.Graph*, align 8
  %saved_stack = alloca i8*, align 8
  %__vla_expr0 = alloca i64, align 8
  %i = alloca i32, align 4
  %i3 = alloca %"struct.std::_List_iterator", align 8
  %u = alloca i32, align 4
  %ref.tmp = alloca %"struct.std::_List_iterator", align 8
  %ref.tmp14 = alloca %"struct.std::_List_iterator", align 8
...
for.end:                                          ; preds = %for.cond
  call void @_ZNSt14_List_iteratorIiEC2Ev(%"struct.std::_List_iterator"* %i3) #3
...
for.cond4:                                        ; preds = %for.inc37, %for.end
  ...
  %8 = load i32, i32* %V5, align 8
  %cmp6 = icmp slt i32 %7, %8
  br i1 %cmp6, label %for.body7, label %for.end39
...
if.then:                                          ; preds = %for.body7
  %adj = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 1
  %11 = load %"class.std::__cxx11::list"*, %"class.std::__cxx11::list"** %adj, align 8
  %12 = load i32, i32* %u, align 4
  %idxprom11 = sext i32 %12 to i64
  %arrayidx12 = getelementptr inbounds %"class.std::__cxx11::list", %"class.std::__cxx11::list"* %11, i64 %idxprom11
  %call = call %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIiSaIiEE5beginEv(%"class.std::__cxx11::list"* %arrayidx12) #3
  %coerce.dive = getelementptr inbounds %"struct.std::_List_iterator", %"struct.std::_List_iterator"* %ref.tmp, i32 0, i32 0
  store %"struct.std::__detail::_List_node_base"* %call, %"struct.std::__detail::_List_node_base"** %coerce.dive, align 8
  %13 = bitcast %"struct.std::_List_iterator"* %i3 to i8*
  %14 = bitcast %"struct.std::_List_iterator"* %ref.tmp to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %13, i8* align 8 %14, i64 8, i1 false)
  br label %for.cond13

for.cond13:                                       ; preds = %for.inc33, %if.then
  %adj15 = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 1
  %15 = load %"class.std::__cxx11::list"*, %"class.std::__cxx11::list"** %adj15, align 8
  %16 = load i32, i32* %u, align 4
  %idxprom16 = sext i32 %16 to i64
  %arrayidx17 = getelementptr inbounds %"class.std::__cxx11::list", %"class.std::__cxx11::list"* %15, i64 %idxprom16
  %call18 = call %"struct.std::__detail::_List_node_base"* @_ZNSt7__cxx114listIiSaIiEE3endEv(%"class.std::__cxx11::list"* %arrayidx17) #3
  %coerce.dive19 = getelementptr inbounds %"struct.std::_List_iterator", %"struct.std::_List_iterator"* %ref.tmp14, i32 0, i32 0
  store %"struct.std::__detail::_List_node_base"* %call18, %"struct.std::__detail::_List_node_base"** %coerce.dive19, align 8
  %call20 = call zeroext i1 @_ZNKSt14_List_iteratorIiEneERKS0_(%"struct.std::_List_iterator"* %i3, %"struct.std::_List_iterator"* dereferenceable(8) %ref.tmp14) #3
  br i1 %call20, label %for.body21, label %for.end35

for.body21:                                       ; preds = %for.cond13
  %call22 = call dereferenceable(4) i32* @_ZNKSt14_List_iteratorIiEdeEv(%"struct.std::_List_iterator"* %i3) #3
  %17 = load i32, i32* %call22, align 4
...
for.inc33:                                        ; preds = %if.end
  %call34 = call dereferenceable(8) %"struct.std::_List_iterator"* @_ZNSt14_List_iteratorIiEppEv(%"struct.std::_List_iterator"* %i3) #3
  br label %for.cond13

for.end35:                                        ; preds = %if.then28, %for.cond13
  br label %if.end36

if.end36:                                         ; preds = %for.end35, %for.body7
  br label %for.inc37

for.inc37:                                        ; preds = %if.end36
  %22 = load i32, i32* %u, align 4
  %inc38 = add nsw i32 %22, 1
  store i32 %inc38, i32* %u, align 4
  br label %for.cond4
...
for.cond41:                                       ; preds = %for.inc52, %for.end39
  %23 = load i32, i32* %i40, align 4
  %V42 = getelementptr inbounds %class.Graph, %class.Graph* %this1, i32 0, i32 0
  %24 = load i32, i32* %V42, align 8
...
for.body44:                                       ; preds = %for.cond41
  ...
  %arrayidx46 = getelementptr inbounds i8, i8* %vla, i64 %idxprom45
...
if.then48:                                        ; preds = %for.body44
  %27 = load i32, i32* %i40, align 4
  %call49 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %27)
  %call50 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call49, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
  br label %if.end51
...
for.inc52:                                        ; preds = %if.end51
  %28 = load i32, i32* %i40, align 4
  %inc53 = add nsw i32 %28, 1
  store i32 %inc53, i32* %i40, align 4
  br label %for.cond41

for.end54:                                        ; preds = %for.cond41
  %29 = load i8*, i8** %saved_stack, align 8
...
entry:
  ...
  call void @_ZN5GraphC1Ei(%class.Graph* %g, i32 7)
  call void @_ZN5Graph7addEdgeEii(%class.Graph* %g, i32 0, i32 1)
  call void @_ZN5Graph7addEdgeEii(%class.Graph* %g, i32 0, i32 2)
  call void @_ZN5Graph7addEdgeEii(%class.Graph* %g, i32 1, i32 3)
  call void @_ZN5Graph7addEdgeEii(%class.Graph* %g, i32 3, i32 4)
  call void @_ZN5Graph7addEdgeEii(%class.Graph* %g, i32 4, i32 5)
  call void @_ZN5Graph7addEdgeEii(%class.Graph* %g, i32 5, i32 6)
  call void @_ZN5Graph16printVertexCoverEv(%class.Graph* %g)
  ret i32 0
}
