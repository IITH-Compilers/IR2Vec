; ModuleID = 'temp/kmp-algorithm.cpp'
source_filename = "temp/kmp-algorithm.cpp"
...
if.then10:                                        ; preds = %if.end
  ...
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i64 0, i64 0), i32 %sub)
...
entry:
  ...
  %arraydecay = getelementptr inbounds [10 x i8], [10 x i8]* %pat, i64 0, i64 0
  %arraydecay1 = getelementptr inbounds [20 x i8], [20 x i8]* %txt, i64 0, i64 0
