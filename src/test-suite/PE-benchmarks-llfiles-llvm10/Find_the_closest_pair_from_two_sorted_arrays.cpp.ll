; ModuleID = 'temp/Find_the_closest_pair_from_two_sorted_arrays.cpp'
source_filename = "temp/Find_the_closest_pair_from_two_sorted_arrays.cpp"
...
while.end:                                        ; preds = %land.end
  %call21 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0))
  ...
  %call25 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call24, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0))
...
entry:
  ...
  %arraydecay = getelementptr inbounds [4 x i32], [4 x i32]* %ar1, i64 0, i64 0
  %arraydecay1 = getelementptr inbounds [4 x i32], [4 x i32]* %ar2, i64 0, i64 0
