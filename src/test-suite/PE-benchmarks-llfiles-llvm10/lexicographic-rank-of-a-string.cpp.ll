; ModuleID = 'temp/lexicographic-rank-of-a-string.cpp'
source_filename = "temp/lexicographic-rank-of-a-string.cpp"
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4facti(i32 %n) #0 {
entry:
...
cond.false:                                       ; preds = %entry
  ...
  %sub = sub nsw i32 %2, 1
  %call = call i32 @_Z4facti(i32 %sub)
...
define dso_local i32 @_Z18findSmallerInRightPcii(i8* %str, i32 %low, i32 %high) #4 {
entry:
  %str.addr = alloca i8*, align 8
  %low.addr = alloca i32, align 4
  %high.addr = alloca i32, align 4
  %countRight = alloca i32, align 4
  %i = alloca i32, align 4
  store i8* %str, i8** %str.addr, align 8
  store i32 %low, i32* %low.addr, align 4
  store i32 %high, i32* %high.addr, align 4
  store i32 0, i32* %countRight, align 4
...
if.then:                                          ; preds = %for.body
  %9 = load i32, i32* %countRight, align 4
  %inc = add nsw i32 %9, 1
  store i32 %inc, i32* %countRight, align 4
  br label %if.end
...
for.end:                                          ; preds = %for.cond
  %11 = load i32, i32* %countRight, align 4
  ret i32 %11
}

; Function Attrs: noinline uwtable
define dso_local i32 @_Z8findRankPc(i8* %str) #0 {
entry:
  %str.addr = alloca i8*, align 8
  ...
  %call1 = call i32 @_Z4facti(i32 %1)
  store i32 %call1, i32* %mul, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %sub = sub nsw i32 %4, %5
  %6 = load i32, i32* %mul, align 4
  %div = sdiv i32 %6, %sub
  store i32 %div, i32* %mul, align 4
  %7 = load i8*, i8** %str.addr, align 8
  %8 = load i32, i32* %i, align 4
  %9 = load i32, i32* %len, align 4
  %sub2 = sub nsw i32 %9, 1
  %call3 = call i32 @_Z18findSmallerInRightPcii(i8* %7, i32 %8, i32 %sub2)
  store i32 %call3, i32* %countRight, align 4
  %10 = load i32, i32* %countRight, align 4
  %11 = load i32, i32* %mul, align 4
  %mul4 = mul nsw i32 %10, %11
  %12 = load i32, i32* %rank, align 4
  %add = add nsw i32 %12, %mul4
...
entry:
  ...
  %call = call i32 @_Z8findRankPc(i8* %arraydecay)
