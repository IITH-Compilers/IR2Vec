...
for.end82:                                        ; preds = %for.cond60
  %call83 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i32 0, i32 0))
...
entry:
  ...
  %arraydecay = getelementptr inbounds [6 x [5 x i32]], [6 x [5 x i32]]* %M, i32 0, i32 0
