...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %call10 = call zeroext i1 @_ZStneRKSt14_List_iteratorI11AdjListNodeES3_(%"struct.std::_List_iterator"* dereferenceable(8) %i, %"struct.std::_List_iterator"* dereferenceable(8) %ref.tmp4) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local zeroext i1 @_ZStneRKSt14_List_iteratorI11AdjListNodeES3_(%"struct.std::_List_iterator"* dereferenceable(8) %__x, %"struct.std::_List_iterator"* dereferenceable(8) %__y) #6 comdat {
entry:
...
for.cond44:                                       ; preds = %for.inc77, %if.then40
  ...
  %call51 = call zeroext i1 @_ZStneRKSt14_List_iteratorI11AdjListNodeES3_(%"struct.std::_List_iterator"* dereferenceable(8) %i36, %"struct.std::_List_iterator"* dereferenceable(8) %ref.tmp45) #3
...
cond.true:                                        ; preds = %for.body85
  %call90 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0))
...
invoke.cont93:                                    ; preds = %cond.false
  %call96 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call94, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
...
invoke.cont9:                                     ; preds = %invoke.cont8
  ...
  %call = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.2, i32 0, i32 0))
...
invoke.cont11:                                    ; preds = %invoke.cont10
  %call14 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %call12, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0))
          to label %invoke.cont13 unwind label %lpad
...
invoke.cont:                                      ; preds = %while.body
  ...
  call void @_ZNSt16allocator_traitsISaISt10_List_nodeI11AdjListNodeEEE7destroyIS1_EEvRS3_PT_(%"class.std::allocator"* dereferenceable(1) %call5, %class.AdjListNode* %10) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaISt10_List_nodeI11AdjListNodeEEE7destroyIS1_EEvRS3_PT_(%"class.std::allocator"* dereferenceable(1) %__a, %class.AdjListNode* %__p) #6 comdat align 2 {
entry:
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeI11AdjListNodeEE7destroyIS2_EEvPT_(%"class.__gnu_cxx::new_allocator"* %1, %class.AdjListNode* %2) #3
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeI11AdjListNodeEE10deallocateEPS3_m(%"class.__gnu_cxx::new_allocator"* %this, %"struct.std::_List_node"* %__p, i64 %__t) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  %__p.addr = alloca %"struct.std::_List_node"*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt5dequeIiSaIiEE15_M_destroy_dataESt15_Deque_iteratorIiRiPiES5_RKS0_(%"class.std::deque"* %this, %"struct.std::_Deque_iterator"* %__first, %"struct.std::_Deque_iterator"* %__last, %"class.std::allocator.0"* dereferenceable(1)) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.std::deque"*, align 8
...
invoke.cont:                                      ; preds = %entry
  ...
  call void @_ZNSt16allocator_traitsISaISt10_List_nodeI11AdjListNodeEEE9constructIS1_JRKS1_EEEvRS3_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %4, %class.AdjListNode* %call3, %class.AdjListNode* dereferenceable(8) %call4) #3
  %call5 = call dereferenceable(16) %"struct.std::__allocated_ptr"* @_ZNSt15__allocated_ptrISaISt10_List_nodeI11AdjListNodeEEEaSEDn(%"struct.std::__allocated_ptr"* %__guard, i8* null) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt16allocator_traitsISaISt10_List_nodeI11AdjListNodeEEE9constructIS1_JRKS1_EEEvRS3_PT_DpOT0_(%"class.std::allocator"* dereferenceable(1) %__a, %class.AdjListNode* %__p, %class.AdjListNode* dereferenceable(8) %__args) #6 comdat align 2 {
entry:
  %__a.addr = alloca %"class.std::allocator"*, align 8
  %__p.addr = alloca %class.AdjListNode*, align 8
  %__args.addr = alloca %class.AdjListNode*, align 8
  ...
  call void @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeI11AdjListNodeEE9constructIS2_JRKS2_EEEvPT_DpOT0_(%"class.__gnu_cxx::new_allocator"* %1, %class.AdjListNode* %2, %class.AdjListNode* dereferenceable(8) %call) #3
  ret void
}

; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local dereferenceable(16) %"struct.std::__allocated_ptr"* @_ZNSt15__allocated_ptrISaISt10_List_nodeI11AdjListNodeEEEaSEDn(%"struct.std::__allocated_ptr"* %this, i8*) #6 comdat align 2 {
entry:
  %this.addr = alloca %"struct.std::__allocated_ptr"*, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local %"struct.std::_List_node"* @_ZN9__gnu_cxx13new_allocatorISt10_List_nodeI11AdjListNodeEE8allocateEmPKv(%"class.__gnu_cxx::new_allocator"* %this, i64 %__n, i8*) #0 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  %__n.addr = alloca i64, align 8
  %.addr = alloca i8*, align 8
  ...
  %this1 = load %"class.__gnu_cxx::new_allocator"*, %"class.__gnu_cxx::new_allocator"** %this.addr, align 8
  %1 = load i64, i64* %__n.addr, align 8
  %call = call i64 @_ZNK9__gnu_cxx13new_allocatorISt10_List_nodeI11AdjListNodeEE11_M_max_sizeEv(%"class.__gnu_cxx::new_allocator"* %this1) #3
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i64 @_ZNK9__gnu_cxx13new_allocatorISt10_List_nodeI11AdjListNodeEE11_M_max_sizeEv(%"class.__gnu_cxx::new_allocator"* %this) #6 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator"*, align 8
  store %"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"** %this.addr, align 8
  %this1 = load %"class.__gnu_cxx::new_allocator"*, %"class.__gnu_cxx::new_allocator"** %this.addr, align 8
...
if.then:                                          ; preds = %entry
  call void @_ZSt20__throw_length_errorPKc(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.4, i32 0, i32 0)) #15
  unreachable
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local zeroext i1 @_ZSteqRKSt15_Deque_iteratorIiRiPiES4_(%"struct.std::_Deque_iterator"* dereferenceable(32) %__x, %"struct.std::_Deque_iterator"* dereferenceable(32) %__y) #6 comdat {
entry:
  %__x.addr = alloca %"struct.std::_Deque_iterator"*, align 8
  %__y.addr = alloca %"struct.std::_Deque_iterator"*, align 8
  store %"struct.std::_Deque_iterator"* %__x, %"struct.std::_Deque_iterator"** %__x.addr, align 8
