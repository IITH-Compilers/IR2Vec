...
if.then12:                                        ; preds = %for.end
  %call13 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i32 0, i32 0))
  %17 = load i32, i32* %i, align 4
  %call14 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %call13, i32 %17)
...
entry:
  ...
  %txt = alloca [19 x i8], align 16
  %pat = alloca [5 x i8], align 1
  store i32 0, i32* %retval, align 4
  %0 = bitcast [19 x i8]* %txt to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %0, i8* align 16 getelementptr inbounds ([19 x i8], [19 x i8]* @__const.main.txt, i32 0, i32 0), i64 19, i1 false)
  ...
  %arraydecay1 = getelementptr inbounds [19 x i8], [19 x i8]* %txt, i32 0, i32 0
