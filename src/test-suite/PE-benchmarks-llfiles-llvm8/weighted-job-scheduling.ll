...
entry:
  ...
  %arraydecay = getelementptr inbounds [4 x %struct.Job], [4 x %struct.Job]* %arr, i32 0, i32 0
...
entry:
  ...
  %call2 = call %struct.Job* @_ZSt22__copy_move_backward_aILb1EP3JobS1_ET1_T0_S3_S2_(%struct.Job* %call, %struct.Job* %call1, %struct.Job* %2)
...
entry:
  ...
  store %struct.Job* %__result, %struct.Job** %__result.addr, align 8
  %0 = load %struct.Job*, %struct.Job** %__first.addr, align 8
  %call = call %struct.Job* @_ZSt12__niter_baseIP3JobET_S2_(%struct.Job* %0) #3
  %1 = load %struct.Job*, %struct.Job** %__last.addr, align 8
  %call1 = call %struct.Job* @_ZSt12__niter_baseIP3JobET_S2_(%struct.Job* %1) #3
  %2 = load %struct.Job*, %struct.Job** %__result.addr, align 8
  %call2 = call %struct.Job* @_ZSt12__niter_baseIP3JobET_S2_(%struct.Job* %2) #3
  %call3 = call %struct.Job* @_ZSt23__copy_move_backward_a1ILb1EP3JobS1_ET1_T0_S3_S2_(%struct.Job* %call, %struct.Job* %call1, %struct.Job* %call2)
  %call4 = call %struct.Job* @_ZSt12__niter_wrapIP3JobET_RKS2_S2_(%struct.Job** dereferenceable(8) %__result.addr, %struct.Job* %call3)
  ret %struct.Job* %call4
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local %struct.Job* @_ZSt12__niter_wrapIP3JobET_RKS2_S2_(%struct.Job** dereferenceable(8), %struct.Job* %__res) #4 comdat {
entry:
  %.addr = alloca %struct.Job**, align 8
  %__res.addr = alloca %struct.Job*, align 8
  store %struct.Job** %0, %struct.Job*** %.addr, align 8
  store %struct.Job* %__res, %struct.Job** %__res.addr, align 8
  %1 = load %struct.Job*, %struct.Job** %__res.addr, align 8
  ret %struct.Job* %1
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local %struct.Job* @_ZSt23__copy_move_backward_a1ILb1EP3JobS1_ET1_T0_S3_S2_(%struct.Job* %__first, %struct.Job* %__last, %struct.Job* %__result) #0 comdat {
entry:
  %__first.addr = alloca %struct.Job*, align 8
  %__last.addr = alloca %struct.Job*, align 8
  %__result.addr = alloca %struct.Job*, align 8
  ...
  %1 = load %struct.Job*, %struct.Job** %__last.addr, align 8
  %2 = load %struct.Job*, %struct.Job** %__result.addr, align 8
  %call = call %struct.Job* @_ZSt23__copy_move_backward_a2ILb1EP3JobS1_ET1_T0_S3_S2_(%struct.Job* %0, %struct.Job* %1, %struct.Job* %2)
  ret %struct.Job* %call
}
