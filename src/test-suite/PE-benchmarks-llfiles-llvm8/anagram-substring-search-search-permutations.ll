...
for.body14:                                       ; preds = %for.cond12
  %arraydecay = getelementptr inbounds [256 x i8], [256 x i8]* %countP, i32 0, i32 0
  %arraydecay15 = getelementptr inbounds [256 x i8], [256 x i8]* %countTW, i32 0, i32 0
  %call16 = call zeroext i1 @_Z7comparePcS_(i8* %arraydecay, i8* %arraydecay15)
  br i1 %call16, label %if.then, label %if.end

if.then:                                          ; preds = %for.body14
  %call17 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0))
...
for.end32:                                        ; preds = %for.cond12
  %arraydecay33 = getelementptr inbounds [256 x i8], [256 x i8]* %countP, i32 0, i32 0
  %arraydecay34 = getelementptr inbounds [256 x i8], [256 x i8]* %countTW, i32 0, i32 0
...
if.then36:                                        ; preds = %for.end32
  %call37 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0))
...
entry:
  ...
  %arraydecay1 = getelementptr inbounds [11 x i8], [11 x i8]* %txt, i32 0, i32 0
