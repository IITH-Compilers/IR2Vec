; ModuleID = 'PE-benchmarks/birthday-paradox.cpp'
source_filename = "PE-benchmarks/birthday-paradox.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_birthday_paradox.cpp, i8* null }]
...
define dso_local i32 @_Z4findd(double %p) #4 {
entry:
  ...
  %call = call double @log(double %div) #3
  %mul = fmul double 7.300000e+02, %call
...
entry:
  %call = call i32 @_Z4findd(double 0x3FE6666666666666)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_birthday_paradox.cpp() #0 section ".text.startup" {
entry:
