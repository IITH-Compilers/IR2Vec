...
for.end14:                                        ; preds = %for.cond3
  %call15 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.1, i32 0, i32 0))
...
entry:
  ...
  %arraydecay = getelementptr inbounds [12 x i32], [12 x i32]* %stream, i32 0, i32 0
