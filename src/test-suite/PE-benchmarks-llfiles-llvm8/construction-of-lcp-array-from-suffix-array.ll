...
entry:
  ...
  %vla = alloca %struct.suffix, i64 %1, align 16
...
for.end:                                          ; preds = %for.cond
  ...
  %vla15 = alloca i32, i64 %18, align 16
  store i64 %18, i64* %__vla_expr1, align 8
...
for.body18:                                       ; preds = %for.cond16
  ...
  store i32 %21, i32* %prev_rank, align 4
  %22 = load i32, i32* %rank19, align 4
  ...
  %23 = load i32, i32* %index27, align 16
...
if.then:                                          ; preds = %land.lhs.true
  ...
  store i32 %34, i32* %prev_rank, align 4
  %35 = load i32, i32* %rank19, align 4
  ...
  store i32 %35, i32* %arrayidx56, align 4
  br label %if.end
...
if.else:                                          ; preds = %land.lhs.true, %for.body33
  ...
  store i32 %38, i32* %prev_rank, align 4
  %39 = load i32, i32* %rank19, align 4
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %43 = load i32, i32* %index68, align 4
...
for.cond75:                                       ; preds = %for.inc97, %for.end73
  %45 = load i32, i32* %i74, align 4
  %46 = load i32, i32* %n.addr, align 4
  %cmp76 = icmp slt i32 %45, %46
  br i1 %cmp76, label %for.body77, label %for.end99

for.body77:                                       ; preds = %for.cond75
  %47 = load i32, i32* %i74, align 4
  ...
  %div = sdiv i32 %49, 2
  %add81 = add nsw i32 %48, %div
  store i32 %add81, i32* %nextindex, align 4
  %50 = load i32, i32* %nextindex, align 4
...
cond.true83:                                      ; preds = %for.body77
  %52 = load i32, i32* %nextindex, align 4
...
cond.end91:                                       ; preds = %cond.false90, %cond.true83
  %cond92 = phi i32 [ %54, %cond.true83 ], [ -1, %cond.false90 ]
  %55 = load i32, i32* %i74, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 %4, i32* %call11, align 4
  br label %for.inc
...
if.end:                                           ; preds = %for.body15
  ...
  %21 = load i32, i32* %call22, align 4
...
while.cond:                                       ; preds = %while.body, %if.end
  ...
  %add23 = add nsw i32 %22, %23
  %24 = load i32, i32* %n, align 4
  %cmp24 = icmp slt i32 %add23, %24
...
while.end:                                        ; preds = %land.end
  ...
  store i32 %39, i32* %call43, align 4
  %42 = load i32, i32* %k, align 4
  %cmp44 = icmp sgt i32 %42, 0
...
entry:
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %str, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), %"class.std::allocator.0"* dereferenceable(1) %ref.tmp)
          to label %invoke.cont unwind label %lpad
...
invoke.cont4:                                     ; preds = %invoke.cont2
  ...
  %call9 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i32 0, i32 0))
...
invoke.cont20:                                    ; preds = %invoke.cont18
  ...
  %call23 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0))
...
entry:
  ...
  %call2 = call %struct.suffix* @_ZSt22__copy_move_backward_aILb1EP6suffixS1_ET1_T0_S3_S2_(%struct.suffix* %call, %struct.suffix* %call1, %struct.suffix* %2)
...
entry:
  ...
  store %struct.suffix* %__result, %struct.suffix** %__result.addr, align 8
  %0 = load %struct.suffix*, %struct.suffix** %__first.addr, align 8
  %call = call %struct.suffix* @_ZSt12__niter_baseIP6suffixET_S2_(%struct.suffix* %0) #3
  %1 = load %struct.suffix*, %struct.suffix** %__last.addr, align 8
  %call1 = call %struct.suffix* @_ZSt12__niter_baseIP6suffixET_S2_(%struct.suffix* %1) #3
  %2 = load %struct.suffix*, %struct.suffix** %__result.addr, align 8
  %call2 = call %struct.suffix* @_ZSt12__niter_baseIP6suffixET_S2_(%struct.suffix* %2) #3
  %call3 = call %struct.suffix* @_ZSt23__copy_move_backward_a1ILb1EP6suffixS1_ET1_T0_S3_S2_(%struct.suffix* %call, %struct.suffix* %call1, %struct.suffix* %call2)
  %call4 = call %struct.suffix* @_ZSt12__niter_wrapIP6suffixET_RKS2_S2_(%struct.suffix** dereferenceable(8) %__result.addr, %struct.suffix* %call3)
  ret %struct.suffix* %call4
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local %struct.suffix* @_ZSt12__niter_wrapIP6suffixET_RKS2_S2_(%struct.suffix** dereferenceable(8), %struct.suffix* %__res) #4 comdat {
entry:
  %.addr = alloca %struct.suffix**, align 8
  %__res.addr = alloca %struct.suffix*, align 8
  store %struct.suffix** %0, %struct.suffix*** %.addr, align 8
  store %struct.suffix* %__res, %struct.suffix** %__res.addr, align 8
  %1 = load %struct.suffix*, %struct.suffix** %__res.addr, align 8
  ret %struct.suffix* %1
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local %struct.suffix* @_ZSt23__copy_move_backward_a1ILb1EP6suffixS1_ET1_T0_S3_S2_(%struct.suffix* %__first, %struct.suffix* %__last, %struct.suffix* %__result) #0 comdat {
entry:
  %__first.addr = alloca %struct.suffix*, align 8
  %__last.addr = alloca %struct.suffix*, align 8
  %__result.addr = alloca %struct.suffix*, align 8
  ...
  %1 = load %struct.suffix*, %struct.suffix** %__last.addr, align 8
  %2 = load %struct.suffix*, %struct.suffix** %__result.addr, align 8
  %call = call %struct.suffix* @_ZSt23__copy_move_backward_a2ILb1EP6suffixS1_ET1_T0_S3_S2_(%struct.suffix* %0, %struct.suffix* %1, %struct.suffix* %2)
  ret %struct.suffix* %call
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZNSt12_Destroy_auxILb1EE9__destroyIPiEEvT_S3_(i32*, i32*) #4 comdat align 2 {
entry:
...
entry:
  ...
  store i32* %__args, i32** %__args.addr, align 8
  %this1 = load %"class.std::vector"*, %"class.std::vector"** %this.addr, align 8
  %call = call i64 @_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc(%"class.std::vector"* %this1, i64 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.4, i32 0, i32 0))
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i32* @_ZSt14__relocate_a_1IiiENSt9enable_ifIXsr3std24__is_bitwise_relocatableIT_EE5valueEPS1_E4typeES2_S2_S2_RSaIT0_E(i32* %__first, i32* %__last, i32* %__result, %"class.std::allocator"* dereferenceable(1)) #4 comdat {
entry:
  %__first.addr = alloca i32*, align 8
  %__last.addr = alloca i32*, align 8
  %__result.addr = alloca i32*, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i64 @_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_(i64 %__n, %"class.std::allocator"* dereferenceable(1) %__a) #0 comdat align 2 {
entry:
  %__n.addr = alloca i64, align 8
  %__a.addr = alloca %"class.std::allocator"*, align 8
  %ref.tmp = alloca %"class.std::allocator", align 1
...
if.then:                                          ; preds = %entry
  call void @_ZSt20__throw_length_errorPKc(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.5, i32 0, i32 0)) #13
  unreachable
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZN9__gnu_cxx13new_allocatorIiEC2ERKS1_(%"class.__gnu_cxx::new_allocator"* %this, %"class.__gnu_cxx::new_allocator"* dereferenceable(1)) unnamed_addr #4 comdat align 2 {
entry:
  %this.addr = alloca %"class.__gnu_cxx::new_allocator"*, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32* @_ZSt24__uninitialized_fill_n_aIPimiiET_S1_T0_RKT1_RSaIT2_E(i32* %__first, i64 %__n, i32* dereferenceable(4) %__x, %"class.std::allocator"* dereferenceable(1)) #0 comdat {
entry:
  %__first.addr = alloca i32*, align 8
  %__n.addr = alloca i64, align 8
  %__x.addr = alloca i32*, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32* @_ZSt10__fill_n_aIPimiET_S1_T0_RKT1_St26random_access_iterator_tag(i32* %__first, i64 %__n, i32* dereferenceable(4) %__value) #0 comdat {
entry:
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZSt19__iterator_categoryIPiENSt15iterator_traitsIT_E17iterator_categoryERKS2_(i32** dereferenceable(8)) #4 comdat {
entry:
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZSt8__fill_aIPiiEvT_S1_RKT0_(i32* %__first, i32* %__last, i32* dereferenceable(4) %__value) #0 comdat {
entry:
  %__first.addr = alloca i32*, align 8
  %__last.addr = alloca i32*, align 8
  %__value.addr = alloca i32*, align 8
...
entry:
  ...
  store %"class.std::allocator"* %__a, %"class.std::allocator"** %__a.addr, align 8
  %0 = load %"class.std::allocator"*, %"class.std::allocator"** %__a.addr, align 8
  call void @_ZNSt16allocator_traitsISaIiEE37select_on_container_copy_constructionERKS0_(%"class.std::allocator"* sret %agg.result, %"class.std::allocator"* dereferenceable(1) %0)
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32* @_ZSt22__uninitialized_copy_aIN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEEPiiET0_T_SA_S9_RSaIT1_E(i32* %__first.coerce, i32* %__last.coerce, i32* %__result, %"class.std::allocator"* dereferenceable(1)) #0 comdat {
entry:
...
entry:
  ...
  call void @_ZN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEC2ERKS2_(%"class.__gnu_cxx::__normal_iterator.3"* %retval, i32** dereferenceable(8) %ref.tmp) #3
...
entry:
  ...
  %0 = load %"class.std::allocator"*, %"class.std::allocator"** %__rhs.addr, align 8
  call void @_ZNSaIiEC2ERKS_(%"class.std::allocator"* %agg.result, %"class.std::allocator"* dereferenceable(1) %0) #3
  ret void
}
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32* @_ZSt13__copy_move_aILb0EN9__gnu_cxx17__normal_iteratorIPKiSt6vectorIiSaIiEEEEPiET1_T0_SA_S9_(i32* %__first.coerce, i32* %__last.coerce, i32* %__result) #0 comdat {
entry:
  %__first = alloca %"class.__gnu_cxx::__normal_iterator.3", align 8
  %__last = alloca %"class.__gnu_cxx::__normal_iterator.3", align 8
  %__result.addr = alloca i32*, align 8
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i32* @_ZSt12__niter_wrapIPiET_RKS1_S1_(i32** dereferenceable(8), i32* %__res) #4 comdat {
entry:
  %.addr = alloca i32**, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32* @_ZSt14__copy_move_a1ILb0EPKiPiET1_T0_S4_S3_(i32* %__first, i32* %__last, i32* %__result) #0 comdat {
entry:
  %__first.addr = alloca i32*, align 8
  %__last.addr = alloca i32*, align 8
  %__result.addr = alloca i32*, align 8
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32* @_ZSt14__copy_move_a2ILb0EPKiPiET1_T0_S4_S3_(i32* %__first, i32* %__last, i32* %__result) #0 comdat {
entry:
  %__first.addr = alloca i32*, align 8
  %__last.addr = alloca i32*, align 8
  %__result.addr = alloca i32*, align 8
