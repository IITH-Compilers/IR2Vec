...
; Function Attrs: noinline uwtable
define dso_local void @_Z6searchNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES4_(%"class.std::__cxx11::basic_string"* %text, %"class.std::__cxx11::basic_string"* %pattern) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %concat = alloca %"class.std::__cxx11::basic_string", align 8
  ...
  call void @_ZStplIcSt11char_traitsIcESaIcEENSt7__cxx1112basic_stringIT_T0_T1_EERKS8_PKS5_(%"class.std::__cxx11::basic_string"* sret %ref.tmp, %"class.std::__cxx11::basic_string"* dereferenceable(32) %pattern, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  invoke void @_ZStplIcSt11char_traitsIcESaIcEENSt7__cxx1112basic_stringIT_T0_T1_EEOS8_RKS8_(%"class.std::__cxx11::basic_string"* sret %concat, %"class.std::__cxx11::basic_string"* dereferenceable(32) %ref.tmp, %"class.std::__cxx11::basic_string"* dereferenceable(32) %text)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %ref.tmp) #3
  %call = call i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6lengthEv(%"class.std::__cxx11::basic_string"* %concat) #3
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1ERKS4_(%"class.std::__cxx11::basic_string"* %agg.tmp, %"class.std::__cxx11::basic_string"* dereferenceable(32) %concat)
          to label %invoke.cont2 unwind label %lpad1

invoke.cont2:                                     ; preds = %invoke.cont
  invoke void @_Z7getZarrNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPi(%"class.std::__cxx11::basic_string"* %agg.tmp, i32* %vla)
...
for.body:                                         ; preds = %for.cond
  ...
  %call6 = call i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6lengthEv(%"class.std::__cxx11::basic_string"* %pattern) #3
  %cmp7 = icmp eq i64 %conv5, %call6
  br i1 %cmp7, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %call9 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0))
          to label %invoke.cont8 unwind label %lpad1

invoke.cont8:                                     ; preds = %if.then
  %7 = load i32, i32* %i, align 4
  %conv10 = sext i32 %7 to i64
  %call11 = call i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6lengthEv(%"class.std::__cxx11::basic_string"* %pattern) #3
  %sub = sub i64 %conv10, %call11
  %sub12 = sub i64 %sub, 1
  %call14 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEm(%"class.std::basic_ostream"* %call9, i64 %sub12)
...
lpad1:                                            ; preds = %invoke.cont13, %invoke.cont8, %if.then, %invoke.cont
...
for.end:                                          ; preds = %for.cond
  ...
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %concat) #3
  ret void
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZStplIcSt11char_traitsIcESaIcEENSt7__cxx1112basic_stringIT_T0_T1_EEOS8_RKS8_(%"class.std::__cxx11::basic_string"* noalias sret %agg.result, %"class.std::__cxx11::basic_string"* dereferenceable(32) %__lhs, %"class.std::__cxx11::basic_string"* dereferenceable(32) %__rhs) #0 comdat {
entry:
  ...
  %call = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_(%"class.std::__cxx11::basic_string"* %0, %"class.std::__cxx11::basic_string"* dereferenceable(32) %1)
  %call1 = call dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZSt4moveIRNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEONSt16remove_referenceIT_E4typeEOS8_(%"class.std::__cxx11::basic_string"* dereferenceable(32) %call) #3
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EOS4_(%"class.std::__cxx11::basic_string"* %agg.result, %"class.std::__cxx11::basic_string"* dereferenceable(32) %call1) #3
  ret void
}

; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZStplIcSt11char_traitsIcESaIcEENSt7__cxx1112basic_stringIT_T0_T1_EERKS8_PKS5_(%"class.std::__cxx11::basic_string"* noalias sret %agg.result, %"class.std::__cxx11::basic_string"* dereferenceable(32) %__lhs, i8* %__rhs) #0 comdat personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %__lhs.addr = alloca %"class.std::__cxx11::basic_string"*, align 8
  ...
  %call = invoke dereferenceable(32) %"class.std::__cxx11::basic_string"* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc(%"class.std::__cxx11::basic_string"* %agg.result, i8* %1)
          to label %invoke.cont unwind label %lpad
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7getZarrNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPi(%"class.std::__cxx11::basic_string"* %str, i32* %Z) #0 {
entry:
...
land.rhs:                                         ; preds = %while.cond
  ...
  %call4 = call dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %str, i64 %conv3)
  %9 = load i8, i8* %call4, align 1
  %conv5 = sext i8 %9 to i32
  %10 = load i32, i32* %R, align 4
  %conv6 = sext i32 %10 to i64
  %call7 = call dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %str, i64 %conv6)
  %11 = load i8, i8* %call7, align 1
...
while.end:                                        ; preds = %land.end
  ...
  store i32 %sub10, i32* %arrayidx, align 4
...
if.else:                                          ; preds = %for.body
  ...
  store i32 %sub11, i32* %k, align 4
  %21 = load i32*, i32** %Z.addr, align 8
  ...
  %cmp15 = icmp slt i32 %23, %add
  br i1 %cmp15, label %if.then16, label %if.else21

if.then16:                                        ; preds = %if.else
  %26 = load i32*, i32** %Z.addr, align 8
  ...
  %29 = load i32*, i32** %Z.addr, align 8
...
while.cond22:                                     ; preds = %while.body34, %if.else21
  %32 = load i32, i32* %R, align 4
  %33 = load i32, i32* %n, align 4
  %cmp23 = icmp slt i32 %32, %33
  br i1 %cmp23, label %land.rhs24, label %land.end33
...
land.rhs24:                                       ; preds = %while.cond22
  ...
  %call27 = call dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %str, i64 %conv26)
  %36 = load i8, i8* %call27, align 1
  %conv28 = sext i8 %36 to i32
  %37 = load i32, i32* %R, align 4
  %conv29 = sext i32 %37 to i64
  %call30 = call dereferenceable(1) i8* @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEixEm(%"class.std::__cxx11::basic_string"* %str, i64 %conv29)
  %38 = load i8, i8* %call30, align 1
  %conv31 = sext i8 %38 to i32
  %cmp32 = icmp eq i32 %conv28, %conv31
  br label %land.end33

land.end33:                                       ; preds = %land.rhs24, %while.cond22
  %39 = phi i1 [ false, %while.cond22 ], [ %cmp32, %land.rhs24 ]
  br i1 %39, label %while.body34, label %while.end36
...
while.end36:                                      ; preds = %land.end33
  ...
  store i32 %dec40, i32* %R, align 4
  br label %if.end

if.end:                                           ; preds = %while.end36, %if.then16
  br label %if.end41

if.end41:                                         ; preds = %if.end, %while.end
  br label %for.inc
...
entry:
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %text, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i32 0, i32 0), %"class.std::allocator"* dereferenceable(1) %ref.tmp)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  call void @_ZNSaIcED1Ev(%"class.std::allocator"* %ref.tmp) #3
  call void @_ZNSaIcEC1Ev(%"class.std::allocator"* %ref.tmp1) #3
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* %pattern, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0), %"class.std::allocator"* dereferenceable(1) %ref.tmp1)
...
invoke.cont5:                                     ; preds = %invoke.cont3
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1ERKS4_(%"class.std::__cxx11::basic_string"* %agg.tmp6, %"class.std::__cxx11::basic_string"* dereferenceable(32) %pattern)
...
invoke.cont10:                                    ; preds = %invoke.cont8
  ...
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %agg.tmp) #3
  store i32 0, i32* %retval, align 4
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %pattern) #3
