...
if.then:                                          ; preds = %for.end
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i32 0, i32 0))
  store i1 false, i1* %retval, align 1
  br label %return

if.end:                                           ; preds = %for.end
  %arraydecay3 = getelementptr inbounds [4 x i32], [4 x i32]* %color, i32 0, i32 0
...
entry:
  ...
  %i = alloca i32, align 4
  store i32* %color, i32** %color.addr, align 8
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.1, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i32 0, i32 0), i32 %3)
  br label %for.inc
...
entry:
  ...
  %arraydecay = getelementptr inbounds [4 x [4 x i8]], [4 x [4 x i8]]* %graph, i32 0, i32 0
