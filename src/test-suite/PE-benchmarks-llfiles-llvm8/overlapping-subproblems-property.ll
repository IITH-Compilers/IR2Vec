...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100 x i32], [100 x i32]* @lookup, i64 0, i64 %idxprom
...
if.then2:                                         ; preds = %if.then
  ...
  %arrayidx4 = getelementptr inbounds [100 x i32], [100 x i32]* @lookup, i64 0, i64 %idxprom3
...
if.else:                                          ; preds = %if.then
  ...
  %call6 = call i32 @_Z3fibi(i32 %sub5)
  %add = add nsw i32 %call, %call6
  %7 = load i32, i32* %n.addr, align 4
  %idxprom7 = sext i32 %7 to i64
  %arrayidx8 = getelementptr inbounds [100 x i32], [100 x i32]* @lookup, i64 0, i64 %idxprom7
...
if.end9:                                          ; preds = %if.end, %entry
  ...
  %arrayidx11 = getelementptr inbounds [100 x i32], [100 x i32]* @lookup, i64 0, i64 %idxprom10
...
entry:
  ...
  %call = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0))
  %0 = load i32, i32* %n, align 4
  %call1 = call i32 @_Z3fibi(i32 %0)
