...
entry:
  ...
  %arraydecay = getelementptr inbounds [9 x [9 x i32]], [9 x [9 x i32]]* %grid, i32 0, i32 0
...
if.then:                                          ; preds = %entry
  %arraydecay1 = getelementptr inbounds [9 x [9 x i32]], [9 x [9 x i32]]* %grid, i32 0, i32 0
  call void @_Z9printGridPA9_i([9 x i32]* %arraydecay1)
  br label %if.end

if.else:                                          ; preds = %entry
  %call2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0))
  br label %if.end
