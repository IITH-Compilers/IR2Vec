...
for.cond13:                                       ; preds = %for.inc33, %if.then
  ...
  %call20 = call zeroext i1 @_ZStneRKSt14_List_iteratorIiES2_(%"struct.std::_List_iterator"* dereferenceable(8) %i3, %"struct.std::_List_iterator"* dereferenceable(8) %ref.tmp14) #3
