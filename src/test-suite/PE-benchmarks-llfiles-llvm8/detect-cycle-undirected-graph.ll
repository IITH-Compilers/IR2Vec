...
; Function Attrs: noinline uwtable
define dso_local zeroext i1 @_ZN5Graph12isCyclicUtilEiPbi(%class.Graph* %this, i32 %v, i8* %visited, i32 %parent) #0 align 2 {
entry:
...
if.else:                                          ; preds = %for.body
  %call17 = call dereferenceable(4) i32* @_ZNKSt14_List_iteratorIiEdeEv(%"struct.std::_List_iterator"* %i) #3
...
for.inc:                                          ; preds = %if.end20
  %call21 = call dereferenceable(8) %"struct.std::_List_iterator"* @_ZNSt14_List_iteratorIiEppEv(%"struct.std::_List_iterator"* %i) #3
  br label %for.cond
...
if.then:                                          ; preds = %for.body6
  ...
  %call9 = call zeroext i1 @_ZN5Graph12isCyclicUtilEiPbi(%class.Graph* %this1, i32 %11, i8* %12, i32 -1)
...
return:                                           ; preds = %for.end14, %if.then10
...
cond.true:                                        ; preds = %entry
  %call1 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i32 0, i32 0))
  br label %cond.end

cond.false:                                       ; preds = %entry
  %call2 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.1, i32 0, i32 0))
  br label %cond.end
...
cond.true4:                                       ; preds = %cond.end
  %call5 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i32 0, i32 0))
  br label %cond.end8

cond.false6:                                      ; preds = %cond.end
  %call7 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.1, i32 0, i32 0))
  br label %cond.end8
