...
entry:
  ...
  %arraydecay = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %keypad, i32 0, i32 0
  %call = call i32 @_Z8getCountPA3_ci([3 x i8]* %arraydecay, i32 1)
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i32 0, i32 0), i32 1, i32 %call)
  %arraydecay2 = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %keypad, i32 0, i32 0
  %call3 = call i32 @_Z8getCountPA3_ci([3 x i8]* %arraydecay2, i32 2)
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i32 0, i32 0), i32 2, i32 %call3)
  %arraydecay5 = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %keypad, i32 0, i32 0
  %call6 = call i32 @_Z8getCountPA3_ci([3 x i8]* %arraydecay5, i32 3)
  %call7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i32 0, i32 0), i32 3, i32 %call6)
  %arraydecay8 = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %keypad, i32 0, i32 0
  %call9 = call i32 @_Z8getCountPA3_ci([3 x i8]* %arraydecay8, i32 4)
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i32 0, i32 0), i32 4, i32 %call9)
  %arraydecay11 = getelementptr inbounds [4 x [3 x i8]], [4 x [3 x i8]]* %keypad, i32 0, i32 0
  %call12 = call i32 @_Z8getCountPA3_ci([3 x i8]* %arraydecay11, i32 5)
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i32 0, i32 0), i32 5, i32 %call12)
  ret i32 0
}
