...
entry:
  ...
  %arraydecay = getelementptr inbounds [4 x [4 x i32]], [4 x [4 x i32]]* %board, i32 0, i32 0
...
if.end:                                           ; preds = %entry
  %arraydecay2 = getelementptr inbounds [4 x [4 x i32]], [4 x [4 x i32]]* %board, i32 0, i32 0
