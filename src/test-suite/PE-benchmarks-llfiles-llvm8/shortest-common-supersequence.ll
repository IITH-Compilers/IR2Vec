...
entry:
  ...
  %arraydecay1 = getelementptr inbounds [8 x i8], [8 x i8]* %Y, i32 0, i32 0
  %arraydecay2 = getelementptr inbounds [7 x i8], [7 x i8]* %X, i32 0, i32 0
  %call3 = call i64 @strlen(i8* %arraydecay2) #8
  %conv = trunc i64 %call3 to i32
  %arraydecay4 = getelementptr inbounds [8 x i8], [8 x i8]* %Y, i32 0, i32 0
