...
; Function Attrs: noinline uwtable
define dso_local void @_ZN5Graph3DFSEi(%class.Graph* %this, i32 %v) #0 align 2 {
entry:
  %this.addr = alloca %class.Graph*, align 8
  %v.addr = alloca i32, align 4
...
for.end:                                          ; preds = %for.cond
  ...
  %7 = load i8*, i8** %visited, align 8
  call void @_ZN5Graph7DFSUtilEiPb(%class.Graph* %this1, i32 %6, i8* %7)
  ret void
}
...
entry:
  ...
  %call = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([62 x i8], [62 x i8]* @.str.1, i32 0, i32 0))
  call void @_ZN5Graph3DFSEi(%class.Graph* %g, i32 2)
  ret i32 0
}
