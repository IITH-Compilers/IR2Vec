...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %call12 = call zeroext i1 @_ZStneRKSt14_List_iteratorIiES2_(%"struct.std::_List_iterator"* dereferenceable(8) %i, %"struct.std::_List_iterator"* dereferenceable(8) %ref.tmp6) #3
...
entry:
  ...
  %call = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.1, i32 0, i32 0))
